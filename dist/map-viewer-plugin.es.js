...
(function(Gi) {
  typeof define == "function" && define.amd ? define(Gi) : Gi();
})(function() {
  (function(Gi) {
    typeof define == "function" && define.amd ? define(Gi) : Gi();
  })(function() {
    var Gi = Object.defineProperty, qr = (i, t, e) => t in i ? Gi(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e, _i = (i, t, e) => qr(i, typeof t != "symbol" ? t + "" : t, e);
    /**
    * @license
    ...
    */
    ...
    class ri extends Ve {
      ...
      setAt(t, e) {
        ...
        this.array_[t] = e, this.dispatchEvent(new go(we.REMOVE, r, t)), this.dispatchEvent(new go(we.ADD, e, t));
      }
      updateLength_() {
    ...
    function Ro(i, t) {
      let e;
      return e = t(nn(i)), e || (e = t(on(i)), e) || (e = t(an(i)), e) || (e = t(ni(i)), e) ? e : !1;
    }
    function bs(i) {
      let t = 0;
    ...
    function Co(i, t, e, s, r) {
      ...
      return Ne(Math.min(n, a, l, c), Math.min(o, h, u, d), Math.max(n, a, l, c), Math.max(o, h, u, d), r);
    }
    function Du(i, t, e, s) {
    ...
    function Fe(i, t, e) {
      const s = e || Se();
      return ne(i, t) ? (i[0] > t[0] ? s[0] = i[0] : s[0] = t[0], i[1] > t[1] ? s[1] = i[1] : s[1] = t[1], i[2] < t[2] ? s[2] = i[2] : s[2] = t[2], i[3] < t[3] ? s[3] = i[3] : s[3] = t[3]) : xi(s), s;
    }
    function ep(i) {
      return pt(i) + Xt(i);
    }
    ...
    const rp = Object.freeze(Object.defineProperty({ __proto__: null, applyTransform: Uu, approximatelyEquals: Jg, boundingExtent: Qa, buffer: Mo, clone: th, closestSquaredDistanceXY: Yi, containsCoordinate: Rs, containsExtent: Wi, containsXY: wo, coordinateRelationship: So, createEmpty: Se, createOrUpdate: Ne, createOrUpdateEmpty: xi, createOrUpdateFromCoordinate: eh, createOrUpdateFromCoordinates: Kg, createOrUpdateFromFlatCoordinates: vo, createOrUpdateFromRings: Hg, equals: sr, extend: rn, extendCoordinate: Cs, extendCoordinates: ih, extendFlatCoordinates: sh, extendRings: Nu, extendXY: Fu, forEachCorner: Ro, getArea: bs, getBottomLeft: nn, getBottomRight: on, getCenter: Ei, getCorner: ku, getEnlargedArea: Qg, getForViewAndSize: Co, getHeight: Xt, getIntersection: Fe, getIntersectionArea: tp, getMargin: ep, getRotatedViewport: Du, getSize: ip, getTopLeft: ni, getTopRight: an, getWidth: pt, intersects: ne, intersectsSegment: zu, isEmpty: rr, returnOrUpdate: Gu, scaleFromCenter: sp, wrapAndSliceX: bo, wrapX: rh }, Symbol.toStringTag, { value: "Module" }));
    function np(i, t) {
    ...
    const Io = 0.9996, ze = 669438e-8, Ao = ze * ze, Po = Ao * ze, Ts = ze / (1 - ze), Yu = Math.sqrt(1 - ze), nr = (1 - Yu) / (1 + Yu), Wu = nr * nr, oh = Wu * nr, ah = oh * nr, qu = ah * nr, Vu = 1 - ze / 4 - 3 * Ao / 64 - 5 * Po / 256, hp = 3 * ze / 8 + 3 * Ao / 32 + 45 * Po / 1024, lp = 15 * Ao / 256 + 45 * Po / 1024, up = 35 * Po / 3072, cp = 3 / 2 * nr - 27 / 32 * oh + 269 / 512 * qu, dp = 21 / 16 * Wu - 55 / 32 * ah, fp = 151 / 96 * oh - 417 / 128 * qu, gp = 1097 / 512 * ah, Lo = 6378137;
    function pp(i, t, e) {
      const s = i - 5e5, r = (e.north ? t : t - 1e7) / Io / (Lo * Vu), n = r + cp * Math.sin(2 * r) + dp * Math.sin(4 * r) + fp * Math.sin(6 * r) + gp * Math.sin(8 * r), o = Math.sin(n), a = o * o, h = Math.cos(n), l = o / h, u = l * l, c = u * u, d = 1 - ze * a, p = Math.sqrt(1 - ze * a), f = Lo / p, y = (1 - ze) / d, E = Ts * h ** 2, M = E * E, w = s / (f * Io), C = w * w, v = C * w, R = v * w, I = R * w, O = I * w, A = n - l / y * (C / 2 - R / 24 * (5 + 3 * u + 10 * E - 4 * M - 9 * Ts)) + O / 720 * (61 + 90 * u + 298 * E + 45 * c - 252 * Ts - 3 * M);
    ...
    function yp(i, t, e) {
      ...
      const s = Xi(t), r = Math.sin(s), n = Math.cos(s), o = r / n, a = o * o, h = a * a, l = Xi(i), u = Ku(e.number), c = Xi(u), d = Lo / Math.sqrt(1 - ze * r ** 2), p = Ts * n ** 2, f = n * Za(l - c, -Math.PI, Math.PI), y = f * f, E = y * f, M = E * f, w = M * f, C = w * f, v = Lo * (Vu * s - hp * Math.sin(2 * s) + lp * Math.sin(4 * s) - up * Math.sin(6 * s)), R = Io * d * (f + E / 6 * (1 - a + p) + w / 120 * (5 - 18 * a + h + 72 * p - 58 * Ts)) + 5e5;
    ...
    class No extends Ve {
      ...
      getExtent(t) {
        if (this.extentRevision_ != this.getRevision()) {
          ...
          (isNaN(e[0]) || isNaN(e[1])) && xi(e), this.extentRevision_ = this.getRevision();
        }
    ...
    class Si extends No {
      ...
      scale(t, e, s) {
        e === void 0 && (e = t), s || (s = Ei(this.getExtent()));
    ...
    function dc(i, t, e, s, r, n, o) {
      ...
      if (l === 0 && u === 0) c = t;
        ...
        if (d > 1) c = e;
          ...
          for (let p = 0; p < s; ++p) o[p] = Oe(i[t + p], i[e + p], d);
          o.length = s;
          return;
        } else c = t;
      }
    ...
    class oi extends Si {
      ...
      clone() {
        const t = new oi(this.flatCoordinates.slice(), this.layout, this.ends_.slice());
        return t.applyProperties(this), t;
      }
      closestPointXY(t, e, s, r) {
      ...
      getSimplifiedGeometryInternal(t) {
        const e = [], s = [];
        return e.length = Ch(this.flatCoordinates, 0, this.ends_, this.stride, Math.sqrt(t), e, 0, s), new oi(e, "XY", s);
      }
      getType() {
        return "Polygon";
      }
    ...
    function Sc(i) {
      ...
      return new oi(n, "XY", [n.length]);
    }
    const Lh = 0;
    class ai extends Ve {
      constructor(t) {
        super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = dh(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && vp(), t.center && (t.center = Mi(t.center, this.projection_)), t.extent && (t.extent = qi(t.extent, this.projection_)), this.applyOptions_(t);
      }
      applyOptions_(t) {
        const e = Object.assign({}, t);
        for (const a in $e) delete e[a];
      ...
      animate(t) {
        ...
        for (let s = 0; s < e.length; ++s) {
          let r = arguments[s];
          r.center && (r = Object.assign({}, r), r.center = Mi(r.center, this.getProjection())), r.anchor && (r = Object.assign({}, r), r.anchor = Mi(r.anchor, this.getProjection())), e[s] = r;
        }
      ...
      fit(t, e) {
        ...
        if (wt(Array.isArray(t) || typeof t.getSimplifiedGeometry == "function", "Invalid extent or geometry provided as `geometry`"), Array.isArray(t)) {
          ...
          s = Sc(r), s.rotate(this.getRotation(), Ei(r));
        } else s = t;
      ...
      fitInternal(t, e) {
        ...
        const l = this.getRotation(), u = Math.sin(l), c = Math.cos(l), d = Ei(a);
      ...
      centerOn(t, e, s) {
        this.centerOnInternal(Mi(t, this.getProjection()), e, s);
      }
      ...
      adjustResolution(t, e) {
        e = e && Mi(e, this.getProjection()), this.adjustResolutionInternal(t, e);
      }
      ...
      adjustRotation(t, e) {
        e && (e = Mi(e, this.getProjection())), this.adjustRotationInternal(t, e);
      }
      ...
      setCenter(t) {
        this.setCenterInternal(t && Mi(t, this.getProjection()));
      }
      setCenterInternal(t) {
      ...
      applyTargetState_(t, e) {
        ...
        this.get($e.ROTATION) !== r && this.set($e.ROTATION, r), this.get($e.RESOLUTION) !== o && (this.set($e.RESOLUTION, o), this.set("zoom", this.getZoom(), !0)), (!a || !this.get($e.CENTER) || !To(this.get($e.CENTER), a)) && this.set($e.CENTER, a), this.getAnimating() && !t && this.cancelAnimations(), this.cancelAnchor_ = void 0;
      }
      ...
      endInteraction(t, e, s) {
        s = s && Mi(s, this.getProjection()), this.endInteractionInternal(t, e, s);
      }
    ...
    class zo extends Au {
      ...
      isVisible(t) {
        ...
        !t && s && (t = s.getView()), t instanceof ai ? e = { viewState: t.getState(), extent: t.calculateExtent() } : e = t, !e.layerStatesArray && s && (e.layerStatesArray = s.getLayerGroup().getLayerStatesArray());
        let r;
      ...
      getAttributions(t) {
        ...
        if (!s) return [];
        const r = t instanceof ai ? t.getViewStateAndExtent() : t;
        let n = s(r);
    ...
    function Zh(i, t, e, s, r, n) {
      let o = t === void 0 ? void 0 : Be.get(t, e, r);
      return o || (o = new $h(i, i && "src" in i ? i.src || void 0 : t, e, s, r), Be.set(t, e, r, o, n)), n && o && !Be.getPattern(t, e, r) && Be.set(t, e, r, o, n), o;
    }
    function Dc(i) {
      return i[0] > 0 && i[1] > 0;
    }
    ...
    function Om(i) {
      if (!i.offset || !i.size) return Be.getPattern(i.src, "anonymous", i.color);
      const t = i.src + ":" + i.offset, e = Be.getPattern(t, void 0, i.color);
      if (e) return e;
      const s = Be.get(i.src, "anonymous", null);
      if (s.getImageState() !== gt.LOADED) return null;
      const r = Yt(i.size[0], i.size[1]);
      return r.drawImage(s.getImage(1), i.offset[0], i.offset[1], i.size[0], i.size[1], 0, 0, i.size[0], i.size[1]), Zh(r.canvas, t, void 0, gt.LOADED, i.color, !0), Be.getPattern(t, void 0, i.color);
    }
    ...
    }, Bc = "10px sans-serif", Re = "#000", cr = "round", vi = [], Ri = 0, dr = "round", yn = 10, xn = "#000", En = "center", $o = "middle", Ls = [0, 0, 0, 0], Mn = 1, Ci = new Ve();
    let fr = null, Hh;
      ...
      function a() {
        ...
        for (let u = 0, c = l.length; u < c; ++u) {
          ...
          if (Ci.get(d) < 100) {
            const [p, f, y] = d.split(`
`);
            o(p, f, y) ? (tn(Jh), fr = null, Hh = void 0, Ci.set(d, 100)) : (Ci.set(d, Ci.get(d) + 1, !0), h = !1);
          }
        }
...
` + l.weight + `
` + p;
          Ci.get(f) === void 0 && (Ci.set(f, 100, !0), o(l.style, l.weight, p) || (Ci.set(f, 0, !0), r === void 0 && (r = setInterval(a, 32))));
        }
      };
...
` || l === u) {
    ...
    class wn extends _n {
      ...
      getImage(t) {
        ...
        let o = (s = Be.get(n, null, null)) == null ? void 0 : s.getImage(1);
        if (!o) {
          const a = this.renderOptions_, h = Math.ceil(a.size * t), l = Yt(h, h);
          this.draw_(a, l, t), o = l.canvas, Be.set(n, null, null, new $h(o, void 0, null, gt.LOADED, null));
        }
        return o;
      }
      getPixelRatio(t) {
      ...
      createRenderOptions() {
        ...
        this.stroke_ && (o = hi(this.stroke_.getColor() ?? xn), a = this.stroke_.getWidth() ?? Mn, r = this.stroke_.getLineDash(), n = this.stroke_.getLineDashOffset() ?? 0, e = this.stroke_.getLineJoin() ?? dr, t = this.stroke_.getLineCap() ?? cr, s = this.stroke_.getMiterLimit() ?? yn);
      ...
      draw_(t, e, s) {
        if (e.scale(s, s), e.translate(t.size / 2, t.size / 2), this.createPath_(e), this.fill_) {
          ...
          r === null && (r = Re), e.fillStyle = hi(r), e.fill();
        }
    ...
    let Ns = 0;
    const me = 1 << Ns++, Et = 1 << Ns++, Ce = 1 << Ns++, Ke = 1 << Ns++, Fs = 1 << Ns++, vn = 1 << Ns++, Ho = Math.pow(2, Ns) - 1, tl = { [me]: "boolean", [Et]: "number", [Ce]: "string", [Ke]: "color", [Fs]: "number[]", [vn]: "size" }, Xm = Object.keys(tl).map(Number).sort(Bi);
    function Ym(i) {
      return i in tl;
    }
    function Rn(i) {
    ...
    function Qt(i, t, e) {
      switch (typeof i) {
        case "boolean": {
          if (Ki(t, Ce)) return new $t(Ce, i ? "true" : "false");
          if (!Cn(t, me)) throw new Error(`got a boolean, but expected ${Rn(t)}`);
          return new $t(me, i);
        }
        case "number": {
          if (Ki(t, vn)) return new $t(vn, ve(i));
          if (Ki(t, me)) return new $t(me, !!i);
          if (Ki(t, Ce)) return new $t(Ce, i.toString());
          if (!Cn(t, Et)) throw new Error(`got a number, but expected ${Rn(t)}`);
          return new $t(Et, i);
        }
        case "string": {
          if (Ki(t, Ke)) return new $t(Ke, Bh(i));
          if (Ki(t, me)) return new $t(me, !!i);
          if (!Cn(t, Ce)) throw new Error(`got a string, but expected ${Rn(t)}`);
          return new $t(Ce, i);
        }
      }
      ...
      if (Ki(t, Ke)) {
        if (i.length === 3) return new $t(Ke, [...i, 1]);
        if (i.length === 4) return new $t(Ke, i);
    ...
    const L = { Get: "get", Var: "var", Concat: "concat", GeometryType: "geometry-type", LineMetric: "line-metric", Any: "any", All: "all", Not: "!", Resolution: "resolution", Zoom: "zoom", Time: "time", Equal: "==", NotEqual: "!=", GreaterThan: ">", GreaterThanOrEqualTo: ">=", LessThan: "<", LessThanOrEqualTo: "<=", Multiply: "*", Divide: "/", Add: "+", Subtract: "-", Clamp: "clamp", Mod: "%", Pow: "^", Abs: "abs", Floor: "floor", Ceil: "ceil", Round: "round", Sin: "sin", Cos: "cos", Atan: "atan", Sqrt: "sqrt", Match: "match", Between: "between", Interpolate: "interpolate", Coalesce: "coalesce", Case: "case", In: "in", Number: "number", String: "string", Array: "array", Color: "color", Id: "id", Band: "band", Palette: "palette", ToString: "to-string", Has: "has" }, qm = { [L.Get]: nt(ft(1, 1 / 0), $c), [L.Var]: nt(ft(1, 1), Vm), [L.Has]: nt(ft(1, 1 / 0), $c), [L.Id]: nt($m, gr), [L.Concat]: nt(ft(2, 1 / 0), Rt(Ce)), [L.GeometryType]: nt(Zm, gr), [L.LineMetric]: nt(gr), [L.Resolution]: nt(gr), [L.Zoom]: nt(gr), [L.Time]: nt(gr), [L.Any]: nt(ft(2, 1 / 0), Rt(me)), [L.All]: nt(ft(2, 1 / 0), Rt(me)), [L.Not]: nt(ft(1, 1), Rt(me)), [L.Equal]: nt(ft(2, 2), Rt(Ho)), [L.NotEqual]: nt(ft(2, 2), Rt(Ho)), [L.GreaterThan]: nt(ft(2, 2), Rt(Et)), [L.GreaterThanOrEqualTo]: nt(ft(2, 2), Rt(Et)), [L.LessThan]: nt(ft(2, 2), Rt(Et)), [L.LessThanOrEqualTo]: nt(ft(2, 2), Rt(Et)), [L.Multiply]: nt(ft(2, 1 / 0), Zc), [L.Coalesce]: nt(ft(2, 1 / 0), Zc), [L.Divide]: nt(ft(2, 2), Rt(Et)), [L.Add]: nt(ft(2, 1 / 0), Rt(Et)), [L.Subtract]: nt(ft(2, 2), Rt(Et)), [L.Clamp]: nt(ft(3, 3), Rt(Et)), [L.Mod]: nt(ft(2, 2), Rt(Et)), [L.Pow]: nt(ft(2, 2), Rt(Et)), [L.Abs]: nt(ft(1, 1), Rt(Et)), [L.Floor]: nt(ft(1, 1), Rt(Et)), [L.Ceil]: nt(ft(1, 1), Rt(Et)), [L.Round]: nt(ft(1, 1), Rt(Et)), [L.Sin]: nt(ft(1, 1), Rt(Et)), [L.Cos]: nt(ft(1, 1), Rt(Et)), [L.Atan]: nt(ft(1, 2), Rt(Et)), [L.Sqrt]: nt(ft(1, 1), Rt(Et)), [L.Match]: nt(ft(4, 1 / 0), Kc, Hm), [L.Between]: nt(ft(3, 3), Rt(Et)), [L.Interpolate]: nt(ft(6, 1 / 0), Kc, Jm), [L.Case]: nt(ft(3, 1 / 0), Km, Qm), [L.In]: nt(ft(2, 2), t_), [L.Number]: nt(ft(1, 1 / 0), Rt(Ho)), [L.String]: nt(ft(1, 1 / 0), Rt(Ho)), [L.Array]: nt(ft(1, 1 / 0), Rt(Et)), [L.Color]: nt(ft(1, 4), Rt(Et)), [L.Band]: nt(ft(1, 3), Rt(Et)), [L.Palette]: nt(ft(2, 2), e_), [L.ToString]: nt(ft(1, 1), Rt(me | Et | Ce | Ke)) };
    function $c(i, t, e) {
    ...
    function Hm(i, t, e) {
      const s = i.length - 1, r = Ce | Et | me, n = Qt(i[1], r, e), o = Qt(i[i.length - 1], t, e), a = new Array(s - 2);
    ...
    function He(i, t) {
      if (i instanceof $t) {
        if (i.type === Ke && typeof i.value == "string") {
          const s = Bh(i.value);
          return function() {
            return s;
          };
    ...
    function s_(i, t) {
      ...
      for (let n = 0; n < s; ++n) r[n] = He(i.args[n]);
      switch (e) {
        case L.Coalesce:
          return (n) => {
            for (let o = 0; o < s; ++o) {
    ...
    function n_(i, t) {
      const e = i.operator, s = He(i.args[0]), r = He(i.args[1]);
      switch (e) {
        case L.Equal:
          return (n) => s(n) === r(n);
        case L.NotEqual:
    ...
    function h_(i, t) {
      ...
      for (let r = 0; r < e; ++r) s[r] = He(i.args[r]);
      return (r) => {
    ...
    function c_(i, t) {
      ...
      switch (e) {
        case L.ToString:
          return (n) => {
            const o = r[0](n);
            return i.args[0].type === Ke ? jh(o) : o.toString();
          };
        default:
    ...
    function p_(i, t) {
      ...
      for (let r = 0; r < e; ++r) {
        const n = i[r], o = "filter" in n ? bi(n.filter, me, t) : f_;
        let a;
    ...
    function el(i, t) {
      const e = Tn(i, "", t), s = In(i, "", t), r = m_(i, t), n = __(i, t), o = be(i, "z-index", t);
    ...
    function In(i, t, e) {
      const s = be(i, t + "stroke-width", e), r = il(i, t + "stroke-color", e);
      if (!s && !r) return null;
      const n = Ti(i, t + "stroke-line-cap", e), o = Ti(i, t + "stroke-line-join", e), a = td(i, t + "stroke-line-dash", e), h = be(i, t + "stroke-line-dash-offset", e), l = be(i, t + "stroke-miter-limit", e), u = new ke();
      return function(c) {
        if (r) {
          const d = r(c);
          if (d === zh) return null;
    ...
    function m_(i, t) {
      const e = "text-", s = Ti(i, e + "value", t);
      if (!s) return null;
      const r = Tn(i, e, t), n = Tn(i, e + "background-", t), o = In(i, e, t), a = In(i, e + "background-", t), h = Ti(i, e + "font", t), l = be(i, e + "max-angle", t), u = be(i, e + "offset-x", t), c = be(i, e + "offset-y", t), d = pr(i, e + "overflow", t), p = Ti(i, e + "placement", t), f = be(i, e + "repeat", t), y = Qo(i, e + "scale", t), E = pr(i, e + "rotate-with-view", t), M = be(i, e + "rotation", t), w = Ti(i, e + "align", t), C = Ti(i, e + "justify", t), v = Ti(i, e + "baseline", t), R = pr(i, e + "keep-upright", t), I = td(i, e + "padding", t), O = ea(i, e + "declutter-mode"), A = new Ko({ declutterMode: O });
      return function(P) {
    ...
    function x_(i, t) {
      const e = "shape-", s = e + "points", r = e + "radius", n = sl(i[s], s), o = sl(i[r], r), a = Tn(i, e, t), h = In(i, e, t), l = Qo(i, e + "scale", t), u = Jo(i, e + "displacement", t), c = be(i, e + "rotation", t), d = pr(i, e + "rotate-with-view", t), p = ta(i, e + "radius2"), f = ta(i, e + "angle"), y = ea(i, e + "declutter-mode"), E = new wn({ points: n, radius: o, radius2: p, angle: f, declutterMode: y });
      return function(M) {
    ...
    function E_(i, t) {
      const e = "circle-", s = Tn(i, e, t), r = In(i, e, t), n = be(i, e + "radius", t), o = Qo(i, e + "scale", t), a = Jo(i, e + "displacement", t), h = be(i, e + "rotation", t), l = pr(i, e + "rotate-with-view", t), u = ea(i, e + "declutter-mode"), c = new Os({ radius: 5, declutterMode: u });
      return function(d) {
    ...
    function M_(i, t, e) {
      const s = Ti(i, t + "pattern-src", e), r = ed(i, t + "pattern-offset", e), n = ed(i, t + "pattern-size", e), o = il(i, t + "color", e);
      return function(a) {
    ...
    class T_ extends lo {
      ...
      calculateMatrices2D(t) {
        ...
        wi(s, t.size[0] / 2, t.size[1] / 2, 1 / e.resolution, -1 / e.resolution, -e.rotation, -e.center[0], -e.center[1]), hc(r, s);
      }
    ...
    class A_ extends T_ {
      constructor(t) {
        super(t), this.fontChangeListenerKey_ = xt(Ci, Ks.PROPERTYCHANGE, t.redrawText, t), this.element_ = document.createElement("div");
      ...
      renderFrame(t) {
        ...
        this.declutter(t, r), bm(this.element_, this.children_), this.dispatchRenderEvent(Ge.POSTCOMPOSE, t), this.renderedVisible_ || (this.element_.style.display = "", this.renderedVisible_ = !0), this.scheduleExpireIconCache(t);
      }
      declutter(t, e) {
        if (t.declutter) {
    ...
    class mr extends Au {
      constructor(t) {
        ...
        delete e.layers;
        let s = t.layers;
        super(e), this.on, this.once, this.un, this.layersListenerKeys_ = [], this.listenerKeys_ = {}, this.addChangeListener(rl.LAYERS, this.handleLayersChanged_), s ? Array.isArray(s) ? s = new ri(s.slice(), { unique: !0 }) : wt(typeof s.getArray == "function", "Expected `layers` to be an array or a `Collection`") : s = new ri(void 0, { unique: !0 }), this.setLayers(s);
      }
      handleLayerChange_() {
        this.changed();
      }
      ...
      getLayerStatesArray(t) {
        ...
        for (let o = s, a = e.length; o < a; o++) {
          const h = e[o];
          h.opacity *= r.opacity, h.visible = h.visible && r.visible, h.maxResolution = Math.min(h.maxResolution, r.maxResolution), h.minResolution = Math.max(h.minResolution, r.minResolution), h.minZoom = Math.max(h.minZoom, r.minZoom), h.maxZoom = Math.min(h.maxZoom, r.maxZoom), r.extent !== void 0 && (h.extent !== void 0 ? h.extent = Fe(h.extent, r.extent) : h.extent = r.extent), h.zIndex === void 0 && (h.zIndex = n);
        }
        return e;
      }
      getSourceState() {
    ...
    const Ii = { POSTRENDER: "postrender", MOVESTART: "movestart", MOVEEND: "moveend", LOADSTART: "loadstart", LOADEND: "loadend" }, he = { LAYERGROUP: "layergroup", SIZE: "size", TARGET: "target", VIEW: "view" }, ol = 1 / 0;
    class L_ {
      constructor(t, e) {
    ...
    class al extends Ve {
      ...
      setMap(t) {
        ...
        if (this.listenerKeys.length = 0, this.map_ = t, t) {
          ...
          this.element && s.appendChild(this.element), this.render !== Hs && this.listenerKeys.push(xt(t, Ii.POSTRENDER, this.render, this)), t.render();
        }
      }
      render(t) {
      }
    ...
    function r0(i) {
      i = i || {};
      const t = new ri(), e = new t0(-5e-3, 0.05, 100);
    ...
    let n0 = class extends Ve {
      ...
      getPixelFromCoordinate(i) {
        const t = Mi(i, this.getView().getProjection());
      ...
      handlePostRender() {
        ...
        i && this.renderer_ && !i.animate && (this.renderComplete_ ? (this.hasListener(Ge.RENDERCOMPLETE) && this.renderer_.dispatchRenderEvent(Ge.RENDERCOMPLETE, i), this.loaded_ === !1 && (this.loaded_ = !0, this.dispatchEvent(new _r(Ii.LOADEND, this, i)))) : this.loaded_ === !0 && (this.loaded_ = !1, this.dispatchEvent(new _r(Ii.LOADSTART, this, i))));
    ...
    function o0(i) {
      ...
      e[he.LAYERGROUP] = s, e[he.TARGET] = i.target, e[he.VIEW] = i.view instanceof ai ? i.view : new ai();
      let r;
      i.controls !== void 0 && (Array.isArray(i.controls) ? r = new ri(i.controls.slice()) : (wt(typeof i.controls.getArray == "function", "Expected `controls` to be an array or an `ol/Collection.js`"), r = i.controls));
      let n;
      i.interactions !== void 0 && (Array.isArray(i.interactions) ? n = new ri(i.interactions.slice()) : (wt(typeof i.interactions.getArray == "function", "Expected `interactions` to be an array or an `ol/Collection.js`"), n = i.interactions));
      let o;
      return i.overlays !== void 0 ? Array.isArray(i.overlays) ? o = new ri(i.overlays.slice()) : (wt(typeof i.overlays.getArray == "function", "Expected `overlays` to be an array or an `ol/Collection.js`"), o = i.overlays) : o = new ri(), { controls: r, interactions: n, keyboardEventTarget: t, overlays: o, values: e };
    }
    class ia extends Ve {
      constructor(t) {
    ...
    function sa(i, t, e, s, r, n, o) {
      ...
      for (let u = 0; u < o; ++u) n[u] = a === void 0 ? NaN : h === void 0 ? i[a + u] : Oe(i[a + u], i[a + s + u], h);
      return n;
    }
    function dl(i, t, e, s, r, n) {
      ...
      o = [];
      for (let d = 0; d < s - 1; ++d) o.push(Oe(i[(a - 1) * s + d], i[a * s + d], c));
      return o.push(r), o;
    }
    ...
    class Nn extends xd {
      ...
      setFillStrokeStyle(t, e) {
        ...
        if (t) {
          const r = t.getColor();
          s.fillPatternScale = r && typeof r == "object" && "src" in r ? this.pixelRatio : 1, s.fillStyle = hi(r || Re);
        } else s.fillStyle = void 0;
        if (e) {
          const r = e.getColor();
          s.strokeStyle = hi(r || xn);
          const n = e.getLineCap();
          s.lineCap = n !== void 0 ? n : cr;
          const o = e.getLineDash();
          s.lineDash = o ? o.slice() : vi;
          const a = e.getLineDashOffset();
          s.lineDashOffset = a || Ri;
    ...
    class u0 extends Nn {
      ...
      drawLineString(t, e, s) {
        ...
        this.updateStrokeStyle(r, this.applyStroke), this.beginGeometry(t, e, s), this.hitDetectionInstructions.push([it.SET_STROKE_STYLE, r.strokeStyle, r.lineWidth, r.lineCap, r.lineJoin, r.miterLimit, vi, Ri], Ds);
    ...
    class Ed extends Nn {
      ...
      drawCircle(t, e, s) {
        ...
        if (n === void 0 && o === void 0) return;
        this.setFillStrokeStyles_(), this.beginGeometry(t, e, s), r.fillStyle !== void 0 && this.hitDetectionInstructions.push([it.SET_FILL_STYLE, Re]), r.strokeStyle !== void 0 && this.hitDetectionInstructions.push([it.SET_STROKE_STYLE, r.strokeStyle, r.lineWidth, r.lineCap, r.lineJoin, r.miterLimit, vi, Ri]);
    ...
    function c0(i, t, e, s, r) {
      ...
      for (; a < i && o + r < s; ) {
        ...
        if (a += p, a >= i) {
          const f = (i - a + p) / p, y = Oe(l, c, f), E = Oe(u, d, f);
    ...
    class f0 extends Nn {
      ...
      drawChars_(t, e) {
        ...
        this.instructions.push([it.DRAW_CHARS, t, e, l, r.overflow, a, r.maxAngle, h, u, n, d * h, c, o, 1, this.declutterMode_, this.textKeepUpright_]), this.hitDetectionInstructions.push([it.DRAW_CHARS, t, e, l, r.overflow, a && Re, r.maxAngle, h, u, n, d * h, c, o, 1 / h, this.declutterMode_, this.textKeepUpright_]);
      }
      setTextStyle(t, e) {
        let s, r, n;
        if (!t) this.text_ = "";
          ...
          const o = t.getFill();
          o ? (r = this.textFillState_, r || (r = {}, this.textFillState_ = r), r.fillStyle = hi(o.getColor() || Re)) : (r = null, this.textFillState_ = r);
          const a = t.getStroke();
          if (!a) n = null, this.textStrokeState_ = n;
            ...
            n.lineCap = a.getLineCap() || cr, n.lineDash = y ? y.slice() : vi, n.lineDashOffset = E === void 0 ? Ri : E, n.lineJoin = a.getLineJoin() || dr, n.lineWidth = M === void 0 ? Mn : M, n.miterLimit = w === void 0 ? yn : w, n.strokeStyle = hi(a.getColor() || xn);
          }
          s = this.textState_;
    ...
    class Md {
      constructor() {
        _i(this, "pushMethodArgs_", (...t) => (this.instructions_[this.zIndex + this.offset_].push(t), this)), this.instructions_ = [], this.zIndex = 0, this.offset_ = 0, this.context_ = new Proxy(Yo(), { get: (t, e) => {
    ...
    class Sd extends _0 {
      ...
      clipUnrotated(t, e, s) {
        const r = ni(s), n = an(s), o = on(s), a = nn(s);
      ...
      prepareContainer(t, e) {
        ...
        wi(this.pixelTransform, t.size[0] / 2, t.size[1] / 2, 1 / o, 1 / o, n, -a / 2, -h / 2), hc(this.inversePixelTransform, this.pixelTransform);
      ...
      getRenderTransform(t, e, s, r, n, o, a) {
        ...
        return wi(this.tempTransform, h, l, u, c, -s, d, p);
      }
      disposeInternal() {
    ...
    function x0(i, t, e, s, r, n, o, a, h, l, u, c, d = !0) {
      ...
      while (t < e - s && w + M < n);
      let v = M === 0 ? 0 : (n - w) / M;
      const R = Oe(y, p, v), I = Oe(E, f, v), O = t - s, A = w, P = n + a * h(l, r, u);
      for (; t < e - s && w + M < P; ) C();
      v = M === 0 ? 0 : (P - w) / M;
...
`) {
      ...
      calculateImageOrLabelDimensions_(t, e, s, r, n, o, a, h, l, u, c, d, p, f, y, E) {
        ...
        (y || c !== 0) && (es[0] = O, is[0] = O, es[1] = A, Ai[1] = A, Ai[0] = O + R, Pi[0] = Ai[0], Pi[1] = A + I, is[1] = Pi[1]);
        let P;
        return c !== 0 ? (P = wi(Ue(), s, r, 1, 1, c, -s, -r), Vt(P, es), Vt(P, Ai), Vt(P, Pi), Vt(P, is), Ne(Math.min(es[0], Ai[0], Pi[0], is[0]), Math.min(es[1], Ai[1], Pi[1], is[1]), Math.max(es[0], Ai[0], Pi[0], is[0]), Math.max(es[1], Ai[1], Pi[1], is[1]), Er)) : Ne(Math.min(O, O + R), Math.min(A, A + I), Math.max(O, O + R), Math.max(A, A + I), Er), p && (M = Math.round(M), w = Math.round(w)), { drawImageX: M, drawImageY: w, drawImageW: C, drawImageH: v, originX: l, originY: u, declutterBox: { minX: Er[0], minY: Er[1], maxX: Er[2], maxY: Er[3], value: E }, canvasTransform: P, scale: d };
      }
      replayImageOrLabel_(t, e, s, r, n, o, a) {
        const h = !!(o || a), l = r.declutterBox, u = a ? a[2] * r.scale[0] / 2 : 0;
        return l.minX - u <= e[0] && l.maxX + u >= 0 && l.minY - u <= e[1] && l.maxY + u >= 0 && (h && this.replayTextBackground_(t, es, Ai, Pi, is, o, a), zm(t, r.canvasTransform, n, s, r.originX, r.originY, r.drawImageW, r.drawImageH, r.drawImageX, r.drawImageY, r.scale)), !0;
      }
      fill_(t) {
      ...
      execute_(t, e, s, r, n, o, a, h) {
        ...
        for (; c < d; ) {
          ...
          switch (b[0]) {
            ...
            case it.CIRCLE:
              p = b[1];
              const at = u[p], Pt = u[p + 1], Ut = u[p + 2], Wt = u[p + 3], ti = Ut - at, Bt = Wt - Pt, gi = Math.sqrt(ti * ti + Bt * Bt);
              t.moveTo(at + gi, Pt), t.arc(at, Pt, gi, 0, 2 * Math.PI, !0), ++c;
              break;
            case it.CLOSE_PATH:
              t.closePath(), ++c;
              break;
            case it.CUSTOM:
              p = b[1], f = b[2];
              const ls = b[3], pi = b[4], Oi = b[5];
              rt.geometry = ls, rt.feature = H, c in Y || (Y[c] = []);
              const ei = Y[c];
              Oi ? Oi(u, p, f, 2, ei) : (ei[0] = u[p], ei[1] = u[p + 1], ei.length = 2), l && (l.zIndex = b[6]), pi(ei, rt), ++c;
              break;
            case it.DRAW_IMAGE:
              p = b[1], f = b[2], I = b[3], y = b[4], E = b[5];
              let de = b[6];
              const We = b[7], us = b[8], cs = b[9], mi = b[10];
              let Ni = b[11];
              const ds = b[12];
              let fs = b[13];
              M = b[14] || "declutter";
              ...
              if (!I && b.length >= 20) {
                ...
                I = Pe.label, b[3] = I;
                const ki = b[23];
                y = (Pe.anchorX - ki) * this.pixelRatio, b[4] = y;
                const Ee = b[24];
              ...
              b.length > 25 && (eo = b[25]);
              let Ur, Us, gs;
              b.length > 17 ? (Ur = b[16], Us = b[17], gs = b[18]) : (Ur = Ls, Us = !1, gs = !1), mi && B ? Ni += Q : !mi && !B && (Ni -= Q);
              let io = 0;
              for (; p < f; p += 2) {
                if (eo && eo[io++] < fs / this.pixelRatio) continue;
                const Pe = this.calculateImageOrLabelDimensions_(I.width, I.height, u[p], u[p + 1], fs, de, y, E, us, cs, Ni, ds, n, Ur, Us || gs, H), ki = [t, e, I, Pe, We, Us ? J : null, gs ? V : null];
                if (h) {
                  let Ee, Le, fe;
                  if (qt) {
                    const Dt = f - p;
                    if (!qt[Dt]) {
                      qt[Dt] = { args: ki, declutterMode: M };
                      continue;
                    }
                    const ie = qt[Dt];
                    Ee = ie.args, Le = ie.declutterMode, delete qt[Dt], fe = vd(Ee);
                  }
                  let ii, si;
                  if (Ee && (Le !== "declutter" || !h.collides(fe)) && (ii = !0), (M !== "declutter" || !h.collides(Pe.declutterBox)) && (si = !0), Le === "declutter" && M === "declutter") {
                    const Dt = ii && si;
                    ii = Dt, si = Dt;
                  }
                  ii && (Le !== "none" && h.insert(fe), this.replayImageOrLabel_.apply(this, Ee)), si && (M !== "none" && h.insert(Pe.declutterBox), this.replayImageOrLabel_.apply(this, ki));
                } else this.replayImageOrLabel_.apply(this, ki);
              }
              ++c;
              break;
            case it.DRAW_CHARS:
              ...
              let Fi;
              ps in this.widths_ ? Fi = this.widths_[ps] : (Fi = {}, this.widths_[ps] = Fi);
              const Yr = _d(u, Bs, Br, 2), no = Math.abs(ms[0]) * Xc(ps, O, Fi);
              if (Xs || no <= Yr) {
                const Pe = this.textStates[A].textAlign, ki = (Yr - no) * fl(O, Pe), Ee = x0(u, Bs, Br, 2, O, ki, Jl, Math.abs(ms[0]), Xc, ps, Fi, B ? 0 : this.viewRotation_, Oa);
                t: if (Ee) {
                  const Le = [];
                  let fe, ii, si, Dt, ie;
                  if (P) for (fe = 0, ii = Ee.length; fe < ii; ++fe) {
                    ie = Ee[fe], si = ie[4], Dt = this.createLabel(si, A, "", P), y = ie[2] + (ms[0] < 0 ? -jr : jr), E = js * Dt.height + (0.5 - js) * 2 * jr * ms[1] / ms[0] - so;
                    const qe = this.calculateImageOrLabelDimensions_(Dt.width, Dt.height, ie[0], ie[1], Dt.width, Dt.height, y, E, 0, 0, ie[3], Xr, !1, Ls, !1, H);
                    if (h && M === "declutter" && h.collides(qe.declutterBox)) break t;
                    Le.push([t, e, Dt, qe, 1, null, null]);
                  }
                  if (F) for (fe = 0, ii = Ee.length; fe < ii; ++fe) {
                    ie = Ee[fe], si = ie[4], Dt = this.createLabel(si, A, F, ""), y = ie[2], E = js * Dt.height - so;
                    const qe = this.calculateImageOrLabelDimensions_(Dt.width, Dt.height, ie[0], ie[1], Dt.width, Dt.height, y, E, 0, 0, ie[3], Xr, !1, Ls, !1, H);
                    if (h && M === "declutter" && h.collides(qe.declutterBox)) break t;
                    Le.push([t, e, Dt, qe, 1, null, null]);
                  }
    ...
    class S0 {
      constructor(t, e, s, r, n, o, a) {
        this.maxExtent_ = t, this.overlaps_ = r, this.pixelRatio_ = s, this.resolution_ = e, this.renderBuffer_ = o, this.executorsByZIndex_ = {}, this.hitDetectionContext_ = null, this.hitDetectionTransform_ = Ue(), this.renderedContext_ = null, this.deferredZIndexContexts_ = {}, this.createExecutors_(n, a);
      }
      clip(t, e) {
      ...
      forEachFeatureAtCoordinate(t, e, s, r, n, o) {
        r = Math.round(r);
        const a = r * 2 + 1, h = wi(this.hitDetectionTransform_, r + 0.5, r + 0.5, 1 / e, -1 / e, -s, -t[0], -t[1]), l = !this.hitDetectionContext_;
        ...
        let c;
        this.renderBuffer_ !== void 0 && (c = Se(), Cs(c, t), Mo(c, e * (this.renderBuffer_ + r), c));
        const d = v0(r);
        let p;
        function f(R, I, O) {
    ...
    class pl extends xd {
      ...
      drawImages_(t, e, s, r) {
        ...
        for (let u = 0, c = n.length; u < c; u += 2) {
          ...
          if (l !== 0 || this.imageScale_[0] != 1 || this.imageScale_[1] != 1) {
            ...
            wi(a, f, y, 1, 1, l, -f, -y), o.save(), o.transform.apply(o, a), o.translate(f, y), o.scale(this.imageScale_[0], this.imageScale_[1]), o.drawImage(this.image_, this.imageOriginX_, this.imageOriginY_, this.imageWidth_, this.imageHeight_, -this.imageAnchorX_, -this.imageAnchorY_, this.imageWidth_, this.imageHeight_), o.restore();
      ...
      setFillStrokeStyle(t, e) {
        if (!t) this.fillState_ = null;
          ...
          const s = t.getColor();
          this.fillState_ = { fillStyle: hi(s || Re) };
        }
        if (!e) this.strokeState_ = null;
        else {
          const s = e.getColor(), r = e.getLineCap(), n = e.getLineDash(), o = e.getLineDashOffset(), a = e.getLineJoin(), h = e.getWidth(), l = e.getMiterLimit(), u = n || vi;
          this.strokeState_ = { lineCap: r !== void 0 ? r : cr, lineDash: this.pixelRatio_ === 1 ? u : u.map((c) => c * this.pixelRatio_), lineDashOffset: (o || Ri) * this.pixelRatio_, lineJoin: a !== void 0 ? a : dr, lineWidth: (h !== void 0 ? h : Mn) * this.pixelRatio_, miterLimit: l !== void 0 ? l : yn, strokeStyle: hi(s || xn) };
        }
      }
      setImageStyle(t) {
        let e;
      ...
      setTextStyle(t) {
        if (!t) this.text_ = "";
          ...
          if (!e) this.textFillState_ = null;
            ...
            const p = e.getColor();
            this.textFillState_ = { fillStyle: hi(p || Re) };
          }
          const s = t.getStroke();
          if (!s) this.textStrokeState_ = null;
            ...
            this.textStrokeState_ = { lineCap: f !== void 0 ? f : cr, lineDash: y || vi, lineDashOffset: E || Ri, lineJoin: M !== void 0 ? M : dr, lineWidth: w !== void 0 ? w : Mn, miterLimit: C !== void 0 ? C : yn, strokeStyle: hi(p || xn) };
          }
    ...
    const R0 = Object.freeze(Object.defineProperty({ __proto__: null, Circle: Os, Fill: Ze, Icon: Sn, IconImage: $h, Image: _n, RegularShape: wn, Stroke: ke, Style: ae, Text: Ko }, Symbol.toStringTag, { value: "Module" })), li = 0.5;
    function C0(i, t, e, s, r, n, o, a, h) {
      const l = r, u = i[0] * li, c = i[1] * li, d = Yt(u, c);
      d.imageSmoothingEnabled = !1;
      const p = d.canvas, f = new pl(d, li, r, null, o, a, null), y = e.length, E = Math.floor((256 * 256 * 256 - 1) / y), M = {};
      for (let C = 1; C <= y; ++C) {
    ...
    function b0(i, t, e) {
      const s = [];
      if (e) {
        const r = Math.floor(Math.round(i[0]) * li), n = Math.floor(Math.round(i[1]) * li), o = (kt(r, 0, e.width - 1) + kt(n, 0, e.height - 1) * e.width) * 4, a = e.data[o], h = e.data[o + 1], l = e.data[o + 2] + 256 * (h + 256 * a), u = Math.floor((256 * 256 * 256 - 1) / t.length);
      ...
      getFeatures(t) {
        return new Promise((e) => {
          if (this.frameState && !this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
            const s = this.frameState.size.slice(), r = this.renderedCenter_, n = this.renderedResolution_, o = this.renderedRotation_, a = this.renderedProjection_, h = this.wrappedRenderedExtent_, l = this.getLayer(), u = [], c = s[0] * li, d = s[1] * li;
            u.push(this.getRenderTransform(r, n, o, li, c, d, 0).slice());
            const p = l.getSource(), f = a.getExtent();
            if (p.getWrapX() && a.canWrapX() && !Wi(f, h)) {
              let y = h[0];
              const E = pt(f);
              let M = 0, w;
              for (; y < f[0]; ) --M, w = E * M, u.push(this.getRenderTransform(r, n, o, li, c, d, w).slice()), y += E;
              for (M = 0, y = h[2]; y > f[2]; ) ++M, w = E * M, u.push(this.getRenderTransform(r, n, o, li, c, d, w).slice()), y -= E;
            }
    ...
    class Sr extends Si {
      ...
      getPolygon(t) {
        ...
        return new oi(this.flatCoordinates.slice(e, r), this.layout, s);
      }
      getPolygons() {
        ...
        for (let o = 0, a = s.length; o < a; ++o) {
          ...
          const u = new oi(e.slice(n, l), t, h);
          r.push(u), n = l;
        }
        return r;
      }
    ...
    const B0 = Object.freeze(Object.defineProperty({ __proto__: null, Circle: oa, Geometry: No, GeometryCollection: aa, LineString: Qi, LinearRing: As, MultiLineString: wr, MultiPoint: Fn, MultiPolygon: Sr, Point: un, Polygon: oi, SimpleGeometry: Si }, Symbol.toStringTag, { value: "Module" })), Od = Ue();
    class Je {
      constructor(t, e, s, r, n, o) {
      ...
      transform(t) {
        ...
        if (e && s) {
          const r = Xt(s) / Xt(e);
          wi(Od, s[0], s[3], r, -r, 0, 0, 0), Vi(this.flatCoordinates_, 0, this.flatCoordinates_.length, 2, Od, this.flatCoordinates_);
        }
      }
      applyTransform(t) {
      ...
      enableSimplifyTransformed() {
        return this.simplifyTransformed = Cu((t, e) => {
          ...
          return r && (this.simplifiedGeometry_ = new Je(this.type_, s, r, 2, this.properties_, this.id_)), this.squaredTolerance_ = t, this.simplifiedGeometry_;
        }), this;
      }
    }
    ...
    class W0 extends Nd {
      constructor(t) {
        ...
        let s, r;
        Array.isArray(t.features) ? r = t.features : t.features && (s = t.features, r = s.getArray()), !e && s === void 0 && (s = new ri(r)), r !== void 0 && this.addFeaturesInternal(r), s !== void 0 && this.bindFeaturesCollection_(s);
      }
      addFeature(t) {
      ...
      setupChangeEvents_(t, e) {
        e instanceof Je || (this.featureChangeKeys_[t] = [xt(e, lt.CHANGE, this.handleFeatureChange_, this), xt(e, Ks.PROPERTYCHANGE, this.handleFeatureChange_, this)]);
      }
      addToIndex_(t, e) {
        let s = !0;
        if (e.getId() !== void 0) {
          ...
          if (!(r in this.idIndex_)) this.idIndex_[r] = e;
            ...
            n instanceof Je ? Array.isArray(n) ? n.push(e) : this.idIndex_[r] = [n, e] : s = !1;
          } else s = !1;
        }
      ...
      addFeaturesInternal(t) {
        ...
        if (this.featuresRtree_ && this.featuresRtree_.load(e, r), this.hasListener(je.ADDFEATURE)) for (let n = 0, o = s.length; n < o; n++) this.dispatchEvent(new ss(je.ADDFEATURE, s[n]));
      }
      ...
      forEachFeatureAtCoordinateDirect(t, e) {
        ...
        return this.forEachFeatureInExtent(s, function(r) {
          ...
          if (n instanceof Je || n.intersectsCoordinate(t)) return e(r);
        });
      }
      ...
      forEachFeatureIntersectingExtent(t, e) {
        return this.forEachFeatureInExtent(t, function(s) {
          ...
          if (r instanceof Je || r.intersectsExtent(t)) {
            const n = e(s);
            if (n) return n;
          }
        });
      ...
      getClosestFeatureToCoordinate(t, e) {
        ...
        return e = e || Qr, this.featuresRtree_.forEachInExtent(h, function(l) {
          if (e(l)) {
            ...
            if (a = u instanceof Je ? 0 : u.closestPointXY(s, r, o, a), a < c) {
              n = l;
              const d = Math.sqrt(a);
    ...
    function q0(i, t) {
      ...
      const n = [0, 0, e.width, e.height], o = Up(Ue(), s, s);
    ...
    class Ud {
      constructor(t, e, s, r, n, o, a) {
        ...
        const u = ni(s), c = an(s), d = on(s), p = nn(s), f = this.transformInv_(u), y = this.transformInv_(c), E = this.transformInv_(d), M = this.transformInv_(p), w = iy + (o ? Math.max(0, Math.ceil(Math.log2(bs(s) / (o * o * 256 * 256)))) : 0);
    ...
    function ry(i, t, e, s, r, n, o, a, h, l, u, c, d, p) {
      ...
      return a.getTriangles().forEach(function(R, I, O) {
        ...
        if (f.save(), f.beginPath(), sy() || !c) {
          f.moveTo(rt, ot);
          const Ut = 4, Wt = Q - rt, ti = B - ot;
          for (let Bt = 0; Bt < Ut; Bt++) f.lineTo(rt + y((Bt + 1) * Wt / Ut), ot + y(Bt * ti / (Ut - 1))), Bt != Ut - 1 && f.lineTo(rt + y((Bt + 1) * Wt / Ut), ot + y((Bt + 1) * ti / (Ut - 1)));
          f.lineTo(H, W);
...
`;
    ...
    function gy(i, t, e, s, r, n, o, a, h, l, u, c, d, p) {
      ...
      i.bindFramebuffer(i.FRAMEBUFFER, E), i.viewport(0, 0, f, y);
      {
        ...
        i.bindTexture(i.TEXTURE_2D, C), i.uniform1i(J, 0), a.getTriangles().forEach(function(H, W, mt) {
          const et = H.source, b = H.target, { u1: at, v1: Pt, u0: Ut, v0: Wt, u2: ti, v2: Bt } = P(b), gi = (et[0][0] - A[0]) / r / v, ls = -(et[0][1] - A[1]) / r / R, pi = (et[1][0] - A[0]) / r / v, Oi = -(et[1][1] - A[1]) / r / R, ei = (et[2][0] - A[0]) / r / v, de = -(et[2][1] - A[1]) / r / R;
          F.push(at, Pt, Ut, Wt, ti, Bt), z.push(pi, Oi, gi, ls, ei, de);
        });
    ...
    class py extends El {
      constructor(t) {
        ...
        this.clipExtent_ = e.canWrapX() ? r ? Fe(s, r) : s : r;
    ...
    function Vd(i, t) {
      ...
      e.extent && (t = Fe(t, qi(e.extent, i.viewState.projection)));
    ...
    class vy extends Sd {
      ...
      renderFrame(t, e) {
        ...
        wi(this.tempTransform, C / 2, v / 2, V, V, 0, -C / 2, -v / 2), r.extent && this.clipUnrotated(Y, t, R), c.getInterpolate() || (Y.imageSmoothingEnabled = !1), this.preRender(Y, t);
        const Q = Object.keys(P).map(Number);
        Q.sort(Bi);
        let B;
        const rt = [], ot = [];
        for (let H = Q.length - 1; H >= 0; --H) {
          const W = Q[H], mt = c.getTilePixelSize(W, l, o), et = p.getResolution(W) / y, b = mt[0] * et * V, at = mt[1] * et * V, Pt = p.getTileCoordForCoordAndZ(ni(A), W), Ut = p.getTileCoordExtent(Pt), Wt = Vt(this.tempTransform, [w * (Ut[0] - A[0]) / y, w * (A[3] - Ut[3]) / y]), ti = w * c.getGutterForProjection(o);
          for (const Bt of P[W]) {
            if (Bt.getState() !== Z.LOADED) continue;
            const gi = Bt.tileCoord, ls = Pt[1] - gi[1], pi = Math.round(Wt[0] - (ls - 1) * b), Oi = Pt[2] - gi[2], ei = Math.round(Wt[1] - (Oi - 1) * at), de = Math.round(Wt[0] - ls * b), We = Math.round(Wt[1] - Oi * at), us = pi - de, cs = ei - We, mi = Q.length === 1;
            let Ni = !1;
            B = [de, We, de + us, We, de + us, We + cs, de, We + cs];
            for (let ds = 0, fs = rt.length; ds < fs; ++ds) if (!mi && W < ot[ds]) {
              const qt = rt[ds];
              ne([de, We, de + us, We + cs], [qt[0], qt[3], qt[4], qt[7]]) && (Ni || (Y.save(), Ni = !0), Y.beginPath(), Y.moveTo(B[0], B[1]), Y.lineTo(B[2], B[3]), Y.lineTo(B[4], B[5]), Y.lineTo(B[6], B[7]), Y.moveTo(qt[6], qt[7]), Y.lineTo(qt[4], qt[5]), Y.lineTo(qt[2], qt[3]), Y.lineTo(qt[0], qt[1]), Y.clip());
            }
            rt.push(B), ot.push(W), this.drawTile(Bt, t, de, We, us, cs, ti, mi), Ni && Y.restore(), this.renderedTiles.unshift(Bt), this.updateUsedTiles(t.usedTiles, c, Bt);
          }
        }
    ...
    class $d {
      ...
      getTileCoordCenter(t) {
        const e = this.getOrigin(t[0]), s = this.getResolution(t[0]), r = ve(this.getTileSize(t[0]), this.tmpSize_);
        return [e[0] + (t[1] + 0.5) * r[0] * s, e[1] - (t[2] + 0.5) * r[1] * s];
      }
      getTileCoordExtent(t, e) {
        const s = this.getOrigin(t[0]), r = this.getResolution(t[0]), n = ve(this.getTileSize(t[0]), this.tmpSize_), o = s[0] + t[1] * n[0] * r, a = s[1] - (t[2] + 1) * n[1] * r, h = o + n[0] * r, l = a + n[1] * r;
        return Ne(o, a, h, l, e);
      }
    ...
    class Py extends Nd {
      ...
      getTilePixelSize(t, e, s) {
        const r = this.getTileGridForProjection(s), n = this.getTilePixelRatio(e), o = ve(r.getTileSize(t), this.tmpSize);
...
`);
    ...
    class _t extends tt {
      ...
      writeFeatureElement(t, e, s) {
        ...
        if (e.hasProperties()) {
          ...
          for (const d in c) {
            const p = c[d];
            p != null && (h.push(d), l.push(p), d == a || typeof p.getSimplifiedGeometry == "function" ? d in n.serializers[o] || (n.serializers[o][d] = K(this.writeGeometryElement, this)) : d in n.serializers[o] || (n.serializers[o][d] = K(Xe)));
          }
        }
    ...
    var Gs = 1, zs = 2, Ar = 3, i1 = 4, Fl = 5, rf = 6378137, s1 = 6356752314e-3, nf = 0.0066943799901413165, Dn = 484813681109536e-20, D = Math.PI / 2, r1 = 0.16666666666666666, n1 = 0.04722222222222222, o1 = 0.022156084656084655, q = 1e-10, te = 0.017453292519943295, ui = 57.29577951308232, Ct = Math.PI / 4, Gn = Math.PI * 2, ee = 3.14159265359, Te = {};
    ...
    function p1(i) {
      ...
      l.forEach(h), !i.long0 && i.longc && (i.projName === "Albers_Conic_Equal_Area" || i.projName === "Lambert_Azimuthal_Equal_Area") && (i.long0 = i.longc), !i.lat_ts && i.lat1 && (i.projName === "Stereographic_South_Pole" || i.projName === "Polar Stereographic (variant B)") ? (i.lat0 = ci(i.lat1 > 0 ? 90 : -90), i.lat_ts = i.lat1) : !i.lat_ts && i.lat0 && i.projName === "Polar_Stereographic" && (i.lat_ts = i.lat0, i.lat0 = ci(i.lat0 > 0 ? 90 : -90));
    }
    function df(i) {
      var t = c1(i), e = t[0], s = {};
    ...
    function R1() {
      var i = this.b / this.a;
      this.es = 1 - i * i, "x0" in this || (this.x0 = 0), "y0" in this || (this.y0 = 0), this.e = Math.sqrt(this.es), this.lat_ts ? this.sphere ? this.k0 = Math.cos(this.lat_ts) : this.k0 = di(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)) : this.k0 || (this.k ? this.k0 = this.k : this.k0 = 1);
    }
    function C1(i) {
      var t = i.x, e = i.y;
      if (e * ui > 90 && e * ui < -90 && t * ui > 180 && t * ui < -180) return null;
      var s, r;
      ...
      if (this.sphere) s = this.x0 + this.a * this.k0 * $(t - this.long0), r = this.y0 + this.a * this.k0 * Math.log(Math.tan(Ct + 0.5 * e));
        ...
        var n = Math.sin(e), o = Qe(this.e, e, n);
    ...
    function fi(i, t) {
      if (!(this instanceof fi)) return new fi(i);
      t = t || function(l) {
        if (l) throw l;
      };
      var e = v1(i);
      ...
      var s = fi.projections.get(e.projName);
      if (!s) {
    ...
    fi.projections = F1, fi.projections.start();
    function K1(i, t) {
    ...
    function Ef(i, t, e) {
      ...
      return isNaN(r.x) ? (console.log("Failed to find a grid shift table for location '" + -s.x * ui + " " + s.y * ui + " tried: '" + n + "'"), -1) : (e.x = -r.x, e.y = r.y, 0);
    }
    function tx(i, t, e) {
    ...
    function Sa(i, t, e, s) {
      ...
      var n = e.z !== void 0;
      if (ex(e), i.datum && t.datum && ix(i, t) && (r = new fi("WGS84"), e = Sa(i, r, e, s), i = r), s && i.axis !== "enu" && (e = wf(i, !1, e)), i.projName === "longlat") e = { x: e.x * te, y: e.y * te, z: e.z || 0 };
      else if (i.to_meter && (e = { x: e.x * i.to_meter, y: e.y * i.to_meter, z: e.z || 0 }), e = i.inverse(e), !e) return;
      if (i.from_greenwich && (e.x += i.from_greenwich), e = Q1(i.datum, t.datum, e), !!e) return t.from_greenwich && (e = { x: e.x - t.from_greenwich, y: e.y, z: e.z || 0 }), t.projName === "longlat" ? e = { x: e.x * ui, y: e.y * ui, z: e.z || 0 } : (e = t.forward(e), t.to_meter && (e = { x: e.x / t.to_meter, y: e.y / t.to_meter, z: e.z || 0 })), s && t.axis !== "enu" ? wf(t, !0, e) : (e && !n && delete e.z, e);
    }
    var Rf = fi("WGS84");
    function Ul(i, t, e, s) {
      var r, n, o;
    ...
    function Cf(i) {
      return i instanceof fi ? i : i.oProj ? i.oProj : fi(i);
    }
    function le(i, t, e) {
      i = Cf(i);
      var s = !1, r;
    ...
    var bf = 6, Tf = "AJSAJS", If = "AFAFAF", Or = 65, Ie = 73, Ye = 79, jn = 86, Xn = 90;
    ...
    function lx(i, t, e) {
      ...
      o > Xn && (o = o - Xn + Or - 1, h = !0), (o === Ie || r < Ie && o > Ie || (o > Ie || r < Ie) && h) && o++, (o === Ye || r < Ye && o > Ye || (o > Ye || r < Ye) && h) && (o++, o === Ie && o++), o > Xn && (o = o - Xn + Or - 1), a > jn ? (a = a - jn + Or - 1, h = !0) : h = !1, (a === Ie || n < Ie && a > Ie || (a > Ie || n < Ie) && h) && a++, (a === Ye || n < Ye && a > Ye || (a > Ye || n < Ye) && h) && (a++, a === Ie && a++), a > jn && (a = a - jn + Or - 1);
...
northing meters` + i;
    ...
    function Tx(i) {
      var t = Math.abs(i);
      return t = bx(t * (1 + t / (Ae(1, t) + 1))), i < 0 ? -t : t;
    }
    function Wl(i, t) {
    ...
    function Lx(i) {
      ...
      e = Math.atan2(s, o * r), t = Math.atan2(n * r, Ae(s, r * o)), t = Tx(Math.tan(t));
    ...
    function Ox(i) {
      ...
      if (Math.abs(t) <= 2.623395162778) {
        ...
        e = Math.atan2(o * l, Ae(h, l * a)), t = Math.atan2(h, l * a), s = $(t + this.long0), r = Wl(this.cgb, e);
      } else s = 1 / 0, r = 1 / 0;
      return i.x = s, i.y = r, i;
    }
    ...
    function Vx(i) {
      var t, e, s, r, n;
      if (i.x = (i.x - this.x0) / this.a, i.y = (i.y - this.y0) / this.a, i.x /= this.k0, i.y /= this.k0, n = Ae(i.x, i.y)) {
    ...
    function fE() {
      if (this.lat2 || (this.lat2 = this.lat1), this.k0 || (this.k0 = 1), this.x0 = this.x0 || 0, this.y0 = this.y0 || 0, !(Math.abs(this.lat1 + this.lat2) < q)) {
        ...
        var t = Math.sin(this.lat1), e = Math.cos(this.lat1), s = di(this.e, t, e), r = Qe(this.e, this.lat1, t), n = Math.sin(this.lat2), o = Math.cos(this.lat2), a = di(this.e, n, o), h = Qe(this.e, this.lat2, n), l = Qe(this.e, this.lat0, Math.sin(this.lat0));
    ...
    function gE(i) {
      ...
      if (s > q) r = Qe(this.e, e, Math.sin(e)), n = this.a * this.f0 * Math.pow(r, this.ns);
      else {
    ...
    function sM() {
      this.sphere || (this.k0 = di(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)));
    }
    function rM(i) {
    ...
    function gw(i) {
      ...
      s < 0 ? s = 0 : s >= zr && (s = zr - 1), e = ui * (e - uw * s);
    ...
    function Iw(i) {
      ...
      if (t = t - this.long0, this.shape === "ellipse") {
        ...
        s = this.radius_g - r, this.flip_axis ? (i.x = this.radius_g_1 * Math.atan(n / Ae(o, s)), i.y = this.radius_g_1 * Math.atan(o / s)) : (i.x = this.radius_g_1 * Math.atan(n / s), i.y = this.radius_g_1 * Math.atan(o / Ae(n, s)));
      } else this.shape === "sphere" && (s = Math.cos(e), r = Math.cos(t) * s, n = Math.sin(t) * s, o = Math.sin(e), s = this.radius_g - r, this.flip_axis ? (i.x = this.radius_g_1 * Math.atan(n / Ae(o, s)), i.y = this.radius_g_1 * Math.atan(o / s)) : (i.x = this.radius_g_1 * Math.atan(n / s), i.y = this.radius_g_1 * Math.atan(o / Ae(n, s))));
      return i.x = i.x * this.a, i.y = i.y * this.a, i;
    }
    function Aw(i) {
      var t = -1, e = 0, s = 0, r, n, o, a;
      if (i.x = i.x / this.a, i.y = i.y / this.a, this.shape === "ellipse") {
        this.flip_axis ? (s = Math.tan(i.y / this.radius_g_1), e = Math.tan(i.x / this.radius_g_1) * Ae(1, s)) : (e = Math.tan(i.x / this.radius_g_1), s = Math.tan(i.y / this.radius_g_1) * Ae(1, e));
    ...
    function Uw(i) {
      ...
      var t, e, s, r;
      if (e = Ae(i.x, i.y = this.am1 - i.y), r = Yl(this.am1 + this.m1 - e, this.es, this.en), (t = Math.abs(r)) < D) t = Math.sin(r), s = e * Math.atan2(i.x, i.y) * Math.sqrt(1 - this.es * t * t) / Math.cos(r);
    ...
    function jw(i) {
      i.x = (i.x - (this.x0 || 0)) / this.a, i.y = (i.y - (this.y0 || 0)) / this.a;
      var t, e, s = Ae(i.x, i.y = this.cphi1 - i.y);
    ...
    le.defaultDatum = "WGS84", le.Proj = fi, le.WGS84 = new le.Proj("WGS84"), le.Point = Nr, le.toPoint = Sf, le.defs = ye, le.nadgrid = B1, le.transform = Sa, le.mgrs = sx, le.version = "__VERSION__", Ww(le);
    ...
    class qw extends Ve {
      ...
      handleMapChanged() {
        ...
        const e = this.getMap();
        if (e) {
          this.mapPostrenderListenerKey = xt(e, Ii.POSTRENDER, this.render, this), this.updatePixelPosition();
        ...
        (function(e, s) {
          ...
          function de(g, m, _) {
            switch (g.operator) {
              ...
              case "propertyislessthanorequalto":
                return pi(g, m, _) || Bt(g, m, _);
              case "propertyisnotequalto":
                return Oi(g, m, _);
              case "propertyisgreaterthan":
                return gi(g, m, _);
              case "propertyisgreaterthanorequalto":
                return pi(g, m, _) || gi(g, m, _);
          ...
          function Ur(g, m, _, x) {
            ...
            for (var S = [], T = 0, N = 0; N < g.rules.length; N += 1) {
              var j = g.rules[N];
              Ni(j, _) && (j.elsefilter ? (S.push(j), T += 1) : j.filter ? mi(j.filter, m, x) && S.push(j) : S.push(j));
            }
          ...
          function ii(g) {
            ...
            return m || (m = new Promise(function(_, x) {
              var S = new Image();
              S.onload = function() {
                ro(g, { url: g, image: S, width: S.naturalWidth, height: S.naturalHeight }), Fi(g, Br), _(g);
              }, S.onerror = function() {
                Fi(g, js), x();
              }, S.src = g;
            }), Fi(g, Bs), ki(g, m), m);
          ...
          function Kf(g, m, _) {
            ...
            for (var U = g.getLength(), X = Math.max(m, 0.1), ct = _.initialGap || 0, Mt = 0, yt = [].concat(x[0]), Lt = [].concat(x[1]), Ot = 0, Ht = []; ct <= U; ) {
              ...
              if (Ot + Jt < ct) {
                ...
                var Me = ct - Ot, se = c2(yt, Lt, Me), De = iu(yt, Lt, _.invertY);
                (!_.extent || o.containsCoordinate(_.extent, se)) && (se.push(De), Ht.push(se)), ct += X;
              }
            }
            return Ht;
          }
          ...
          function b2(g) {
            ...
            var se = g.fill ? g.fill.styling : {}, De = b(se.fill, null, null, "#000000"), za = b(se.fillOpacity, null, null, 1), Ua = { text: m, font: j, offsetX: Mt, offsetY: yt, rotation: Math.PI * X / 180, textAlign: Ot, textBaseline: Jt, fill: new s.Fill({ color: Wr(De, za) }) };
            if (g.halo) {
          ...
          function nu(g, m, _, x) {
            ...
            switch (Mt) {
              case "Point":
              case "MultiPoint":
                Di(yt, N, m, Ys, _), Di(yt, j, m, ru, _);
                break;
              case "LineString":
              case "MultiLineString":
                Di(yt, T, m, tg, _), X.strictGeometryMatch || Di(yt, N, m, I2, _), Di(yt, j, m, ru, _);
                break;
              case "Polygon":
              case "MultiPolygon":
                Di(yt, S, m, C2, _), X.strictGeometryMatch || Di(yt, T, m, tg, _), Di(yt, N, m, A2, _), Di(yt, j, m, ru, _);
                break;
              default:
    ...
    `, this.shadowRoot.appendChild(t), this.overlay = new qw({ element: t, offset: [10, 10], positioning: "center-left" }), this.map.addOverlay(this.overlay), this.map.on("pointermove", (e) => {
      ...
      getStyle(t, e = null) {
        ...
        switch (t) {
          case "Polygon":
          case "MultiPolygon":
            return new ae({ fill: new Ze({ color: s }), stroke: new ke({ color: r, width: n }) });
          case "LineString":
            return new ae({ stroke: new ke({ color: r, width: n }) });
          case "Point":
            return new ae({ image: new Os({ radius: 5, fill: new Ze({ color: s }), stroke: new ke({ color: r, width: 1 }) }) });
          default:
  ...
  `;
      ...
      updateLayerStyle(t, { fillColor: e, strokeColor: s, strokeWidth: r }) {
        t.setStyle((n) => {
          ...
          return o === "Point" ? new ae({ image: new Os({ radius: 5, fill: new Ze({ color: e }), stroke: new ke({ color: s, width: r }) }) }) : o === "Polygon" || o === "MultiPolygon" ? new ae({ fill: new Ze({ color: e }), stroke: new ke({ color: s, width: r }) }) : o === "LineString" ? new ae({ stroke: new ke({ color: s, width: r }) }) : o === "Circle" ? new ae({ stroke: new ke({ color: s, width: r }) }) : new ae({ fill: new Ze({ color: e }), stroke: new ke({ color: s, width: r }) });
        });
      }
  ...
  `), _i(Kl, "properties", { gmlFile: { type: String, reflect: !0 }, xmlFile: { type: String, reflect: !0 }, sldFile: { type: String, reflect: !0 } });
    class Hl extends Ui {
      constructor() {
  ...
  `), _i(Hl, "properties", { gmlFile: { type: String, reflect: !0 }, xmlFile: { type: String, reflect: !0 }, sldFile: { type: String, reflect: !0 } });
    class Wf extends Ui {
      render() {
  ...
  `);
    ...
    _i(qf, "properties", { route: { type: String } }), customElements.define("main-component", qf), customElements.define("map-viewer", Kl), customElements.define("map-template", Hl), customElements.define("map-example", Wf);
  });
});
