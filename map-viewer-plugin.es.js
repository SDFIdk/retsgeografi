    ...
    for (const ge of jt)
      if (ge.type === "childList")
        for (const _s of ge.addedNodes)
          _s.tagName === "LINK" && _s.rel === "modulepreload" && Ki(_s);
...
(function(qi) {
  typeof define == "function" && define.amd ? define(qi) : qi();
})(function() {
  var qi = Object.defineProperty, Vi = (n, t, e) => t in n ? qi(n, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[t] = e, yn = (n, t, e) => Vi(n, typeof t != "symbol" ? t + "" : t, e);
  /**
  * @license
  ...
  */
  ...
  const fg = (n) => new hu(typeof n == "string" ? n : n + "", void 0, _s), ja = (n, ...t) => {
    const e = n.length === 1 ? n[0] : t.reduce((s, i, r) => s + ((o) => {
      if (o._$cssResult$ === !0) return o.cssText;
      if (typeof o == "number") return o;
      throw Error("Value passed to 'css' function must be a 'css' function result: " + o + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
    })(i) + n[r + 1], n[0]);
    return new hu(e, n, _s);
  }, gg = (n, t) => {
  ...
  * SPDX-License-Identifier: BSD-3-Clause
  */
  const { is: pg, defineProperty: mg, getOwnPropertyDescriptor: _g, getOwnPropertyNames: yg, getOwnPropertySymbols: xg, getPrototypeOf: Eg } = Object, qs = globalThis, uu = qs.trustedTypes, Mg = uu ? uu.emptyScript : "", cu = qs.reactiveElementPolyfillSupport, Zi = (n, t) => n, Wa = { toAttribute(n, t) {
    switch (t) {
      case Boolean:
        n = n ? Mg : null;
        break;
  ...
  Vs.elementStyles = [], Vs.shadowRootOptions = { mode: "open" }, Vs[Zi("elementProperties")] = /* @__PURE__ */ new Map(), Vs[Zi("finalized")] = /* @__PURE__ */ new Map(), cu == null || cu({ ReactiveElement: Vs }), (qs.reactiveElementVersions ?? (qs.reactiveElementVersions = [])).push("2.0.4");
  /**
  * @license
  * Copyright 2017 Google LLC
  * SPDX-License-Identifier: BSD-3-Clause
  */
  const oo = globalThis, ao = oo.trustedTypes, gu = ao ? ao.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, pu = "$lit$", zn = `lit$${Math.random().toFixed(9).slice(2)}$`, mu = "?" + zn, wg = `<${mu}>`, ys = document, $i = () => ys.createComment(""), Hi = (n) => n === null || typeof n != "object" && typeof n != "function", Xa = Array.isArray, Sg = (n) => Xa(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", Ya = `[ 	
\f\r]`, Ji = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _u = /-->/g, yu = />/g, xs = RegExp(`>|${Ya}(?:([^\\s"'>=/]+)(${Ya}*=${Ya}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), xu = /'/g, Eu = /"/g, Mu = /^(?:script|style|textarea|title)$/i, vg = (n) => (t, ...e) => ({ _$litType$: n, strings: t, values: e }), Es = vg(1), Ks = Symbol.for("lit-noChange"), Zt = Symbol.for("lit-nothing"), wu = /* @__PURE__ */ new WeakMap(), Ms = ys.createTreeWalker(ys, 129);
  function Su(n, t) {
    if (!Xa(n) || !n.hasOwnProperty("raw")) throw Error("invalid template strings array");
  ...
  const Rg = (n, t) => {
    ...
    for (let a = 0; a < e; a++) {
      const h = n[a];
      let l, u, c = -1, d = 0;
      for (; d < h.length && (o.lastIndex = d, u = o.exec(h), u !== null); ) d = o.lastIndex, o === Ji ? u[1] === "!--" ? o = _u : u[1] !== void 0 ? o = yu : u[2] !== void 0 ? (Mu.test(u[2]) && (i = RegExp("</" + u[2], "g")), o = xs) : u[3] !== void 0 && (o = xs) : o === xs ? u[0] === ">" ? (o = i ?? Ji, c = -1) : u[1] === void 0 ? c = -2 : (c = o.lastIndex - u[2].length, l = u[1], o = u[3] === void 0 ? xs : u[3] === '"' ? Eu : xu) : o === Eu || o === xu ? o = xs : o === _u || o === yu ? o = Ji : (o = xs, i = void 0);
      const p = o === xs && n[a + 1].startsWith("/>") ? " " : "";
      r += o === Ji ? h + wg : c >= 0 ? (s.push(l), h.slice(0, c) + pu + h.slice(c) + zn + p) : h + zn + (c === -2 ? a : p);
    }
  ...
  class Qi {
    constructor({ strings: t, _$litType$: e }, s) {
      ...
      if (this.el = Qi.createElement(l, s), Ms.currentNode = this.el.content, e === 2 || e === 3) {
        const c = this.el.content.firstChild;
        c.replaceWith(...c.childNodes);
      }
      for (; (i = Ms.nextNode()) !== null && h.length < a; ) {
        if (i.nodeType === 1) {
          if (i.hasAttributes()) for (const c of i.getAttributeNames()) if (c.endsWith(pu)) {
            const d = u[o++], p = i.getAttribute(c).split(zn), f = /([.?@])?(.*)/.exec(d);
            h.push({ type: 1, index: r, name: f[2], strings: p, ctor: f[1] === "." ? bg : f[1] === "?" ? Tg : f[1] === "@" ? Ig : ho }), i.removeAttribute(c);
          } else c.startsWith(zn) && (h.push({ type: 6, index: r }), i.removeAttribute(c));
          if (Mu.test(i.tagName)) {
            const c = i.textContent.split(zn), d = c.length - 1;
            if (d > 0) {
              i.textContent = ao ? ao.emptyScript : "";
              for (let p = 0; p < d; p++) i.append(c[p], $i()), Ms.nextNode(), h.push({ type: 2, index: ++r });
              i.append(c[d], $i());
            }
          }
          ...
          let c = -1;
          for (; (c = i.data.indexOf(zn, c + 1)) !== -1; ) h.push({ type: 7, index: r }), c += zn.length - 1;
        }
        r++;
      }
    }
  ...
  function Zs(n, t, e = n, s) {
    var i, r;
    if (t === Ks) return t;
    let o = s !== void 0 ? (i = e._$Co) == null ? void 0 : i[s] : e._$Cl;
    const a = Hi(t) ? void 0 : t._$litDirective$;
    return (o == null ? void 0 : o.constructor) !== a && ((r = o == null ? void 0 : o._$AO) == null || r.call(o, !1), a === void 0 ? o = void 0 : (o = new a(n), o._$AT(n, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = o : e._$Cl = o), o !== void 0 && (t = Zs(n, o._$AS(n, t.values), o, s)), t;
  }
  let Cg = class {
    constructor(n, t) {
    ...
    u(n) {
      const { el: { content: t }, parts: e } = this._$AD, s = ((n == null ? void 0 : n.creationScope) ?? ys).importNode(t, !0);
      Ms.currentNode = s;
      let i = Ms.nextNode(), r = 0, o = 0, a = e[0];
      for (; a !== void 0; ) {
        if (r === a.index) {
          let h;
        ...
        r !== (a == null ? void 0 : a.index) && (i = Ms.nextNode(), r++);
      }
    ...
    _$AI(t, e = this) {
      t = Zs(this, t, e), Hi(t) ? t === Zt || t == null || t === "" ? (this._$AH !== Zt && this._$AR(), this._$AH = Zt) : t !== this._$AH && t !== Ks && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Sg(t) ? this.k(t) : this._(t);
    }
    O(t) {
    ...
    _(t) {
      this._$AH !== Zt && Hi(this._$AH) ? this._$AA.nextSibling.data = t : this.T(ys.createTextNode(t)), this._$AH = t;
    }
    $(t) {
      var e;
    ...
    k(t) {
      ...
      const e = this._$AH;
      let s, i = 0;
      for (const r of t) i === e.length ? e.push(s = new cg(this.O($i()), this.O($i()), this, this.options)) : s = e[i], s._$AI(r), i++;
  ...
  class ho {
    ...
    _$AI(t, e = this, s, i) {
      ...
      let o = !1;
      if (r === void 0) t = Zs(this, t, e, 0), o = !Hi(t) || t !== this._$AH && t !== Ks, o && (this._$AH = t);
      else {
        const a = t;
        let h, l;
        for (t = r[0], h = 0; h < r.length - 1; h++) l = Zs(this, a[s + h], e, h), l === Ks && (l = this._$AH[h]), o || (o = !Hi(l) || l !== this._$AH[h]), l === Zt ? t = Zt : t !== Zt && (t += (l ?? "") + r[h + 1]), this._$AH[h] = l;
      }
      o && !i && this.j(t);
    }
    j(t) {
  ...
  class Ig extends ho {
    ...
    _$AI(t, e = this) {
      if ((t = Zs(this, t, e, 0) ?? Zt) === Ks) return;
  ...
  const Pg = (n, t, e) => {
    ...
    if (i === void 0) {
      ...
      s._$litPart$ = i = new qa(t.insertBefore($i(), r), r, void 0, e ?? {});
    }
    return i._$AI(n), i;
  };
  /**
  ...
  */
  ...
  Un._$litElement$ = !0, Un.finalized = !0, (Ki = globalThis.litElementHydrateSupport) == null || Ki.call(globalThis, { LitElement: Un });
  const Ru = globalThis.litElementPolyfillSupport;
  Ru == null || Ru({ LitElement: Un }), (globalThis.litElementVersions ?? (globalThis.litElementVersions = [])).push("4.1.1");
  class xn {
    constructor(t) {
  ...
  const $s = { PROPERTYCHANGE: "propertychange" };
  class lo {
    constructor() {
      this.disposed = !1;
    }
  ...
  function Cu(n) {
    ...
    return function() {
      ...
      return (!e || this !== s || !jn(i, e)) && (s = this, e = i, t = n.apply(this, arguments)), t;
    };
  }
  function kg(n) {
    function t() {
  ...
  class co extends lo {
    ...
    removeEventListener(t, e) {
      ...
      if (!s) return;
      const i = s.indexOf(e);
      i !== -1 && (this.pendingRemovals_ && t in this.pendingRemovals_ ? (s[i] = Hs, ++this.pendingRemovals_[t]) : (s.splice(i, 1), s.length === 0 && delete this.listeners_[t]));
    }
  }
  ...
  class Ve extends nr {
    ...
    notify(t, e) {
      let s;
      s = `change:${t}`, this.hasListener(s) && this.dispatchEvent(new bu(s, t, e)), s = $s.PROPERTYCHANGE, this.hasListener(s) && this.dispatchEvent(new bu(s, t, e));
    }
  ...
  const Ge = { PRERENDER: "prerender", POSTRENDER: "postrender", PRECOMPOSE: "precompose", POSTCOMPOSE: "postcompose", RENDERCOMPLETE: "rendercomplete" }, ie = { ANIMATING: 0, INTERACTING: 1 }, Ke = { CENTER: "center", RESOLUTION: "resolution", ROTATION: "rotation" }, Bg = 42, $a = 256, Ha = { radians: 6370997 / (2 * Math.PI), degrees: 2 * Math.PI * 6370997 / 360, ft: 0.3048, m: 1, "us-ft": 1200 / 3937 };
  let _o = class {
    constructor(n) {
  ...
  const sr = 6378137, ti = Math.PI * sr, jg = [-ti, -ti, ti, ti], Wg = [-180, -85, 180, 85], yo = sr * Math.log(Math.tan(Math.PI / 2));
  class ei extends _o {
    constructor(t) {
  ...
  const Pu = [new ei("EPSG:3857"), new ei("EPSG:102100"), new ei("EPSG:102113"), new ei("EPSG:900913"), new ei("http://www.opengis.net/def/crs/EPSG/0/3857"), new ei("http://www.opengis.net/gml/srs/epsg.xml#3857")];
  function Xg(n, t, e, s) {
    const i = n.length;
  ...
  function Yg(n, t, e, s) {
    const i = n.length;
    e = e > 1 ? e : 2, s = s ?? e, t === void 0 && (e > 2 ? t = n.slice() : t = new Array(i));
    for (let r = 0; r < i; r += s) t[r] = 180 * n[r] / ti, t[r + 1] = 360 * Math.atan(Math.exp(n[r + 1] / sr)) / Math.PI - 90;
    return t;
  }
  ...
  function vs(n, t, e) {
    ...
    s in ni || (ni[s] = {}), ni[s][i] = e;
  }
  function Eo(n, t) {
    return n in ni && t in ni[n] ? ni[n][t] : null;
  }
  const $t = { UNKNOWN: 0, INTERSECTING: 1, ABOVE: 2, RIGHT: 4, BELOW: 8, LEFT: 16 };
  function Qa(n) {
    const t = Se();
    for (let e = 0, s = n.length; e < s; ++e) Cs(t, n[e]);
    return t;
  }
  function Zg(n, t, e) {
  ...
  function So(n, t) {
    ...
    let h = $t.UNKNOWN;
    return o < e ? h = h | $t.LEFT : o > i && (h = h | $t.RIGHT), a < s ? h = h | $t.BELOW : a > r && (h = h | $t.ABOVE), h === $t.UNKNOWN && (h = $t.INTERSECTING), h;
  }
  function Se() {
  ...
  function nh(n, t) {
    for (let e = 0, s = t.length; e < s; ++e) Cs(n, t[e]);
    return n;
  }
  ...
  function Ro(n, t) {
    let e;
    return e = t(rr(n)), e || (e = t(or(n)), e) || (e = t(ar(n)), e) || (e = t(on(n)), e) ? e : !1;
  }
  function bs(n) {
    let t = 0;
    return ii(n) || (t = pt(n) * Wt(n)), t;
  }
  function rr(n) {
    return [n[0], n[1]];
  }
  ...
  function Fe(n, t, e) {
    const s = e || Se();
    return re(n, t) ? (n[0] > t[0] ? s[0] = n[0] : s[0] = t[0], n[1] > t[1] ? s[1] = n[1] : s[1] = t[1], n[2] < t[2] ? s[2] = n[2] : s[2] = t[2], n[3] < t[3] ? s[3] = n[3] : s[3] = t[3]) : En(s), s;
  }
  function ep(n) {
    return pt(n) + Wt(n);
  }
  ...
  function zu(n, t, e) {
    ...
    if (i === $t.INTERSECTING || r === $t.INTERSECTING) s = !0;
    else {
      const o = n[0], a = n[1], h = n[2], l = n[3], u = t[0], c = t[1], d = e[0], p = e[1], f = (p - c) / (d - u);
      let y, E;
      r & $t.ABOVE && !(i & $t.ABOVE) && (y = d - (p - l) / f, s = y >= o && y <= h), !s && r & $t.RIGHT && !(i & $t.RIGHT) && (E = p - (d - h) * f, s = E >= a && E <= l), !s && r & $t.BELOW && !(i & $t.BELOW) && (y = d - (p - a) / f, s = y >= o && y <= h), !s && r & $t.LEFT && !(i & $t.LEFT) && (E = p - (d - o) * f, s = E >= a && E <= l);
    }
    return s;
  }
  function Uu(n, t, e, s) {
  ...
  const ip = Object.freeze(Object.defineProperty({ __proto__: null, applyTransform: Uu, approximatelyEquals: Jg, boundingExtent: Qa, buffer: Mo, clone: th, closestSquaredDistanceXY: Xn, containsCoordinate: Rs, containsExtent: Yn, containsXY: wo, coordinateRelationship: So, createEmpty: Se, createOrUpdate: Ne, createOrUpdateEmpty: En, createOrUpdateFromCoordinate: eh, createOrUpdateFromCoordinates: $g, createOrUpdateFromFlatCoordinates: vo, createOrUpdateFromRings: Hg, equals: si, extend: ir, extendCoordinate: Cs, extendCoordinates: nh, extendFlatCoordinates: sh, extendRings: Nu, extendXY: Fu, forEachCorner: Ro, getArea: bs, getBottomLeft: rr, getBottomRight: or, getCenter: Mn, getCorner: ku, getEnlargedArea: Qg, getForViewAndSize: Co, getHeight: Wt, getIntersection: Fe, getIntersectionArea: tp, getMargin: ep, getRotatedViewport: Du, getSize: np, getTopLeft: on, getTopRight: ar, getWidth: pt, intersects: re, intersectsSegment: zu, isEmpty: ii, returnOrUpdate: Gu, scaleFromCenter: sp, wrapAndSliceX: bo, wrapX: ih }, Symbol.toStringTag, { value: "Module" }));
  function rp(n, t) {
  ...
  function Wu(n, t, e) {
    e = e || ap;
    const s = Wn(n[1]), i = Wn(t[1]), r = (i - s) / 2, o = Wn(t[0] - n[0]) / 2, a = Math.sin(r) * Math.sin(r) + Math.sin(o) * Math.sin(o) * Math.cos(s) * Math.cos(i);
    return 2 * e * Math.atan2(Math.sqrt(a), Math.sqrt(1 - a));
  }
  const Io = 0.9996, ze = 669438e-8, Ao = ze * ze, Po = Ao * ze, Ts = ze / (1 - ze), Xu = Math.sqrt(1 - ze), ri = (1 - Xu) / (1 + Xu), Yu = ri * ri, oh = Yu * ri, ah = oh * ri, qu = ah * ri, Vu = 1 - ze / 4 - 3 * Ao / 64 - 5 * Po / 256, hp = 3 * ze / 8 + 3 * Ao / 32 + 45 * Po / 1024, lp = 15 * Ao / 256 + 45 * Po / 1024, up = 35 * Po / 3072, cp = 3 / 2 * ri - 27 / 32 * oh + 269 / 512 * qu, dp = 21 / 16 * Yu - 55 / 32 * ah, fp = 151 / 96 * oh - 417 / 128 * qu, gp = 1097 / 512 * ah, Lo = 6378137;
  function pp(n, t, e) {
    const s = n - 5e5, i = (e.north ? t : t - 1e7) / Io / (Lo * Vu), r = i + cp * Math.sin(2 * i) + dp * Math.sin(4 * i) + fp * Math.sin(6 * i) + gp * Math.sin(8 * i), o = Math.sin(r), a = o * o, h = Math.cos(r), l = o / h, u = l * l, c = u * u, d = 1 - ze * a, p = Math.sqrt(1 - ze * a), f = Lo / p, y = (1 - ze) / d, E = Ts * h ** 2, M = E * E, w = s / (f * Io), C = w * w, v = C * w, R = v * w, I = R * w, O = I * w, A = r - l / y * (C / 2 - R / 24 * (5 + 3 * u + 10 * E - 4 * M - 9 * Ts)) + O / 720 * (61 + 90 * u + 298 * E + 45 * c - 252 * Ts - 3 * M);
    let P = (w - v / 6 * (1 + 2 * u + E) + I / 120 * (5 - 2 * E + 28 * u - 3 * M + 8 * Ts + 24 * c)) / h;
    return P = Za(P + Wn($u(e.number)), -Math.PI, Math.PI), [Iu(P), Iu(A)];
  }
  const Ku = -80, Zu = 84, mp = -180, _p = 180;
  function yp(n, t, e) {
    n = Za(n, mp, _p), t < Ku ? t = Ku : t > Zu && (t = Zu);
    const s = Wn(t), i = Math.sin(s), r = Math.cos(s), o = i / r, a = o * o, h = a * a, l = Wn(n), u = $u(e.number), c = Wn(u), d = Lo / Math.sqrt(1 - ze * i ** 2), p = Ts * r ** 2, f = r * Za(l - c, -Math.PI, Math.PI), y = f * f, E = y * f, M = E * f, w = M * f, C = w * f, v = Lo * (Vu * s - hp * Math.sin(2 * s) + lp * Math.sin(4 * s) - up * Math.sin(6 * s)), R = Io * d * (f + E / 6 * (1 - a + p) + w / 120 * (5 - 18 * a + h + 72 * p - 58 * Ts)) + 5e5;
  ...
  class No extends Ve {
    ...
    getExtent(t) {
      if (this.extentRevision_ != this.getRevision()) {
        ...
        (isNaN(e[0]) || isNaN(e[1])) && En(e), this.extentRevision_ = this.getRevision();
      }
    ...
    transform(t, e) {
      const s = It(t), i = s.getUnits() == "tile-pixels" ? function(r, o, a) {
        ...
        Sn(uc, l[0], l[3], u, -u, 0, 0, 0);
        const c = Vn(r, 0, r.length, a, uc, o), d = oi(s, e);
        return d ? d(c, c, a) : c;
      } : oi(s, e);
  ...
  class vn extends No {
    ...
    scale(t, e, s) {
      e === void 0 && (e = t), s || (s = Mn(this.getExtent()));
    ...
    translate(t, e) {
      ...
      if (s) {
        const i = this.getStride();
        Xp(s, 0, s.length, i, t, e, s), this.changed();
      }
    }
  }
  function Yp(n) {
  ...
  function Mh(n, t, e, s, i) {
    let r = n[t], o = n[t + 1];
    for (t += s; t < e; t += s) {
      const a = n[t], h = n[t + 1], l = ws(r, o, a, h);
      l > i && (i = l), r = a, o = h;
    }
    return i;
  }
  ...
  function Sh(n, t, e, s, i, r, o, a, h, l, u) {
    ...
    u = u || [NaN, NaN];
    let p = t + s;
    for (; p < e; ) if (dc(n, p - s, p, s, o, a, u), d = ws(o, a, u[0], u[1]), d < l) {
      for (l = d, c = 0; c < s; ++c) h[c] = u[c];
      h.length = s, p += s;
    } else p += s * Math.max((Math.sqrt(d) - Math.sqrt(l)) / i | 0, 1);
    if (r && (dc(n, e - s, t, s, o, a, u), d = ws(o, a, u[0], u[1]), d < l)) {
      for (l = d, c = 0; c < s; ++c) h[c] = u[c];
      h.length = s;
    }
    return l;
  ...
  function Kp(n, t, e, s, i, r, o, a, h, l, u) {
    u = u || [NaN, NaN];
    for (let c = 0, d = e.length; c < d; ++c) {
      const p = e[c];
  ...
  function $p(n, t, e, s, i, r, o) {
    if (t == e) return o;
    let a = Is(n[t], i), h = Is(n[t + 1], i);
    t += s, r[o++] = a, r[o++] = h;
    let l, u;
    do
      if (l = Is(n[t], i), u = Is(n[t + 1], i), t += s, t == e) return r[o++] = l, r[o++] = u, o;
    while (l == a && u == h);
    for (; t < e; ) {
      const c = Is(n[t], i), d = Is(n[t + 1], i);
  ...
  function Ch(n, t, e, s, i, r, o, a) {
    for (let h = 0, l = e.length; h < l; ++h) {
      const u = e[h];
      o = $p(n, t, u, s, i, r, o), a.push(o), t = u;
    }
    return o;
  }
  ...
  class As extends vn {
    ...
    getCoordinates() {
      return Kn(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride);
    }
    getSimplifiedGeometryInternal(t) {
      const e = [];
  ...
  let ur = class dg extends vn {
    ...
    closestPointXY(t, e, s, i) {
      const r = this.flatCoordinates, o = ws(t, e, r[0], r[1]);
      if (o < i) {
        const a = this.stride;
  ...
  function Qp(n, t, e, s, i) {
    return !Ro(i, function(r) {
      return !Ps(n, t, e, s, r[0], r[1]);
    });
  }
  function Ps(n, t, e, s, i, r) {
  ...
  function Th(n, t, e, s, i, r) {
    if (e.length === 0 || !Ps(n, t, e[0], s, i, r)) return !1;
    for (let o = 1, a = e.length; o < a; ++o) if (Ps(n, e[o - 1], e[o], s, i, r)) return !1;
    return !0;
  }
  ...
  function Ih(n, t, e, s, i, r, o) {
    ...
    let E = NaN, M = -1 / 0;
    for (y.sort(Bn), u = y[0], a = 1, h = y.length; a < h; ++a) {
      c = y[a];
  ...
  function Do(n, t, e, s, i) {
    ...
    return re(i, r) ? Yn(i, r) || r[0] >= i[0] && r[2] <= i[2] || r[1] >= i[1] && r[3] <= i[3] ? !0 : yc(n, t, e, s, function(o, a) {
      return zu(i, o, a);
    }) : !1;
  }
  ...
  function xc(n, t, e, s, i) {
    return !!(Do(n, t, e, s, i) || Ps(n, t, e, s, i[0], i[1]) || Ps(n, t, e, s, i[0], i[3]) || Ps(n, t, e, s, i[2], i[1]) || Ps(n, t, e, s, i[2], i[3]));
  }
  ...
  class an extends vn {
    ...
    clone() {
      const t = new an(this.flatCoordinates.slice(), this.layout, this.ends_.slice());
      return t.applyProperties(this), t;
    }
    closestPointXY(t, e, s, i) {
    ...
    getLinearRings() {
      ...
      for (let o = 0, a = s.length; o < a; ++o) {
        const h = s[o], l = new As(e.slice(r, h), t);
        i.push(l), r = h;
      }
      return i;
    }
    ...
    getSimplifiedGeometryInternal(t) {
      const e = [], s = [];
      return e.length = Ch(this.flatCoordinates, 0, this.ends_, this.stride, Math.sqrt(t), e, 0, s), new an(e, "XY", s);
    }
    getType() {
      return "Polygon";
    }
  ...
  function Sc(n) {
    if (ii(n)) throw new Error("Cannot create polygon from empty extent");
    const t = n[0], e = n[1], s = n[2], i = n[3], r = [t, e, t, i, s, i, s, e, t, e];
    return new an(r, "XY", [r.length]);
  }
  const Lh = 0;
  class hn extends Ve {
    constructor(t) {
      super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = dh(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && vp(), t.center && (t.center = wn(t.center, this.projection_)), t.extent && (t.extent = qn(t.extent, this.projection_)), this.applyOptions_(t);
    }
    applyOptions_(t) {
      const e = Object.assign({}, t);
      for (const a in Ke) delete e[a];
    ...
    animate(t) {
      ...
      for (let s = 0; s < e.length; ++s) {
        let i = arguments[s];
        i.center && (i = Object.assign({}, i), i.center = wn(i.center, this.getProjection())), i.anchor && (i = Object.assign({}, i), i.anchor = wn(i.anchor, this.getProjection())), e[s] = i;
      }
    ...
    getResolution() {
      return this.get(Ke.RESOLUTION);
    }
    getResolutions() {
      return this.resolutions_;
    }
    getResolutionForExtent(t, e) {
      return this.getResolutionForExtentInternal(qn(t, this.getProjection()), e);
    }
    ...
    fit(t, e) {
      ...
      if (wt(Array.isArray(t) || typeof t.getSimplifiedGeometry == "function", "Invalid extent or geometry provided as `geometry`"), Array.isArray(t)) {
        wt(!ii(t), "Cannot fit empty extent provided as `geometry`");
        const i = qn(t, this.getProjection());
        s = Sc(i);
      } else if (t.getType() === "Circle") {
        const i = qn(t.getExtent(), this.getProjection());
        s = Sc(i), s.rotate(this.getRotation(), Mn(i));
      } else s = t;
    ...
    fitInternal(t, e) {
      ...
      const l = this.getRotation(), u = Math.sin(l), c = Math.cos(l), d = Mn(a);
    ...
    centerOn(t, e, s) {
      this.centerOnInternal(wn(t, this.getProjection()), e, s);
    }
    ...
    adjustResolution(t, e) {
      e = e && wn(e, this.getProjection()), this.adjustResolutionInternal(t, e);
    }
    ...
    adjustRotation(t, e) {
      e && (e = wn(e, this.getProjection())), this.adjustRotationInternal(t, e);
    }
    ...
    setCenter(t) {
      this.setCenterInternal(t && wn(t, this.getProjection()));
    }
    setCenterInternal(t) {
    ...
    applyTargetState_(t, e) {
      ...
      this.get(Ke.ROTATION) !== i && this.set(Ke.ROTATION, i), this.get(Ke.RESOLUTION) !== o && (this.set(Ke.RESOLUTION, o), this.set("zoom", this.getZoom(), !0)), (!a || !this.get(Ke.CENTER) || !To(this.get(Ke.CENTER), a)) && this.set(Ke.CENTER, a), this.getAnimating() && !t && this.cancelAnimations(), this.cancelAnchor_ = void 0;
    }
    resolveConstraints(t, e, s) {
      ...
      s = s || (t === 0 ? this.cancelAnchor_ : void 0), this.cancelAnchor_ = void 0, (this.getResolution() !== a || this.getRotation() !== r || !this.getCenterInternal() || !To(this.getCenterInternal(), h)) && (this.getAnimating() && this.cancelAnimations(), this.animateInternal({ rotation: r, center: h, resolution: a, duration: t, easing: ai, anchor: s }));
    }
    beginInteraction() {
      this.resolveConstraints(0), this.setHint(ie.INTERACTING, 1);
    }
    endInteraction(t, e, s) {
      s = s && wn(s, this.getProjection()), this.endInteractionInternal(t, e, s);
    }
  ...
  function am(n) {
    ...
    if (!a && !p && u.isGlobal() && (d = !1, p = c), n.resolutions !== void 0) {
      ...
      const f = (c ? Math.max(pt(c), Wt(c)) : 360 * Ha.degrees / u.getMetersPerUnit()) / $a / Math.pow(2, Lh), y = f / Math.pow(2, 28 - Lh);
  ...
  class zo extends Au {
    ...
    isVisible(t) {
      ...
      !t && s && (t = s.getView()), t instanceof hn ? e = { viewState: t.getState(), extent: t.calculateExtent() } : e = t, !e.layerStatesArray && s && (e.layerStatesArray = s.getLayerGroup().getLayerStatesArray());
      let i;
    ...
    getAttributions(t) {
      ...
      if (!s) return [];
      const i = t instanceof hn ? t.getViewStateAndExtent() : t;
      let r = s(i);
  ...
  let Rc = class {
    ...
    _build(n, t, e, s) {
      ...
      if (i <= r) return o = li(n.slice(t, e + 1)), hi(o, this.toBBox), o;
      s || (s = Math.ceil(Math.log(i) / Math.log(r)), r = Math.ceil(i / Math.pow(r, s - 1))), o = li([]), o.leaf = !1, o.height = s;
    ...
    _split(n, t) {
      ...
      const r = this._chooseSplitIndex(e, i, s), o = li(e.children.splice(r, e.children.length - r));
      o.height = e.height, o.leaf = e.leaf, hi(e, this.toBBox), hi(o, this.toBBox), t ? n[t - 1].children.push(o) : this._splitRoot(e, o);
    }
    _splitRoot(n, t) {
      this.data = li([n, t]), this.data.height = n.height + 1, this.data.leaf = !1, hi(this.data, this.toBBox);
    }
    ...
    _condense(n) {
      for (let t = n.length - 1, e; t >= 0; t--) n[t].children.length === 0 ? t > 0 ? (e = n[t - 1].children, e.splice(e.indexOf(n[t]), 1)) : this.clear() : hi(n[t], this.toBBox);
    }
  };
  function cm(n, t, e) {
  ...
  function dr(n, t, e, s, i) {
    i || (i = li(null)), i.minX = 1 / 0, i.minY = 1 / 0, i.maxX = -1 / 0, i.maxY = -1 / 0;
    for (let r = t; r < e; r++) {
  ...
  const Zn = typeof navigator < "u" && typeof navigator.userAgent < "u" ? navigator.userAgent.toLowerCase() : "", Lc = Zn.includes("firefox"), Oc = Zn.includes("safari") && !Zn.includes("chrom"), wm = Oc && (Zn.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(Zn)), Nc = Zn.includes("webkit") && !Zn.includes("edge"), Wh = Zn.includes("macintosh"), jo = typeof devicePixelRatio < "u" ? devicePixelRatio : 1, Wo = typeof WorkerGlobalScope < "u" && typeof OffscreenCanvas < "u" && self instanceof WorkerGlobalScope, Xh = typeof Image < "u" && Image.prototype.decode, Sm = typeof createImageBitmap == "function", Yh = function() {
    let n = !1;
    try {
    ...
    return n;
  }(), vm = Object.freeze(Object.defineProperty({ __proto__: null, CREATE_IMAGE_BITMAP: Sm, DEVICE_PIXEL_RATIO: jo, FIREFOX: Lc, IMAGE_DECODE: Xh, MAC: Wh, PASSIVE_EVENT_LISTENERS: Yh, SAFARI: Oc, SAFARI_BUG_237906: wm, WEBKIT: Nc, WORKER_OFFSCREEN_CANVAS: Wo }, Symbol.toStringTag, { value: "Module" }));
  function Xt(n, t, e, s) {
    let i;
  ...
  function Tm(n, t, e) {
    ...
    return s.src && Xh ? (r = !0, s.decode().then(function() {
      i && t();
    }).catch(function(h) {
      i && (o ? t() : e());
  ...
  function Am(n, t) {
    return t && (n.src = t), n.src && Xh ? new Promise((e, s) => n.decode().then(() => e(n)).catch((i) => n.complete && n.width ? e(n) : s(i))) : Im(n);
  }
  class Pm {
    constructor() {
    ...
    set(t, e, s, i, r) {
      ...
      this.cache_[o] = i, r && (i.getImageState() === gt.IDLE && i.load(), i.getImageState() === gt.LOADING ? i.ready().then(() => {
        this.patternCache_[o] = Xo().createPattern(i.getImage(1), "repeat");
      }) : this.patternCache_[o] = Xo().createPattern(i.getImage(1), "repeat")), a || ++this.cacheSize_;
    }
    setSize(t) {
  ...
  class Kh extends co {
    ...
    isTainted_() {
      if (this.tainted_ === void 0 && this.imageState_ === gt.LOADED) {
        mr || (mr = Xt(1, 1, void 0, { willReadFrequently: !0 })), mr.drawImage(this.image_, 0, 0);
        try {
    ...
    getHitDetectionImage() {
      if (this.image_ || this.initializeImage_(), !this.hitDetectionImage_) if (this.isTainted_()) {
        const t = this.size_[0], e = this.size_[1], s = Xt(t, e);
    ...
    replaceColor_(t) {
      ...
      const e = this.image_, s = Xt(Math.ceil(e.width * t), Math.ceil(e.height * t)), i = s.canvas;
  ...
  function Zh(n, t, e, s, i, r) {
    ...
    return o || (o = new Kh(n, n && "src" in n ? n.src || void 0 : t, e, s, i), Be.set(t, e, i, o, r)), r && o && !Be.getPattern(t, e, i) && Be.set(t, e, i, o, r), o;
  }
  function Dc(n) {
    return n[0] > 0 && n[1] > 0;
  }
  ...
  }, Bc = "10px sans-serif", Re = "#000", ci = "round", Rn = [], Cn = 0, di = "round", yr = 10, xr = "#000", Er = "center", Ko = "middle", Ls = [0, 0, 0, 0], Mr = 1, bn = new Ve();
  let fi = null, Hh;
    ...
    function a() {
      ...
      for (let u = 0, c = l.length; u < c; ++u) {
        ...
        if (bn.get(d) < 100) {
          const [p, f, y] = d.split(`
`);
          o(p, f, y) ? (er(Jh), fi = null, Hh = void 0, bn.set(d, 100)) : (bn.set(d, bn.get(d) + 1, !0), h = !1);
        }
      }
...
` + l.weight + `
` + p;
        bn.get(f) === void 0 && (bn.set(f, 100, !0), o(l.style, l.weight, p) || (bn.set(f, 0, !0), i === void 0 && (i = setInterval(a, 32))));
      }
    };
  ...
  function jc(n, t) {
    return fi || (fi = Xt(1, 1)), n != Hh && (fi.font = n, Hh = fi.font), fi.measureText(t);
  }
  function Zo(n, t) {
    return jc(n, t).width;
  }
...
` || l === u) {
  ...
  class wr extends _r {
    ...
    getImage(t) {
      ...
      if (!o) {
        const a = this.renderOptions_, h = Math.ceil(a.size * t), l = Xt(h, h);
        this.draw_(a, l, t), o = l.canvas, Be.set(r, null, null, new Kh(o, void 0, null, gt.LOADED, null));
      }
      return o;
    }
    getPixelRatio(t) {
    ...
    createRenderOptions() {
      let t = ci, e = di, s = 0, i = null, r = 0, o, a = 0;
      this.stroke_ && (o = ln(this.stroke_.getColor() ?? xr), a = this.stroke_.getWidth() ?? Mr, i = this.stroke_.getLineDash(), r = this.stroke_.getLineDashOffset() ?? 0, e = this.stroke_.getLineJoin() ?? di, t = this.stroke_.getLineCap() ?? ci, s = this.stroke_.getMiterLimit() ?? yr);
    ...
    draw_(t, e, s) {
      if (e.scale(s, s), e.translate(t.size / 2, t.size / 2), this.createPath_(e), this.fill_) {
        ...
        i === null && (i = Re), e.fillStyle = ln(i), e.fill();
      }
    ...
    createHitDetectionCanvas_(t) {
      ...
      if (this.fill_) {
        ...
        typeof s == "string" && (s = ui(s)), s === null ? i = 1 : Array.isArray(s) && (i = s.length === 4 ? s[3] : 1), i === 0 && (e = Xt(t.size, t.size), this.drawHitDetectionCanvas_(t, e));
      }
  ...
  class Ze {
    ...
    clone() {
      ...
      return new Ze({ color: Array.isArray(t) ? t.slice() : t || void 0 });
    }
    getColor() {
      return this.color_;
    }
    ...
    getKey() {
      const t = this.getColor();
      return t ? t instanceof CanvasPattern || t instanceof CanvasGradient ? vt(t) : typeof t == "object" && "src" in t ? t.src + ":" + t.offset : ui(t).toString() : "";
    }
    loading() {
  ...
  class ae {
    constructor(t) {
      t = t || {}, this.geometry_ = null, this.geometryFunction_ = Yc, t.geometry !== void 0 && this.setGeometry(t.geometry), this.fill_ = t.fill !== void 0 ? t.fill : null, this.image_ = t.image !== void 0 ? t.image : null, this.renderer_ = t.renderer !== void 0 ? t.renderer : null, this.hitDetectionRenderer_ = t.hitDetectionRenderer !== void 0 ? t.hitDetectionRenderer : null, this.stroke_ = t.stroke !== void 0 ? t.stroke : null, this.text_ = t.text !== void 0 ? t.text : null, this.zIndex_ = t.zIndex;
    }
    clone() {
    ...
    setGeometry(t) {
      typeof t == "function" ? this.geometryFunction_ = t : typeof t == "string" ? this.geometryFunction_ = function(e) {
        ...
        return t;
      }) : this.geometryFunction_ = Yc, this.geometry_ = t;
    }
    setZIndex(t) {
      this.zIndex_ = t;
    }
  ...
  function Xc(n, t) {
    if (!Qh) {
      const e = new Ze({ color: "rgba(255,255,255,0.4)" }), s = new ke({ color: "#3399CC", width: 1.25 });
  ...
  class Sr extends _r {
    constructor(t) {
      ...
      let h;
      if (t.src !== void 0 ? h = gt.IDLE : o !== void 0 && ("complete" in o ? o.complete ? h = o.src ? gt.LOADED : gt.IDLE : h = gt.LOADING : h = gt.LOADED), this.color_ = t.color !== void 0 ? ui(t.color) : null, this.iconImage_ = Zh(o, a, this.crossOrigin_, h, this.color_), this.offset_ = t.offset !== void 0 ? t.offset : [0, 0], this.offsetOrigin_ = t.offsetOrigin !== void 0 ? t.offsetOrigin : "top-left", this.origin_ = null, this.size_ = t.size !== void 0 ? t.size : null, this.initialOptions_, t.width !== void 0 || t.height !== void 0) {
        let l, u;
  ...
  class $o {
    constructor(t) {
      t = t || {}, this.font_ = t.font, this.rotation_ = t.rotation, this.rotateWithView_ = t.rotateWithView, this.keepUpright_ = t.keepUpright, this.scale_ = t.scale, this.scaleArray_ = ve(t.scale !== void 0 ? t.scale : 1), this.text_ = t.text, this.textAlign_ = t.textAlign, this.justify_ = t.justify, this.repeat_ = t.repeat, this.textBaseline_ = t.textBaseline, this.fill_ = t.fill !== void 0 ? t.fill : new Ze({ color: jm }), this.maxAngle_ = t.maxAngle !== void 0 ? t.maxAngle : Math.PI / 4, this.placement_ = t.placement !== void 0 ? t.placement : "point", this.overflow_ = !!t.overflow, this.stroke_ = t.stroke !== void 0 ? t.stroke : null, this.offsetX_ = t.offsetX !== void 0 ? t.offsetX : 0, this.offsetY_ = t.offsetY !== void 0 ? t.offsetY : 0, this.backgroundFill_ = t.backgroundFill ? t.backgroundFill : null, this.backgroundStroke_ = t.backgroundStroke ? t.backgroundStroke : null, this.padding_ = t.padding === void 0 ? null : t.padding, this.declutterMode_ = t.declutterMode;
    }
    clone() {
      const t = this.getScale();
      return new $o({ font: this.getFont(), placement: this.getPlacement(), repeat: this.getRepeat(), maxAngle: this.getMaxAngle(), overflow: this.getOverflow(), rotation: this.getRotation(), rotateWithView: this.getRotateWithView(), keepUpright: this.getKeepUpright(), scale: Array.isArray(t) ? t.slice() : t, text: this.getText(), textAlign: this.getTextAlign(), justify: this.getJustify(), textBaseline: this.getTextBaseline(), fill: this.getFill() ? this.getFill().clone() : void 0, stroke: this.getStroke() ? this.getStroke().clone() : void 0, offsetX: this.getOffsetX(), offsetY: this.getOffsetY(), backgroundFill: this.getBackgroundFill() ? this.getBackgroundFill().clone() : void 0, backgroundStroke: this.getBackgroundStroke() ? this.getBackgroundStroke().clone() : void 0, padding: this.getPadding() || void 0, declutterMode: this.getDeclutterMode() });
    }
    getOverflow() {
  ...
  let Ns = 0;
  const me = 1 << Ns++, Et = 1 << Ns++, Ce = 1 << Ns++, $e = 1 << Ns++, Fs = 1 << Ns++, vr = 1 << Ns++, Ho = Math.pow(2, Ns) - 1, tl = { [me]: "boolean", [Et]: "number", [Ce]: "string", [$e]: "color", [Fs]: "number[]", [vr]: "size" }, Wm = Object.keys(tl).map(Number).sort(Bn);
  function Xm(n) {
    return n in tl;
  }
  function Rr(n) {
  ...
  class Kt {
    constructor(t, e) {
      if (!Xm(t)) throw new Error(`literal expressions must have a specific type, got ${Rr(t)}`);
  ...
  function Qt(n, t, e) {
    switch (typeof n) {
      case "boolean": {
        if ($n(t, Ce)) return new Kt(Ce, n ? "true" : "false");
        if (!Cr(t, me)) throw new Error(`got a boolean, but expected ${Rr(t)}`);
        return new Kt(me, n);
      }
      case "number": {
        if ($n(t, vr)) return new Kt(vr, ve(n));
        if ($n(t, me)) return new Kt(me, !!n);
        if ($n(t, Ce)) return new Kt(Ce, n.toString());
        if (!Cr(t, Et)) throw new Error(`got a number, but expected ${Rr(t)}`);
        return new Kt(Et, n);
      }
      case "string": {
        if ($n(t, $e)) return new Kt($e, Bh(n));
        if ($n(t, me)) return new Kt(me, !!n);
    ...
    if ($n(t, $e)) {
      if (n.length === 3) return new Kt($e, [...n, 1]);
      if (n.length === 4) return new Kt($e, n);
      throw new Error(`expected an array of 3 or 4 values for a color, got ${n.length}`);
    }
    if (!Cr(t, Fs)) throw new Error(`got an array of numbers, but expected ${Rr(t)}`);
    return new Kt(Fs, n);
  }
  const L = { Get: "get", Var: "var", Concat: "concat", GeometryType: "geometry-type", LineMetric: "line-metric", Any: "any", All: "all", Not: "!", Resolution: "resolution", Zoom: "zoom", Time: "time", Equal: "==", NotEqual: "!=", GreaterThan: ">", GreaterThanOrEqualTo: ">=", LessThan: "<", LessThanOrEqualTo: "<=", Multiply: "*", Divide: "/", Add: "+", Subtract: "-", Clamp: "clamp", Mod: "%", Pow: "^", Abs: "abs", Floor: "floor", Ceil: "ceil", Round: "round", Sin: "sin", Cos: "cos", Atan: "atan", Sqrt: "sqrt", Match: "match", Between: "between", Interpolate: "interpolate", Coalesce: "coalesce", Case: "case", In: "in", Number: "number", String: "string", Array: "array", Color: "color", Id: "id", Band: "band", Palette: "palette", ToString: "to-string", Has: "has" }, qm = { [L.Get]: rt(ft(1, 1 / 0), Kc), [L.Var]: rt(ft(1, 1), Vm), [L.Has]: rt(ft(1, 1 / 0), Kc), [L.Id]: rt(Km, gi), [L.Concat]: rt(ft(2, 1 / 0), Rt(Ce)), [L.GeometryType]: rt(Zm, gi), [L.LineMetric]: rt(gi), [L.Resolution]: rt(gi), [L.Zoom]: rt(gi), [L.Time]: rt(gi), [L.Any]: rt(ft(2, 1 / 0), Rt(me)), [L.All]: rt(ft(2, 1 / 0), Rt(me)), [L.Not]: rt(ft(1, 1), Rt(me)), [L.Equal]: rt(ft(2, 2), Rt(Ho)), [L.NotEqual]: rt(ft(2, 2), Rt(Ho)), [L.GreaterThan]: rt(ft(2, 2), Rt(Et)), [L.GreaterThanOrEqualTo]: rt(ft(2, 2), Rt(Et)), [L.LessThan]: rt(ft(2, 2), Rt(Et)), [L.LessThanOrEqualTo]: rt(ft(2, 2), Rt(Et)), [L.Multiply]: rt(ft(2, 1 / 0), Zc), [L.Coalesce]: rt(ft(2, 1 / 0), Zc), [L.Divide]: rt(ft(2, 2), Rt(Et)), [L.Add]: rt(ft(2, 1 / 0), Rt(Et)), [L.Subtract]: rt(ft(2, 2), Rt(Et)), [L.Clamp]: rt(ft(3, 3), Rt(Et)), [L.Mod]: rt(ft(2, 2), Rt(Et)), [L.Pow]: rt(ft(2, 2), Rt(Et)), [L.Abs]: rt(ft(1, 1), Rt(Et)), [L.Floor]: rt(ft(1, 1), Rt(Et)), [L.Ceil]: rt(ft(1, 1), Rt(Et)), [L.Round]: rt(ft(1, 1), Rt(Et)), [L.Sin]: rt(ft(1, 1), Rt(Et)), [L.Cos]: rt(ft(1, 1), Rt(Et)), [L.Atan]: rt(ft(1, 2), Rt(Et)), [L.Sqrt]: rt(ft(1, 1), Rt(Et)), [L.Match]: rt(ft(4, 1 / 0), $c, Hm), [L.Between]: rt(ft(3, 3), Rt(Et)), [L.Interpolate]: rt(ft(6, 1 / 0), $c, Jm), [L.Case]: rt(ft(3, 1 / 0), $m, Qm), [L.In]: rt(ft(2, 2), t_), [L.Number]: rt(ft(1, 1 / 0), Rt(Ho)), [L.String]: rt(ft(1, 1 / 0), Rt(Ho)), [L.Array]: rt(ft(1, 1 / 0), Rt(Et)), [L.Color]: rt(ft(1, 4), Rt(Et)), [L.Band]: rt(ft(1, 3), Rt(Et)), [L.Palette]: rt(ft(2, 2), e_), [L.ToString]: rt(ft(1, 1), Rt(me | Et | Ce | $e)) };
  function Kc(n, t, e) {
  ...
  function Vm(n, t, e) {
    ...
    return e.variables.add(s), [new Kt(Ce, s)];
  }
  function Km(n, t, e) {
    e.featureId = !0;
  }
  ...
  function e_(n, t, e) {
    ...
    for (let o = 0; o < r.length; o++) {
      ...
      if (!(a instanceof Kt)) throw new Error(`the palette color at index ${o} must be a literal value`);
      r[o] = a;
    }
    return [s, ...r];
  }
  ...
  function He(n, t) {
    if (n instanceof Kt) {
      if (n.type === $e && typeof n.value == "string") {
        const s = Bh(n.value);
        return function() {
          return s;
        };
  ...
  function s_(n, t) {
    ...
    for (let r = 0; r < s; ++r) i[r] = He(n.args[r]);
    switch (e) {
      case L.Coalesce:
        return (r) => {
          for (let o = 0; o < s; ++o) {
  ...
  function r_(n, t) {
    const e = n.operator, s = He(n.args[0]), i = He(n.args[1]);
    switch (e) {
      case L.Equal:
        return (r) => s(r) === i(r);
      case L.NotEqual:
  ...
  function h_(n, t) {
    ...
    for (let i = 0; i < e; ++i) s[i] = He(n.args[i]);
    return (i) => {
  ...
  function c_(n, t) {
    ...
    switch (e) {
      case L.ToString:
        return (r) => {
          const o = i[0](r);
          return n.args[0].type === $e ? jh(o) : o.toString();
        };
      default:
  ...
  function p_(n, t) {
    ...
    for (let i = 0; i < e; ++i) {
      const r = n[i], o = "filter" in r ? Tn(r.filter, me, t) : f_;
      let a;
  ...
  function el(n, t) {
    ...
    if (!e && !s && !i && !r && !Js(n)) throw new Error("No fill, stroke, point, or text symbolizer properties in style: " + JSON.stringify(n));
    const a = new ae();
    return function(h) {
      let l = !0;
      if (e) {
  ...
  function Ir(n, t, e) {
    ...
    if (!s && !i) return null;
    const r = In(n, t + "stroke-line-cap", e), o = In(n, t + "stroke-line-join", e), a = td(n, t + "stroke-line-dash", e), h = be(n, t + "stroke-line-dash-offset", e), l = be(n, t + "stroke-miter-limit", e), u = new ke();
    return function(c) {
      if (i) {
        const d = i(c);
        if (d === zh) return null;
  ...
  function m_(n, t) {
    const e = "text-", s = In(n, e + "value", t);
    if (!s) return null;
    const i = Tr(n, e, t), r = Tr(n, e + "background-", t), o = Ir(n, e, t), a = Ir(n, e + "background-", t), h = In(n, e + "font", t), l = be(n, e + "max-angle", t), u = be(n, e + "offset-x", t), c = be(n, e + "offset-y", t), d = pi(n, e + "overflow", t), p = In(n, e + "placement", t), f = be(n, e + "repeat", t), y = Qo(n, e + "scale", t), E = pi(n, e + "rotate-with-view", t), M = be(n, e + "rotation", t), w = In(n, e + "align", t), C = In(n, e + "justify", t), v = In(n, e + "baseline", t), R = pi(n, e + "keep-upright", t), I = td(n, e + "padding", t), O = ea(n, e + "declutter-mode"), A = new $o({ declutterMode: O });
    return function(P) {
  ...
  function x_(n, t) {
    const e = "shape-", s = e + "points", i = e + "radius", r = sl(n[s], s), o = sl(n[i], i), a = Tr(n, e, t), h = Ir(n, e, t), l = Qo(n, e + "scale", t), u = Jo(n, e + "displacement", t), c = be(n, e + "rotation", t), d = pi(n, e + "rotate-with-view", t), p = ta(n, e + "radius2"), f = ta(n, e + "angle"), y = ea(n, e + "declutter-mode"), E = new wr({ points: r, radius: o, radius2: p, angle: f, declutterMode: y });
    return function(M) {
  ...
  function E_(n, t) {
    const e = "circle-", s = Tr(n, e, t), i = Ir(n, e, t), r = be(n, e + "radius", t), o = Qo(n, e + "scale", t), a = Jo(n, e + "displacement", t), h = be(n, e + "rotation", t), l = pi(n, e + "rotate-with-view", t), u = ea(n, e + "declutter-mode"), c = new Os({ radius: 5, declutterMode: u });
    return function(d) {
  ...
  function M_(n, t, e) {
    const s = In(n, t + "pattern-src", e), i = ed(n, t + "pattern-offset", e), r = ed(n, t + "pattern-size", e), o = nl(n, t + "color", e);
    return function(a) {
  ...
  class T_ extends lo {
    ...
    calculateMatrices2D(t) {
      ...
      Sn(s, t.size[0] / 2, t.size[1] / 2, 1 / e.resolution, -1 / e.resolution, -e.rotation, -e.center[0], -e.center[1]), hc(i, s);
    }
  ...
  class A_ extends T_ {
    constructor(t) {
      super(t), this.fontChangeListenerKey_ = xt(bn, $s.PROPERTYCHANGE, t.redrawText, t), this.element_ = document.createElement("div");
  ...
  class mi extends Au {
    constructor(t) {
      ...
      delete e.layers;
      let s = t.layers;
      super(e), this.on, this.once, this.un, this.layersListenerKeys_ = [], this.listenerKeys_ = {}, this.addChangeListener(il.LAYERS, this.handleLayersChanged_), s ? Array.isArray(s) ? s = new rn(s.slice(), { unique: !0 }) : wt(typeof s.getArray == "function", "Expected `layers` to be an array or a `Collection`") : s = new rn(void 0, { unique: !0 }), this.setLayers(s);
    }
    handleLayerChange_() {
      this.changed();
    }
    handleLayersChanged_() {
      ...
      for (let s = 0, i = e.length; s < i; s++) {
        const r = e[s];
        this.registerLayerListeners_(r), this.dispatchEvent(new Hn("addlayer", r));
      }
      this.changed();
    }
    registerLayerListeners_(t) {
      const e = [xt(t, $s.PROPERTYCHANGE, this.handleLayerChange_, this), xt(t, lt.CHANGE, this.handleLayerChange_, this)];
      t instanceof mi && e.push(xt(t, "addlayer", this.handleLayerGroupAdd_, this), xt(t, "removelayer", this.handleLayerGroupRemove_, this)), this.listenerKeys_[vt(t)] = e;
    }
    handleLayerGroupAdd_(t) {
      this.dispatchEvent(new Hn("addlayer", t.layer));
    }
    handleLayerGroupRemove_(t) {
      this.dispatchEvent(new Hn("removelayer", t.layer));
    }
    handleLayersAdd_(t) {
      const e = t.element;
      this.registerLayerListeners_(e), this.dispatchEvent(new Hn("addlayer", e)), this.changed();
    }
    handleLayersRemove_(t) {
      const e = t.element, s = vt(e);
      this.listenerKeys_[s].forEach(At), delete this.listenerKeys_[s], this.dispatchEvent(new Hn("removelayer", e)), this.changed();
    }
    getLayers() {
    ...
    setLayers(t) {
      ...
      if (e) {
        const s = e.getArray();
        for (let i = 0, r = s.length; i < r; ++i) this.dispatchEvent(new Hn("removelayer", s[i]));
      }
  ...
  class P_ extends co {
    constructor(t, e) {
      ...
      this.activePointers_ = [], this.trackedTouches_ = {}, this.element_ = s, this.pointerdownListenerKey_ = xt(s, rl.POINTERDOWN, this.handlePointerDown_, this), this.originalPointerMoveEvent_, this.relayedListenerKey_ = xt(s, rl.POINTERMOVE, this.relayMoveEvent_, this), this.boundHandleTouchMove_ = this.handleTouchMove_.bind(this), this.element_.addEventListener(lt.TOUCHMOVE, this.boundHandleTouchMove_, Yh ? { passive: !1 } : !1);
    }
    emulateClick_(t) {
      let e = new Jn(zt.CLICK, this.map_, t);
      this.dispatchEvent(e), this.clickTimeoutId_ !== void 0 ? (clearTimeout(this.clickTimeoutId_), this.clickTimeoutId_ = void 0, e = new Jn(zt.DBLCLICK, this.map_, t), this.dispatchEvent(e)) : this.clickTimeoutId_ = setTimeout(() => {
        this.clickTimeoutId_ = void 0;
        const s = new Jn(zt.SINGLECLICK, this.map_, t);
    ...
    handlePointerUp_(t) {
      ...
      const e = new Jn(zt.POINTERUP, this.map_, t, void 0, void 0, this.activePointers_);
    ...
    handlePointerDown_(t) {
      ...
      const e = new Jn(zt.POINTERDOWN, this.map_, t, void 0, void 0, this.activePointers_);
    ...
    handlePointerMove_(t) {
      if (this.isMoving_(t)) {
        ...
        const e = new Jn(zt.POINTERDRAG, this.map_, t, this.dragging_, void 0, this.activePointers_);
    ...
    relayMoveEvent_(t) {
      ...
      this.dispatchEvent(new Jn(zt.POINTERMOVE, this.map_, t, e));
    }
    handleTouchMove_(t) {
  ...
  const An = { POSTRENDER: "postrender", MOVESTART: "movestart", MOVEEND: "moveend", LOADSTART: "loadstart", LOADEND: "loadend" }, he = { LAYERGROUP: "layergroup", SIZE: "size", TARGET: "target", VIEW: "view" }, ol = 1 / 0;
  class L_ {
    constructor(t, e) {
  ...
  class al extends Ve {
    ...
    setMap(t) {
      ...
      if (this.listenerKeys.length = 0, this.map_ = t, t) {
        ...
        this.element && s.appendChild(this.element), this.render !== Hs && this.listenerKeys.push(xt(t, An.POSTRENDER, this.render, this)), t.render();
      }
    }
    render(t) {
    }
  ...
  class F_ extends al {
    constructor(t) {
      ...
      const l = e + " " + Vo + " " + $h + (this.collapsed_ && this.collapsible_ ? " " + Gc : "") + (this.collapsible_ ? "" : " ol-uncollapsible"), u = this.element;
    ...
    async updateElement_(t) {
      ...
      if (this.renderedVisible_ != s && (this.element.style.display = s ? "" : "none", this.renderedVisible_ = s), !jn(e, this.renderedAttributions_)) {
        kc(this.ulElement_);
        for (let i = 0, r = e.length; i < r; ++i) {
  ...
  class k_ extends al {
    ...
    resetNorth_() {
      ...
      e !== void 0 && (this.duration_ > 0 && e % (2 * Math.PI) !== 0 ? t.animate({ rotation: 0, duration: this.duration_, easing: ai }) : t.setRotation(0));
    }
    render(t) {
  ...
  class D_ extends al {
    ...
    zoomByDelta_(t) {
      ...
      if (s !== void 0) {
        ...
        this.duration_ > 0 ? (e.getAnimating() && e.cancelAnimations(), e.animate({ zoom: i, duration: this.duration_, easing: ai })) : e.setZoom(i);
      }
    }
  }
  function G_(n) {
  ...
  function hl(n, t, e, s) {
    ...
    n.getAnimating() && n.cancelAnimations(), n.animate({ resolution: o, anchor: e, duration: s !== void 0 ? s : 250, easing: ai });
  }
  class U_ extends Pr {
    constructor(t) {
    ...
    handleUpEvent(t) {
      ...
      if (this.targetPointers.length === 0) {
        if (!this.noKinetic_ && this.kinetic_ && this.kinetic_.end()) {
          ...
          s.animateInternal({ center: s.getConstrainedCenter(h), duration: 500, easing: ai });
        }
  ...
  class Z_ extends lo {
    ...
    createOrUpdateGeometry() {
      ...
      s[4] = s[0].slice(), this.geometry_ ? this.geometry_.setCoordinates([s]) : this.geometry_ = new an([s]);
    }
    getGeometry() {
      return this.geometry_;
    }
  }
  const yi = { BOXSTART: "boxstart", BOXDRAG: "boxdrag", BOXEND: "boxend", BOXCANCEL: "boxcancel" };
  class Or extends xn {
    constructor(t, e, s) {
  ...
  class $_ extends Lr {
    ...
    handleDragEvent(t) {
      this.startPixel_ && (this.box_.setPixels(this.startPixel_, t.pixel), this.dispatchEvent(new Or(yi.BOXDRAG, t.coordinate, t)));
    }
    handleUpEvent(t) {
      if (!this.startPixel_) return !1;
      const e = this.boxEndCondition_(t, this.startPixel_, t.pixel);
      return e && this.onBoxEnd(t), this.dispatchEvent(new Or(e ? yi.BOXEND : yi.BOXCANCEL, t.coordinate, t)), this.box_.setMap(null), this.startPixel_ = null, !1;
    }
    handleDownEvent(t) {
      return this.condition_(t) ? (this.startPixel_ = t.pixel, this.box_.setMap(t.map), this.box_.setPixels(this.startPixel_, this.startPixel_), this.dispatchEvent(new Or(yi.BOXSTART, t.coordinate, t)), !0) : !1;
    }
    onBoxEnd(t) {
    }
    setActive(t) {
      t || (this.box_.setMap(null), this.startPixel_ && (this.dispatchEvent(new Or(yi.BOXCANCEL, this.startPixel_, null)), this.startPixel_ = null)), super.setActive(t);
    }
    setMap(t) {
      this.getMap() && (this.box_.setMap(null), this.startPixel_ && (this.dispatchEvent(new Or(yi.BOXCANCEL, this.startPixel_, null)), this.startPixel_ = null)), super.setMap(t);
    }
  }
  class H_ extends $_ {
    constructor(t) {
    ...
    onBoxEnd(t) {
      ...
      e.fitInternal(s, { duration: this.duration_, easing: ai });
    }
  }
  ...
  class J_ extends Pr {
    ...
    handleEvent(t) {
      ...
      if (t.type == lt.KEYDOWN) {
        ...
        if (this.condition_(t) && (i == ks.DOWN || i == ks.LEFT || i == ks.RIGHT || i == ks.UP)) {
          const r = t.map.getView(), o = r.getResolution() * this.pixelDelta_;
          let a = 0, h = 0;
          i == ks.DOWN ? h = -o : i == ks.LEFT ? a = -o : i == ks.RIGHT ? a = o : h = o;
          const l = [a, h];
  ...
  function pd(n) {
    ...
    n instanceof mi && n.getLayers().forEach(pd);
  }
  function md(n, t) {
    if (n instanceof zo) {
      n.setMapInternal(t);
  ...
  let r0 = class extends Ve {
    constructor(n) {
      ...
      const e = this;
      n.view && !(n.view instanceof hn) && n.view.then(function(s) {
        e.setView(new hn(s));
    ...
    getAllLayers() {
      ...
      function t(e) {
        e.forEach(function(s) {
          s instanceof mi ? t(s.getLayers()) : n.push(s);
        });
      }
    ...
    getPixelFromCoordinate(n) {
      const t = wn(n, this.getView().getProjection());
    ...
    handleMapBrowserEvent(n) {
      ...
      if (n.frameState = this.frameState_, this.dispatchEvent(n) !== !1) {
        ...
        for (let i = s.length - 1; i >= 0; i--) {
          const r = s[i];
          if (!(r.getMap() !== this || !r.getActive() || !this.getTargetElement()) && (!r.handleEvent(n) || n.propagationStopped))
            break;
        }
      }
    }
    handlePostRender() {
      ...
      n && this.renderer_ && !n.animate && (this.renderComplete_ ? (this.hasListener(Ge.RENDERCOMPLETE) && this.renderer_.dispatchRenderEvent(Ge.RENDERCOMPLETE, n), this.loaded_ === !1 && (this.loaded_ = !0, this.dispatchEvent(new _i(An.LOADEND, this, n)))) : this.loaded_ === !0 && (this.loaded_ = !1, this.dispatchEvent(new _i(An.LOADSTART, this, n))));
    ...
    handleTargetChanged_() {
      ...
      if (this.targetElement_ = t, !t) this.renderer_ && (clearTimeout(this.postRenderTimeoutHandle_), this.postRenderTimeoutHandle_ = void 0, this.postRenderFunctions_.length = 0, this.renderer_.dispose(), this.renderer_ = null), this.animationDelayKey_ && (cancelAnimationFrame(this.animationDelayKey_), this.animationDelayKey_ = void 0);
        ...
        this.viewport_.addEventListener(lt.CONTEXTMENU, this.boundHandleBrowserEvent_, !1), this.viewport_.addEventListener(lt.WHEEL, this.boundHandleBrowserEvent_, Yh ? { passive: !1 } : !1);
        let e;
    ...
    handleViewChanged_() {
      ...
      n && (this.updateViewportSize_(this.getSize()), this.viewPropertyListenerKey_ = xt(n, $s.PROPERTYCHANGE, this.handleViewPropertyChanged_, this), this.viewChangeListenerKey_ = xt(n, lt.CHANGE, this.handleViewPropertyChanged_, this), n.resolveConstraints(0)), this.render();
    }
    handleLayerGroupChanged_() {
      ...
      n && (this.handleLayerAdd_(new Hn("addlayer", n)), this.layerGroupPropertyListenerKeys_ = [xt(n, $s.PROPERTYCHANGE, this.render, this), xt(n, lt.CHANGE, this.render, this), xt(n, "addlayer", this.handleLayerAdd_, this), xt(n, "removelayer", this.handleLayerRemove_, this)]), this.render();
    }
    isRendered() {
    ...
    renderFrame_(n) {
      ...
      this.frameState_ = i, this.renderer_.renderFrame(i), i && (i.animate && this.render(), Array.prototype.push.apply(this.postRenderFunctions_, i.postRenderFunctions), s && (!this.previousExtent_ || !ii(this.previousExtent_) && !si(i.extent, this.previousExtent_)) && (this.dispatchEvent(new _i(An.MOVESTART, this, s)), this.previousExtent_ = En(this.previousExtent_)), this.previousExtent_ && !i.viewHints[ie.ANIMATING] && !i.viewHints[ie.INTERACTING] && !si(i.extent, this.previousExtent_) && (this.dispatchEvent(new _i(An.MOVEEND, this, i)), th(i.extent, this.previousExtent_))), this.dispatchEvent(new _i(An.POSTRENDER, this, i)), this.renderComplete_ = (this.hasListener(An.LOADSTART) || this.hasListener(An.LOADEND) || this.hasListener(Ge.RENDERCOMPLETE)) && !this.tileQueue_.getTilesLoading() && !this.tileQueue_.getCount() && !this.getLoadingOrNotReady(), this.postRenderTimeoutHandle_ || (this.postRenderTimeoutHandle_ = setTimeout(() => {
        this.postRenderTimeoutHandle_ = void 0, this.handlePostRender();
      }, 0));
    }
    setLayerGroup(n) {
      const t = this.getLayerGroup();
      t && this.handleLayerRemove_(new Hn("removelayer", t)), this.set(he.LAYERGROUP, n);
    }
    setSize(n) {
      this.set(he.SIZE, n);
    }
    ...
    setView(n) {
      if (!n || n instanceof hn) {
        this.set(he.VIEW, n);
        return;
      }
      this.set(he.VIEW, new hn());
      const t = this;
      n.then(function(e) {
        t.setView(new hn(e));
      });
    ...
    updateSize() {
      ...
      t && (!e || !jn(t, e)) && (this.setSize(t), this.updateViewportSize_(t));
    }
  ...
  function o0(n) {
    ...
    const e = {}, s = n.layers && typeof n.layers.getLayers == "function" ? n.layers : new mi({ layers: n.layers });
    e[he.LAYERGROUP] = s, e[he.TARGET] = n.target, e[he.VIEW] = n.view instanceof hn ? n.view : new hn();
    let i;
    n.controls !== void 0 && (Array.isArray(n.controls) ? i = new rn(n.controls.slice()) : (wt(typeof n.controls.getArray == "function", "Expected `controls` to be an array or an `ol/Collection.js`"), i = n.controls));
    let r;
    n.interactions !== void 0 && (Array.isArray(n.interactions) ? r = new rn(n.interactions.slice()) : (wt(typeof n.interactions.getArray == "function", "Expected `interactions` to be an array or an `ol/Collection.js`"), r = n.interactions));
    let o;
    return n.overlays !== void 0 ? Array.isArray(n.overlays) ? o = new rn(n.overlays.slice()) : (wt(typeof n.overlays.getArray == "function", "Expected `overlays` to be an array or an `ol/Collection.js`"), o = n.overlays) : o = new rn(), { controls: i, interactions: r, keyboardEventTarget: t, overlays: o, values: e };
  }
  class na extends Ve {
    constructor(t) {
  ...
  class Qn extends vn {
    ...
    getSimplifiedGeometryInternal(t) {
      const e = [];
      return e.length = ko(this.flatCoordinates, 0, this.flatCoordinates.length, this.stride, t, e, 0), new Qn(e, "XY");
    }
    getType() {
      return "LineString";
    }
  ...
  const nt = { BEGIN_GEOMETRY: 0, BEGIN_PATH: 1, CIRCLE: 2, CLOSE_PATH: 3, CUSTOM: 4, DRAW_CHARS: 5, DRAW_IMAGE: 6, END_GEOMETRY: 7, FILL: 8, MOVE_TO_LINE_TO: 9, SET_FILL_STYLE: 10, SET_STROKE_STYLE: 11, STROKE: 12 }, ia = [nt.FILL], ts = [nt.STROKE], Ds = [nt.BEGIN_PATH], yd = [nt.CLOSE_PATH];
  class xd {
  ...
  class Nr extends xd {
    ...
    appendFlatPointCoordinates(t, e) {
      ...
      let o = r.length;
      for (let a = 0, h = t.length; a < h; a += e) i[0] = t[a], i[1] = t[a + 1], Rs(s, i) && (r[o++] = i[0], r[o++] = i[1]);
      return o;
    }
    appendFlatLineCoordinates(t, e, s, i, r, o) {
      ...
      let p = !0, f, y, E;
      for (f = e + i; f < s; f += i) d[0] = t[f], d[1] = t[f + 1], E = So(l, d), E !== y ? (p && (a[h++] = u, a[h++] = c, p = !1), a[h++] = d[0], a[h++] = d[1]) : E === $t.INTERSECTING ? (a[h++] = d[0], a[h++] = d[1], p = !1) : p = !0, u = d[0], c = d[1], y = E;
    ...
    drawCustom(t, e, s, i, r) {
      ...
      switch (o) {
        ...
        case "LineString":
        case "Circle":
          l = t.getFlatCoordinates(), u = this.appendFlatLineCoordinates(l, 0, l.length, a, !1, !1), this.instructions.push([nt.CUSTOM, h, u, t, s, Kn, r]), this.hitDetectionInstructions.push([nt.CUSTOM, h, u, t, i || s, Kn, r]);
          break;
        case "MultiPoint":
          l = t.getFlatCoordinates(), u = this.appendFlatPointCoordinates(l, a), u > h && (this.instructions.push([nt.CUSTOM, h, u, t, s, Kn, r]), this.hitDetectionInstructions.push([nt.CUSTOM, h, u, t, i || s, Kn, r]));
          break;
        case "Point":
    ...
    setFillStrokeStyle(t, e) {
      ...
      if (t) {
        const i = t.getColor();
        s.fillPatternScale = i && typeof i == "object" && "src" in i ? this.pixelRatio : 1, s.fillStyle = ln(i || Re);
      } else s.fillStyle = void 0;
      if (e) {
        const i = e.getColor();
        s.strokeStyle = ln(i || xr);
        const r = e.getLineCap();
        s.lineCap = r !== void 0 ? r : ci;
        const o = e.getLineDash();
        s.lineDash = o ? o.slice() : Rn;
        const a = e.getLineDashOffset();
        s.lineDashOffset = a || Cn;
        const h = e.getLineJoin();
        s.lineJoin = h !== void 0 ? h : di;
        const l = e.getWidth();
    ...
    updateStrokeStyle(t, e) {
      ...
      (t.currentStrokeStyle != s || t.currentLineCap != i || r != t.currentLineDash && !jn(t.currentLineDash, r) || t.currentLineDashOffset != o || t.currentLineJoin != a || t.currentLineWidth != h || t.currentMiterLimit != l) && (s !== void 0 && e.call(this, t), t.currentStrokeStyle = s, t.currentLineCap = i, t.currentLineDash = r, t.currentLineDashOffset = o, t.currentLineJoin = a, t.currentLineWidth = h, t.currentMiterLimit = l);
    }
    endGeometry(t) {
  ...
  class l0 extends Nr {
    ...
    drawMultiPoint(t, e, s) {
      ...
      for (let h = 0, l = i.length; h < l; h += t.getStride()) (!this.maxExtent || Rs(this.maxExtent, i.slice(h, h + 2))) && r.push(i[h], i[h + 1]);
  ...
  class u0 extends Nr {
    ...
    drawLineString(t, e, s) {
      ...
      this.updateStrokeStyle(i, this.applyStroke), this.beginGeometry(t, e, s), this.hitDetectionInstructions.push([nt.SET_STROKE_STYLE, i.strokeStyle, i.lineWidth, i.lineCap, i.lineJoin, i.miterLimit, Rn, Cn], Ds);
  ...
  class Ed extends Nr {
    ...
    drawFlatCoordinatess_(t, e, s, i) {
      ...
      return o && (this.instructions.push(ia), this.hitDetectionInstructions.push(ia)), a && (this.instructions.push(ts), this.hitDetectionInstructions.push(ts)), e;
    }
    drawCircle(t, e, s) {
      const i = this.state, r = i.fillStyle, o = i.strokeStyle;
      if (r === void 0 && o === void 0) return;
      this.setFillStrokeStyles_(), this.beginGeometry(t, e, s), i.fillStyle !== void 0 && this.hitDetectionInstructions.push([nt.SET_FILL_STYLE, Re]), i.strokeStyle !== void 0 && this.hitDetectionInstructions.push([nt.SET_STROKE_STYLE, i.strokeStyle, i.lineWidth, i.lineCap, i.lineJoin, i.miterLimit, Rn, Cn]);
      const a = t.getFlatCoordinates(), h = t.getStride(), l = this.coordinates.length;
      this.appendFlatLineCoordinates(a, 0, a.length, h, !1, !1);
      const u = [nt.CIRCLE, l];
      this.instructions.push(Ds, u), this.hitDetectionInstructions.push(Ds, u), i.fillStyle !== void 0 && (this.instructions.push(ia), this.hitDetectionInstructions.push(ia)), i.strokeStyle !== void 0 && (this.instructions.push(ts), this.hitDetectionInstructions.push(ts)), this.endGeometry(e);
    }
    drawPolygon(t, e, s) {
      const i = this.state, r = i.fillStyle, o = i.strokeStyle;
      if (r === void 0 && o === void 0) return;
    ...
    finish() {
      ...
      if (t !== 0) {
        ...
        for (let s = 0, i = e.length; s < i; ++s) e[s] = Is(e[s], t);
      }
      return super.finish();
    }
  ...
  class f0 extends Nr {
    ...
    drawText(t, e, s) {
      ...
      if (o.placement === "line" && (l == "LineString" || l == "MultiLineString" || l == "Polygon" || l == "MultiPolygon")) {
        ...
        this.instructions.push([nt.DRAW_IMAGE, h, p, null, NaN, NaN, NaN, 1, 0, 0, this.textRotateWithView_, this.textRotation_, [1, 1], NaN, this.declutterMode_, this.declutterImageWithText_, f == Ls ? Ls : f.map(function(w) {
          return w * y;
    ...
    saveTextStates_() {
      ...
      r in this.textStates || (this.textStates[r] = { font: e.font, textAlign: e.textAlign || Er, justify: e.justify, textBaseline: e.textBaseline || Ko, scale: e.scale });
    ...
    setTextStyle(t, e) {
      ...
      if (!t) this.text_ = "";
        ...
        const o = t.getFill();
        o ? (i = this.textFillState_, i || (i = {}, this.textFillState_ = i), i.fillStyle = ln(o.getColor() || Re)) : (i = null, this.textFillState_ = i);
        const a = t.getStroke();
        if (!a) r = null, this.textStrokeState_ = r;
          ...
          r.lineCap = a.getLineCap() || ci, r.lineDash = y ? y.slice() : Rn, r.lineDashOffset = E === void 0 ? Cn : E, r.lineJoin = a.getLineJoin() || di, r.lineWidth = M === void 0 ? Mr : M, r.miterLimit = w === void 0 ? yr : w, r.strokeStyle = ln(a.getColor() || xr);
        }
        s = this.textState_;
        const h = t.getFont() || Bc;
        km(h);
        const l = t.getScaleArray();
        s.overflow = t.getOverflow(), s.font = h, s.maxAngle = t.getMaxAngle(), s.placement = t.getPlacement(), s.textAlign = t.getTextAlign(), s.repeat = t.getRepeat(), s.justify = t.getJustify(), s.textBaseline = t.getTextBaseline() || Ko, s.backgroundFill = t.getBackgroundFill(), s.backgroundStroke = t.getBackgroundStroke(), s.padding = t.getPadding() || Ls, s.scale = l === void 0 ? [1, 1] : l;
  ...
  class Md {
    constructor() {
      yn(this, "pushMethodArgs_", (...t) => (this.instructions_[this.zIndex + this.offset_].push(t), this)), this.instructions_ = [], this.zIndex = 0, this.offset_ = 0, this.context_ = new Proxy(Xo(), { get: (t, e) => {
        if (typeof Xo()[e] == "function") return this.instructions_[this.zIndex + this.offset_] || (this.instructions_[this.zIndex + this.offset_] = []), this.instructions_[this.zIndex + this.offset_].push(e), this.pushMethodArgs_;
  ...
  let xi = null;
  function y0() {
    xi = Xt(1, 1, void 0, { willReadFrequently: !0 });
  }
  class Sd extends _0 {
    constructor(t) {
    ...
    getImageData(t, e, s) {
      xi || y0(), xi.clearRect(0, 0, 1, 1);
      let i;
      try {
        xi.drawImage(t, e, s, 1, 1, 0, 0, 1, 1), i = xi.getImageData(0, 0, 1, 1).data;
      } catch {
        return xi = null, null;
      }
      return i;
    ...
    useContainer(t, e, s) {
      ...
      let r, o;
      if (t && t.className === i && (!s || t && t.style.backgroundColor && jn(ui(t.style.backgroundColor), ui(s)))) {
    ...
    clipUnrotated(t, e, s) {
      const i = on(s), r = ar(s), o = or(s), a = rr(s);
    ...
    prepareContainer(t, e) {
      ...
      Sn(this.pixelTransform, t.size[0] / 2, t.size[1] / 2, 1 / o, 1 / o, r, -a / 2, -h / 2), hc(this.inversePixelTransform, this.pixelTransform);
    ...
    getRenderTransform(t, e, s, i, r, o, a) {
      ...
      return Sn(this.tempTransform, h, l, u, c, -s, d, p);
    }
    disposeInternal() {
  ...
  function x0(n, t, e, s, i, r, o, a, h, l, u, c, d = !0) {
    ...
    for (let B = 0, it = i.length; B < it; ) {
      ...
      V.push([et, b, Y / 2, ot, mt]), r += Y;
    }
    return V;
  }
  const Ei = Se(), es = [], Pn = [], Ln = [], ns = [];
  function vd(n) {
...
`) {
        ...
        const Y = [ot, P + A * E[V] + c * (E[V] - w[X]), 0.5 * (d + k) + J];
        P += E[V], i && F.push("strokeText", Y), s && z.push("fillText", Y), ++V;
      }
    ...
    calculateImageOrLabelDimensions_(t, e, s, i, r, o, a, h, l, u, c, d, p, f, y, E) {
      ...
      (y || c !== 0) && (es[0] = O, ns[0] = O, es[1] = A, Pn[1] = A, Pn[0] = O + R, Ln[0] = Pn[0], Ln[1] = A + I, ns[1] = Ln[1]);
      let P;
      return c !== 0 ? (P = Sn(Ue(), s, i, 1, 1, c, -s, -i), Vt(P, es), Vt(P, Pn), Vt(P, Ln), Vt(P, ns), Ne(Math.min(es[0], Pn[0], Ln[0], ns[0]), Math.min(es[1], Pn[1], Ln[1], ns[1]), Math.max(es[0], Pn[0], Ln[0], ns[0]), Math.max(es[1], Pn[1], Ln[1], ns[1]), Ei)) : Ne(Math.min(O, O + R), Math.min(A, A + I), Math.max(O, O + R), Math.max(A, A + I), Ei), p && (M = Math.round(M), w = Math.round(w)), { drawImageX: M, drawImageY: w, drawImageW: C, drawImageH: v, originX: l, originY: u, declutterBox: { minX: Ei[0], minY: Ei[1], maxX: Ei[2], maxY: Ei[3], value: E }, canvasTransform: P, scale: d };
    }
    replayImageOrLabel_(t, e, s, i, r, o, a) {
      const h = !!(o || a), l = i.declutterBox, u = a ? a[2] * i.scale[0] / 2 : 0;
      return l.minX - u <= e[0] && l.maxX + u >= 0 && l.minY - u <= e[1] && l.maxY + u >= 0 && (h && this.replayTextBackground_(t, es, Pn, Ln, ns, o, a), zm(t, i.canvasTransform, r, s, i.originX, i.originY, i.drawImageW, i.drawImageH, i.drawImageX, i.drawImageY, i.scale)), !0;
    }
    fill_(t) {
    ...
    drawLabelWithPointPlacement_(t, e, s, i) {
      const r = this.textStates[e], o = this.createLabel(t, e, i, s), a = this.strokeStates[s], h = this.pixelRatio, l = fl(Array.isArray(t) ? t[0] : t, r.textAlign || Er), u = ra[r.textBaseline || Ko], c = a && a.lineWidth ? a.lineWidth : 0, d = o.width / h - 2 * r.scale[0], p = l * d + 2 * (0.5 - l) * c, f = u * o.height / h + 2 * (0.5 - u) * c;
      return { label: o, anchorX: p, anchorY: f };
    }
    execute_(t, e, s, i, r, o, a, h) {
      const l = this.zIndexContext_;
      let u;
      this.pixelCoordinates_ && jn(s, this.renderedTransform_) ? u = this.pixelCoordinates_ : (this.pixelCoordinates_ || (this.pixelCoordinates_ = []), u = Vn(this.coordinates, 0, this.coordinates.length, 2, s, this.pixelCoordinates_), zp(this.renderedTransform_, s));
      let c = 0;
      const d = i.length;
      let p = 0, f, y, E, M, w, C, v, R, I, O, A, P, F, z = 0, k = 0, J = null, V = null;
      const X = this.coordinateCache_, Q = this.viewRotation_, B = Math.round(Math.atan2(-s[1], s[0]) * 1e12) / 1e12, it = { context: t, pixelRatio: this.pixelRatio, resolution: this.resolution, rotation: Q }, ot = this.instructions != i || this.overlaps ? 0 : 200;
      let H, Y, mt, et;
      for (; c < d; ) {
        const b = i[c];
        switch (b[0]) {
          ...
          case nt.CIRCLE:
            p = b[1];
            const at = u[p], Pt = u[p + 1], Ut = u[p + 2], Yt = u[p + 3], tn = Ut - at, Bt = Yt - Pt, pn = Math.sqrt(tn * tn + Bt * Bt);
            t.moveTo(at + pn, Pt), t.arc(at, Pt, pn, 0, 2 * Math.PI, !0), ++c;
            break;
          case nt.CLOSE_PATH:
            t.closePath(), ++c;
            break;
          case nt.CUSTOM:
            p = b[1], f = b[2];
            const ls = b[3], mn = b[4], Nn = b[5];
            it.geometry = ls, it.feature = H, c in X || (X[c] = []);
            const en = X[c];
            Nn ? Nn(u, p, f, 2, en) : (en[0] = u[p], en[1] = u[p + 1], en.length = 2), l && (l.zIndex = b[6]), mn(en, it), ++c;
            break;
          case nt.DRAW_IMAGE:
            p = b[1], f = b[2], I = b[3], y = b[4], E = b[5];
            let de = b[6];
            const Ye = b[7], us = b[8], cs = b[9], _n = b[10];
            let Fn = b[11];
            const ds = b[12];
            let fs = b[13];
            M = b[14] || "declutter";
            ...
            if (!I && b.length >= 20) {
              ...
              I = Pe.label, b[3] = I;
              const Dn = b[23];
              y = (Pe.anchorX - Dn) * this.pixelRatio, b[4] = y;
              const Ee = b[24];
              E = (Pe.anchorY - Ee) * this.pixelRatio, b[5] = E, de = I.height, b[6] = de, fs = I.width, b[13] = fs;
            }
            let eo;
            b.length > 25 && (eo = b[25]);
            let Ui, Us, gs;
            b.length > 17 ? (Ui = b[16], Us = b[17], gs = b[18]) : (Ui = Ls, Us = !1, gs = !1), _n && B ? Fn += Q : !_n && !B && (Fn -= Q);
            let no = 0;
            for (; p < f; p += 2) {
              if (eo && eo[no++] < fs / this.pixelRatio) continue;
              const Pe = this.calculateImageOrLabelDimensions_(I.width, I.height, u[p], u[p + 1], fs, de, y, E, us, cs, Fn, ds, r, Ui, Us || gs, H), Dn = [t, e, I, Pe, Ye, Us ? J : null, gs ? V : null];
              if (h) {
                let Ee, Le, fe;
                if (qt) {
                  const Dt = f - p;
                  if (!qt[Dt]) {
                    qt[Dt] = { args: Dn, declutterMode: M };
                    continue;
                  }
                  const ne = qt[Dt];
                ...
                let nn, sn;
                if (Ee && (Le !== "declutter" || !h.collides(fe)) && (nn = !0), (M !== "declutter" || !h.collides(Pe.declutterBox)) && (sn = !0), Le === "declutter" && M === "declutter") {
                  const Dt = nn && sn;
                  nn = Dt, sn = Dt;
                }
                nn && (Le !== "none" && h.insert(fe), this.replayImageOrLabel_.apply(this, Ee)), sn && (M !== "none" && h.insert(Pe.declutterBox), this.replayImageOrLabel_.apply(this, Dn));
              } else this.replayImageOrLabel_.apply(this, Dn);
            }
            ++c;
            break;
          case nt.DRAW_CHARS:
            const Bs = b[1], Bi = b[2], js = b[3], Ws = b[4];
            F = b[5];
            ...
            const Wi = [b[13], b[13]];
            M = b[14] || "declutter";
            const Oa = b[15], io = this.textStates[A], ps = io.font, ms = [io.scale[0] * La, io.scale[1] * La];
            let kn;
            ps in this.widths_ ? kn = this.widths_[ps] : (kn = {}, this.widths_[ps] = kn);
            const Xi = _d(u, Bs, Bi, 2), ro = Math.abs(ms[0]) * Wc(ps, O, kn);
            if (Ws || ro <= Xi) {
              const Pe = this.textStates[A].textAlign, Dn = (Xi - ro) * fl(O, Pe), Ee = x0(u, Bs, Bi, 2, O, Dn, Jl, Math.abs(ms[0]), Wc, ps, kn, B ? 0 : this.viewRotation_, Oa);
              t: if (Ee) {
                const Le = [];
                let fe, nn, sn, Dt, ne;
                if (P) for (fe = 0, nn = Ee.length; fe < nn; ++fe) {
                  ne = Ee[fe], sn = ne[4], Dt = this.createLabel(sn, A, "", P), y = ne[2] + (ms[0] < 0 ? -ji : ji), E = js * Dt.height + (0.5 - js) * 2 * ji * ms[1] / ms[0] - so;
                  const qe = this.calculateImageOrLabelDimensions_(Dt.width, Dt.height, ne[0], ne[1], Dt.width, Dt.height, y, E, 0, 0, ne[3], Wi, !1, Ls, !1, H);
                  if (h && M === "declutter" && h.collides(qe.declutterBox)) break t;
                  Le.push([t, e, Dt, qe, 1, null, null]);
                }
                if (F) for (fe = 0, nn = Ee.length; fe < nn; ++fe) {
                  ne = Ee[fe], sn = ne[4], Dt = this.createLabel(sn, A, F, ""), y = ne[2], E = js * Dt.height - so;
                  const qe = this.calculateImageOrLabelDimensions_(Dt.width, Dt.height, ne[0], ne[1], Dt.width, Dt.height, y, E, 0, 0, ne[3], Wi, !1, Ls, !1, H);
                  if (h && M === "declutter" && h.collides(qe.declutterBox)) break t;
                  Le.push([t, e, Dt, qe, 1, null, null]);
                }
          ...
          case nt.MOVE_TO_LINE_TO:
            for (p = b[1], f = b[2], Y = u[p], mt = u[p + 1], t.moveTo(Y, mt), w = Y + 0.5 | 0, C = mt + 0.5 | 0, p += 2; p < f; p += 2) Y = u[p], mt = u[p + 1], v = Y + 0.5 | 0, R = mt + 0.5 | 0, (p == f - 2 || v !== w || R !== C) && (t.lineTo(Y, mt), w = v, C = R);
            ++c;
            break;
  ...
  const Mi = ["Polygon", "Circle", "LineString", "Image", "Text", "Default"], Cd = ["Image", "Text"], w0 = Mi.filter((n) => !Cd.includes(n));
  class S0 {
    ...
    forEachFeatureAtCoordinate(t, e, s, i, r, o) {
      i = Math.round(i);
      const a = i * 2 + 1, h = Sn(this.hitDetectionTransform_, i + 0.5, i + 0.5, 1 / e, -1 / e, -s, -t[0], -t[1]), l = !this.hitDetectionContext_;
      l && (this.hitDetectionContext_ = Xt(a, a, void 0, { willReadFrequently: !0 }));
      ...
      let c;
      this.renderBuffer_ !== void 0 && (c = Se(), Cs(c, t), Mo(c, e * (this.renderBuffer_ + i), c));
      const d = v0(i);
      let p;
      function f(R, I, O) {
      ...
      for (E = y.length - 1; E >= 0; --E) {
        ...
        for (w = this.executorsByZIndex_[R], M = Mi.length - 1; M >= 0; --M) if (p = Mi[M], C = w[p], C !== void 0 && (v = C.executeHitDetection(u, h, s, f, c), v)) return v;
      }
    }
    getClipCoords(t) {
    ...
    renderDeferred() {
      const t = this.deferredZIndexContexts_, e = Object.keys(t).map(Number).sort(Bn);
  ...
  class pl extends xd {
    constructor(t, e, s, i, r, o, a) {
      super(), this.context_ = t, this.pixelRatio_ = e, this.extent_ = s, this.transform_ = i, this.transformRotation_ = i ? Ka(Math.atan2(i[1], i[0]), 10) : 0, this.viewRotation_ = r, this.squaredTolerance_ = o, this.userTransform_ = a, this.contextFillState_ = null, this.contextStrokeState_ = null, this.contextTextState_ = null, this.fillState_ = null, this.strokeState_ = null, this.image_ = null, this.imageAnchorX_ = 0, this.imageAnchorY_ = 0, this.imageHeight_ = 0, this.imageOpacity_ = 0, this.imageOriginX_ = 0, this.imageOriginY_ = 0, this.imageRotateWithView_ = !1, this.imageRotation_ = 0, this.imageScale_ = [0, 0], this.imageWidth_ = 0, this.text_ = "", this.textOffsetX_ = 0, this.textOffsetY_ = 0, this.textRotateWithView_ = !1, this.textRotation_ = 0, this.textScale_ = [0, 0], this.textFillState_ = null, this.textStrokeState_ = null, this.textState_ = null, this.pixelCoordinates_ = [], this.tmpLocalTransform_ = Ue();
    }
    drawImages_(t, e, s, i) {
      if (!this.image_) return;
      const r = Vn(t, e, s, i, this.transform_, this.pixelCoordinates_), o = this.context_, a = this.tmpLocalTransform_, h = o.globalAlpha;
      ...
      for (let u = 0, c = r.length; u < c; u += 2) {
        ...
        if (l !== 0 || this.imageScale_[0] != 1 || this.imageScale_[1] != 1) {
          ...
          Sn(a, f, y, 1, 1, l, -f, -y), o.save(), o.transform.apply(o, a), o.translate(f, y), o.scale(this.imageScale_[0], this.imageScale_[1]), o.drawImage(this.image_, this.imageOriginX_, this.imageOriginY_, this.imageWidth_, this.imageHeight_, -this.imageAnchorX_, -this.imageAnchorY_, this.imageWidth_, this.imageHeight_), o.restore();
    ...
    drawText_(t, e, s, i) {
      ...
      const r = Vn(t, e, s, i, this.transform_, this.pixelCoordinates_), o = this.context_;
    ...
    moveToLineTo_(t, e, s, i, r) {
      const o = this.context_, a = Vn(t, e, s, i, this.transform_, this.pixelCoordinates_);
      o.moveTo(a[0], a[1]);
      let h = a.length;
      r && (h -= 2);
    ...
    setContextStrokeState_(t) {
      ...
      s ? (s.lineCap != t.lineCap && (s.lineCap = t.lineCap, e.lineCap = t.lineCap), jn(s.lineDash, t.lineDash) || e.setLineDash(s.lineDash = t.lineDash), s.lineDashOffset != t.lineDashOffset && (s.lineDashOffset = t.lineDashOffset, e.lineDashOffset = t.lineDashOffset), s.lineJoin != t.lineJoin && (s.lineJoin = t.lineJoin, e.lineJoin = t.lineJoin), s.lineWidth != t.lineWidth && (s.lineWidth = t.lineWidth, e.lineWidth = t.lineWidth), s.miterLimit != t.miterLimit && (s.miterLimit = t.miterLimit, e.miterLimit = t.miterLimit), s.strokeStyle != t.strokeStyle && (s.strokeStyle = t.strokeStyle, e.strokeStyle = t.strokeStyle)) : (e.lineCap = t.lineCap, e.setLineDash(t.lineDash), e.lineDashOffset = t.lineDashOffset, e.lineJoin = t.lineJoin, e.lineWidth = t.lineWidth, e.miterLimit = t.miterLimit, e.strokeStyle = t.strokeStyle, this.contextStrokeState_ = { lineCap: t.lineCap, lineDash: t.lineDash, lineDashOffset: t.lineDashOffset, lineJoin: t.lineJoin, lineWidth: t.lineWidth, miterLimit: t.miterLimit, strokeStyle: t.strokeStyle });
    }
    ...
    setFillStrokeStyle(t, e) {
      if (!t) this.fillState_ = null;
        ...
        const s = t.getColor();
        this.fillState_ = { fillStyle: ln(s || Re) };
      }
      if (!e) this.strokeState_ = null;
      else {
        const s = e.getColor(), i = e.getLineCap(), r = e.getLineDash(), o = e.getLineDashOffset(), a = e.getLineJoin(), h = e.getWidth(), l = e.getMiterLimit(), u = r || Rn;
        this.strokeState_ = { lineCap: i !== void 0 ? i : ci, lineDash: this.pixelRatio_ === 1 ? u : u.map((c) => c * this.pixelRatio_), lineDashOffset: (o || Cn) * this.pixelRatio_, lineJoin: a !== void 0 ? a : di, lineWidth: (h !== void 0 ? h : Mr) * this.pixelRatio_, miterLimit: l !== void 0 ? l : yr, strokeStyle: ln(s || xr) };
      }
    }
    setImageStyle(t) {
      let e;
    ...
    setTextStyle(t) {
      if (!t) this.text_ = "";
        ...
        if (!e) this.textFillState_ = null;
          ...
          const p = e.getColor();
          this.textFillState_ = { fillStyle: ln(p || Re) };
        }
        const s = t.getStroke();
        if (!s) this.textStrokeState_ = null;
          ...
          this.textStrokeState_ = { lineCap: f !== void 0 ? f : ci, lineDash: y || Rn, lineDashOffset: E || Cn, lineJoin: M !== void 0 ? M : di, lineWidth: w !== void 0 ? w : Mr, miterLimit: C !== void 0 ? C : yr, strokeStyle: ln(p || xr) };
        }
        ...
        this.textState_ = { font: i !== void 0 ? i : Bc, textAlign: c !== void 0 ? c : Er, textBaseline: d !== void 0 ? d : Ko }, this.text_ = u !== void 0 ? Array.isArray(u) ? u.reduce((p, f, y) => p += y % 2 ? " " : f, "") : u : "", this.textOffsetX_ = r !== void 0 ? this.pixelRatio_ * r : 0, this.textOffsetY_ = o !== void 0 ? this.pixelRatio_ * o : 0, this.textRotateWithView_ = a !== void 0 ? a : !1, this.textRotation_ = h !== void 0 ? h : 0, this.textScale_ = [this.pixelRatio_ * l[0], this.pixelRatio_ * l[1]];
      }
    }
  }
  const R0 = Object.freeze(Object.defineProperty({ __proto__: null, Circle: Os, Fill: Ze, Icon: Sr, IconImage: Kh, Image: _r, RegularShape: wr, Stroke: ke, Style: ae, Text: $o }, Symbol.toStringTag, { value: "Module" })), un = 0.5;
  function C0(n, t, e, s, i, r, o, a, h) {
    const l = i, u = n[0] * un, c = n[1] * un, d = Xt(u, c);
    d.imageSmoothingEnabled = !1;
    const p = d.canvas, f = new pl(d, un, i, null, o, a, null), y = e.length, E = Math.floor((256 * 256 * 256 - 1) / y), M = {};
    for (let C = 1; C <= y; ++C) {
      ...
      for (let A = 0, P = I.length; A < P; ++A) {
        ...
        const X = F.getImage();
        if (X) {
          const ot = X.getImageSize();
          if (!ot) continue;
          const H = Xt(ot[0], ot[1], void 0, { alpha: !1 }), Y = H.canvas;
          H.fillStyle = O, H.fillRect(0, 0, Y.width, Y.height), k.setImage(new Sr({ img: Y, anchor: X.getAnchor(), anchorXUnits: "pixels", anchorYUnits: "pixels", offset: X.getOrigin(), opacity: 1, size: X.getSize(), scale: X.getScale(), rotation: X.getRotation(), rotateWithView: X.getRotateWithView() }));
        }
    ...
    const w = Object.keys(M).map(Number).sort(Bn);
    for (let C = 0, v = w.length; C < v; ++C) {
      const R = M[w[C]];
      for (const I in R) {
        const O = R[I];
  ...
  function b0(n, t, e) {
    const s = [];
    if (e) {
      const i = Math.floor(Math.round(n[0]) * un), r = Math.floor(Math.round(n[1]) * un), o = (kt(i, 0, e.width - 1) + kt(r, 0, e.height - 1) * e.width) * 4, a = e.data[o], h = e.data[o + 1], l = e.data[o + 2] + 256 * (h + 256 * a), u = Math.floor((256 * 256 * 256 - 1) / t.length);
  ...
  class z0 extends Sd {
    ...
    renderWorlds(t, e, s) {
      ...
      do {
        ...
        e.declutter && (O = O.slice(0)), t.execute(E, [E.canvas.width, E.canvas.height], O, l, y, s === void 0 ? Mi : s ? Cd : w0, s ? d && e.declutter[d] : void 0);
      } while (++I < R);
    }
    setDrawContext_() {
      this.opacity_ !== 1 && (this.targetContext_ = this.context, this.context = Xt(this.context.canvas.width, this.context.canvas.height, wd));
    }
    resetDrawContext_() {
      if (this.opacity_ !== 1) {
        const t = this.targetContext_.globalAlpha;
        this.targetContext_.globalAlpha = this.opacity_, this.targetContext_.drawImage(this.context.canvas, 0, 0), this.targetContext_.globalAlpha = t, Yo(this.context), wd.push(this.context.canvas), this.context = this.targetContext_, this.targetContext_ = null;
      }
    }
    renderDeclutter(t) {
    ...
    renderFrame(t, e) {
      ...
      if (this.setDrawContext_(), this.preRender(r, t), i.projection, this.clipped_ = !1, a && s.extent && this.clipping) {
        const h = qn(s.extent);
        a = re(h, t.extent), this.clipped_ = a && !Yn(h, t.extent), this.clipped_ && this.clipUnrotated(r, t, h);
      }
    ...
    getFeatures(t) {
      return new Promise((e) => {
        if (this.frameState && !this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
          const s = this.frameState.size.slice(), i = this.renderedCenter_, r = this.renderedResolution_, o = this.renderedRotation_, a = this.renderedProjection_, h = this.wrappedRenderedExtent_, l = this.getLayer(), u = [], c = s[0] * un, d = s[1] * un;
          u.push(this.getRenderTransform(i, r, o, un, c, d, 0).slice());
          const p = l.getSource(), f = a.getExtent();
          if (p.getWrapX() && a.canWrapX() && !Yn(f, h)) {
            let y = h[0];
            const E = pt(f);
            let M = 0, w;
            for (; y < f[0]; ) --M, w = E * M, u.push(this.getRenderTransform(i, r, o, un, c, d, w).slice()), y += E;
            for (M = 0, y = h[2]; y > f[2]; ) ++M, w = E * M, u.push(this.getRenderTransform(i, r, o, un, c, d, w).slice()), y -= E;
          }
    ...
    prepareFrame(t) {
      ...
      if (s.getWrapX() && u.canWrapX() && !Yn(v, t.extent)) {
        const V = pt(v), X = Math.max(pt(M) / 2, V);
        M[0] = v[0] - X, M[2] = v[2] + X, Bu(E, u);
        const Q = ih(C[0], u);
        Q[0] < v[0] && Q[2] < v[2] ? C.push([Q[0] + V, Q[1], Q[2] + V, Q[3]]) : Q[0] > v[0] && Q[2] > v[2] && C.push([Q[0] - V, Q[1], Q[2] - V, Q[3]]);
      }
      if (this.ready && this.renderedResolution_ == c && this.renderedRevision_ == p && this.renderedRenderOrder_ == y && this.renderedFrameDeclutter_ === !!t.declutter && Yn(this.wrappedRenderedExtent_, M)) return jn(this.renderedExtent_, w) || (this.hitDetectionImageData_ = null, this.renderedExtent_ = w), this.renderedCenter_ = E, this.replayGroupChanged = !1, !0;
      this.replayGroup_ = null;
      const R = new p0(Td(c, d), M, c, d);
      let I;
      for (let V = 0, X = C.length; V < X; ++V) s.loadFeatures(C[V], c, u);
      const O = ml(c, d);
      let A = !0;
      const P = (V, X) => {
        let Q;
        ...
        if (B && (Q = B(V, c)), Q) {
          const it = this.renderFeature(V, O, Q, R, I, this.getLayer().getDeclutter(), X);
          A = A && !it;
        }
      }, F = ec(M), z = s.getFeaturesInExtent(F);
      y && z.sort(y);
      for (let V = 0, X = z.length; V < X; ++V) P(z[V], V);
  ...
  class Pd {
    ...
    update(t, e) {
      ...
      si(i, t) || (this.remove(e), this.insert(t, e));
    }
    getAll() {
  ...
  class wi extends vn {
    ...
    clone() {
      const t = new wi(this.flatCoordinates.slice(), this.layout, this.ends_.slice());
      return t.applyProperties(this), t;
    }
    closestPointXY(t, e, s, i) {
    ...
    getLineString(t) {
      return t < 0 || this.ends_.length <= t ? null : new Qn(this.flatCoordinates.slice(t === 0 ? 0 : this.ends_[t - 1], this.ends_[t]), this.layout);
    }
    getLineStrings() {
      const t = this.flatCoordinates, e = this.ends_, s = this.layout, i = [];
      let r = 0;
      for (let o = 0, a = e.length; o < a; ++o) {
        const h = e[o], l = new Qn(t.slice(r, h), s);
        i.push(l), r = h;
      }
      return i;
    }
    ...
    getSimplifiedGeometryInternal(t) {
      const e = [], s = [];
      return e.length = gc(this.flatCoordinates, 0, this.ends_, this.stride, t, e, 0, s), new wi(e, "XY", s);
    }
    getType() {
  ...
  class Si extends vn {
    ...
    clone() {
      ...
      const s = new Si(this.flatCoordinates.slice(), this.layout, e);
      return s.applyProperties(this), s;
    }
    closestPointXY(t, e, s, i) {
      return i < Xn(this.getExtent(), t, e) ? i : (this.maxDeltaRevision_ != this.getRevision() && (this.maxDelta_ = Math.sqrt(Vp(this.flatCoordinates, 0, this.endss_, this.stride, 0)), this.maxDeltaRevision_ = this.getRevision()), Kp(this.getOrientedFlatCoordinates(), 0, this.endss_, this.stride, this.maxDelta_, !0, t, e, s, i));
    }
    containsXY(t, e) {
    ...
    getSimplifiedGeometryInternal(t) {
      const e = [], s = [];
      return e.length = Hp(this.flatCoordinates, 0, this.endss_, this.stride, Math.sqrt(t), e, 0, s), new Si(e, "XY", s);
    }
    getPolygon(t) {
      ...
      return new an(this.flatCoordinates.slice(e, i), this.layout, s);
    }
    getPolygons() {
      ...
      for (let o = 0, a = s.length; o < a; ++o) {
        ...
        const u = new an(e.slice(r, l), t, h);
        i.push(u), r = l;
      }
      return i;
    }
  ...
  const B0 = Object.freeze(Object.defineProperty({ __proto__: null, Circle: oa, Geometry: No, GeometryCollection: aa, LineString: Qn, LinearRing: As, MultiLineString: wi, MultiPoint: Fr, MultiPolygon: Si, Point: ur, Polygon: an, SimpleGeometry: vn }, Symbol.toStringTag, { value: "Module" })), Od = Ue();
  class Je {
    constructor(t, e, s, i, r, o) {
    ...
    transform(t) {
      ...
      if (e && s) {
        const i = Wt(s) / Wt(e);
        Sn(Od, s[0], s[3], i, -i, 0, 0, 0), Vn(this.flatCoordinates_, 0, this.flatCoordinates_.length, 2, Od, this.flatCoordinates_);
      }
    }
    applyTransform(t) {
    ...
    clone() {
      var t;
      return new Je(this.type_, this.flatCoordinates_.slice(), (t = this.ends_) == null ? void 0 : t.slice(), this.stride_, Object.assign({}, this.properties_), this.id_);
    }
    getEnds() {
      return this.ends_;
    }
    enableSimplifyTransformed() {
      return this.simplifyTransformed = Cu((t, e) => {
        ...
        return i && (this.simplifiedGeometry_ = new Je(this.type_, s, i, 2, this.properties_, this.id_)), this.squaredTolerance_ = t, this.simplifiedGeometry_;
      }), this;
    }
  }
  ...
  class Y0 extends Nd {
    constructor(t) {
      ...
      let s, i;
      Array.isArray(t.features) ? i = t.features : t.features && (s = t.features, i = s.getArray()), !e && s === void 0 && (s = new rn(i)), i !== void 0 && this.addFeaturesInternal(i), s !== void 0 && this.bindFeaturesCollection_(s);
    }
    addFeature(t) {
    ...
    addFeatureInternal(t) {
      ...
      this.dispatchEvent(new ss(je.ADDFEATURE, t));
    }
    setupChangeEvents_(t, e) {
      e instanceof Je || (this.featureChangeKeys_[t] = [xt(e, lt.CHANGE, this.handleFeatureChange_, this), xt(e, $s.PROPERTYCHANGE, this.handleFeatureChange_, this)]);
    }
    addToIndex_(t, e) {
      let s = !0;
      if (e.getId() !== void 0) {
        ...
        if (!(i in this.idIndex_)) this.idIndex_[i] = e;
          ...
          r instanceof Je ? Array.isArray(r) ? r.push(e) : this.idIndex_[i] = [r, e] : s = !1;
        } else s = !1;
      }
    ...
    addFeaturesInternal(t) {
      ...
      if (this.featuresRtree_ && this.featuresRtree_.load(e, i), this.hasListener(je.ADDFEATURE)) for (let r = 0, o = s.length; r < o; r++) this.dispatchEvent(new ss(je.ADDFEATURE, s[r]));
    }
    ...
    forEachFeatureAtCoordinateDirect(t, e) {
      ...
      return this.forEachFeatureInExtent(s, function(i) {
        ...
        if (r instanceof Je || r.intersectsCoordinate(t)) return e(i);
      });
    }
    ...
    forEachFeatureIntersectingExtent(t, e) {
      return this.forEachFeatureInExtent(t, function(s) {
        ...
        if (i instanceof Je || i.intersectsExtent(t)) {
          const r = e(s);
          if (r) return r;
        }
      });
    ...
    getClosestFeatureToCoordinate(t, e) {
      ...
      return e = e || tr, this.featuresRtree_.forEachInExtent(h, function(l) {
        if (e(l)) {
          ...
          if (a = u instanceof Je ? 0 : u.closestPointXY(s, i, o, a), a < c) {
            r = l;
            const d = Math.sqrt(a);
    ...
    handleFeatureChange_(t) {
      ...
      this.changed(), this.dispatchEvent(new ss(je.CHANGEFEATURE, e));
    }
    hasFeature(t) {
      const e = t.getId();
    ...
    loadFeatures(t, e, s) {
      ...
      for (let o = 0, a = r.length; o < a; ++o) {
        ...
        i.forEachInExtent(h, function(l) {
          return Yn(l.extent, h);
        }) || (++this.loadingExtentsCount_, this.dispatchEvent(new ss(je.FEATURESLOADSTART)), this.loader_.call(this, h, e, s, (l) => {
          --this.loadingExtentsCount_, this.dispatchEvent(new ss(je.FEATURESLOADEND, void 0, l));
        }, () => {
          --this.loadingExtentsCount_, this.dispatchEvent(new ss(je.FEATURESLOADERROR));
    ...
    removeFeatureInternal(t) {
      ...
      return delete this.uidIndex_[e], this.hasListener(je.REMOVEFEATURE) && this.dispatchEvent(new ss(je.REMOVEFEATURE, t)), !0;
    }
  ...
  const Z0 = Object.freeze(Object.defineProperty({ __proto__: null, getRenderPixel: K0, getVectorContext: V0, toContext: q0 }, Symbol.toStringTag, { value: "Module" }));
  function ha() {
  ...
  let vi = null;
  function ty(n) {
    vi || (vi = Xt(n.width, n.height, void 0, { willReadFrequently: !0 }));
    const t = vi.canvas, e = n.width;
    t.width !== e && (t.width = e);
    const s = n.height;
    return t.height !== s && (t.height = s), vi.clearRect(0, 0, e, s), vi.drawImage(n, 0, 0), vi.getImageData(0, 0, e, s).data;
  }
  const ey = [256, 256];
  class El extends xl {
    constructor(t) {
  ...
  class Ud {
    constructor(t, e, s, i, r, o, a) {
      ...
      let h = {};
      const l = a ? fh((C) => Vt(a, tc(C, this.targetProj_, this.sourceProj_))) : oi(this.targetProj_, this.sourceProj_);
      ...
      const u = on(s), c = ar(s), d = or(s), p = rr(s), f = this.transformInv_(u), y = this.transformInv_(c), E = this.transformInv_(d), M = this.transformInv_(p), w = ny + (o ? Math.max(0, Math.ceil(Math.log2(bs(s) / (o * o * 256 * 256)))) : 0);
    ...
    addQuad_(t, e, s, i, r, o, a, h, l) {
      ...
      if (l > 0) {
        if (!f) {
          ...
          let w;
          p ? w = (Qs(r[0], d) + Qs(a[0], d)) / 2 - Qs(M[0], d) : w = (r[0] + a[0]) / 2 - M[0];
  ...
  function sy() {
    if (Ml === void 0) {
      ...
      Ml = wl(t, 0) || wl(t, 4) || wl(t, 8), Yo(n), Ri.push(n.canvas);
    }
    return Ml;
  }
  function jd(n, t, e, s) {
  ...
  function iy(n, t, e, s, i, r, o, a, h, l, u, c, d, p) {
    const f = Xt(Math.round(e * n), Math.round(e * t), Ri);
    ...
    M = Xt(Math.round(pt(E) * w), Math.round(Wt(E) * w), Ri), c || (M.imageSmoothingEnabled = !1), h.forEach(function(R, I, O) {
      if (R.image.width > 0 && R.image.height > 0) {
        if (R.clipExtent) {
          M.save();
          const k = (R.clipExtent[0] - E[0]) * w, J = -(R.clipExtent[3] - E[3]) * w, V = pt(R.clipExtent) * w, X = Wt(R.clipExtent) * w;
          M.rect(c ? k : Math.round(k), c ? J : Math.round(J), c ? V : Math.round(k + V) - Math.round(k), c ? X : Math.round(J + X) - Math.round(J)), M.clip();
        }
    ...
    return a.getTriangles().forEach(function(R, I, O) {
      ...
      let F = A[0][0], z = A[0][1], k = A[1][0], J = A[1][1], V = A[2][0], X = A[2][1];
      const Q = y((P[0][0] - v[0]) / r), B = y(-(P[0][1] - v[1]) / r), it = y((P[1][0] - v[0]) / r), ot = y(-(P[1][1] - v[1]) / r), H = y((P[2][0] - v[0]) / r), Y = y(-(P[2][1] - v[1]) / r), mt = F, et = z;
      F = 0, z = 0, k -= mt, J -= et, V -= mt, X -= et;
      const b = [[k, J, 0, 0, it - Q], [V, X, 0, 0, H - Q], [0, 0, k, J, ot - B], [0, 0, V, X, Y - B]], at = Ug(b);
      if (!at) return;
      if (f.save(), f.beginPath(), sy() || !c) {
        f.moveTo(it, ot);
        const Ut = 4, Yt = Q - it, tn = B - ot;
        for (let Bt = 0; Bt < Ut; Bt++) f.lineTo(it + y((Bt + 1) * Yt / Ut), ot + y(Bt * tn / (Ut - 1))), Bt != Ut - 1 && f.lineTo(it + y((Bt + 1) * Yt / Ut), ot + y((Bt + 1) * tn / (Ut - 1)));
        f.lineTo(H, Y);
      } else f.moveTo(it, ot), f.lineTo(Q, B), f.lineTo(H, Y);
      f.clip(), f.transform(at[0], at[2], at[1], at[3], Q, B), f.translate(E[0] - mt, E[3] - et);
      let Pt;
      if (M) Pt = M.canvas, f.scale(C, -C);
      else {
        const Ut = h[0], Yt = Ut.extent;
        Pt = Ut.image, f.scale(pt(Yt) / Pt.width, -Wt(Yt) / Pt.height);
      }
      f.drawImage(Pt, 0, 0), f.restore();
    }), M && (Yo(M), Ri.push(M.canvas)), u && (f.save(), f.globalCompositeOperation = "source-over", f.strokeStyle = "black", f.lineWidth = 1, a.getTriangles().forEach(function(R, I, O) {
...
`;
  class ay {
    ...
    drawImage(t, e, s, i, r, o, a, h, l, u, c, d, p) {
      ...
      y = $0(y, h, l, 0), y = Dd(y, u, c, 1), f.uniformMatrix4fv(this.matrixLocation, !1, y);
      let E = H0(i / e, r / s, 0);
  ...
  function Sl(n, t, e) {
    const s = n.createProgram(), i = Xd(n, n.VERTEX_SHADER, e), r = Xd(n, n.FRAGMENT_SHADER, t);
...
`;
  ...
  function gy(n, t, e, s, i, r, o, a, h, l, u, c, d, p) {
    ...
    const I = 1 / i;
    {
      ...
      n.bindFramebuffer(n.FRAMEBUFFER, X), n.framebufferTexture2D(n.FRAMEBUFFER, n.COLOR_ATTACHMENT0, n.TEXTURE_2D, C, 0);
      const Q = new ay(n);
      h.forEach(function(B, it, ot) {
        const H = (B.extent[0] - w[0]) * I * k, Y = -(B.extent[3] - w[3]) * I * k, mt = pt(B.extent) * I * k, et = Wt(B.extent) * I * k;
        if (n.bindFramebuffer(n.FRAMEBUFFER, X), n.viewport(0, 0, J, V), B.clipExtent) {
        ...
        Q.drawImage(B.texture, B.width, B.height, l, l, B.width - 2 * l, B.height - 2 * l, d ? H : Math.round(H), d ? Y : Math.round(Y), d ? mt : Math.round(H + mt) - Math.round(H), d ? et : Math.round(Y + et) - Math.round(Y), J, V), n.disable(n.SCISSOR_TEST);
      }), n.deleteFramebuffer(X);
    }
    const O = on(o), A = on(w), P = (F) => {
      const z = (F[0][0] - O[0]) / r * s, k = -(F[0][1] - O[1]) / r * s, J = (F[1][0] - O[0]) / r * s, V = -(F[1][1] - O[1]) / r * s, X = (F[2][0] - O[0]) / r * s, Q = -(F[2][1] - O[1]) / r * s;
      return { u1: J, v1: V, u0: z, v0: k, u2: X, v2: Q };
    };
    n.bindFramebuffer(n.FRAMEBUFFER, E), n.viewport(0, 0, f, y);
    {
      ...
      n.bindTexture(n.TEXTURE_2D, C), n.uniform1i(J, 0), a.getTriangles().forEach(function(H, Y, mt) {
        const et = H.source, b = H.target, { u1: at, v1: Pt, u0: Ut, v0: Yt, u2: tn, v2: Bt } = P(b), pn = (et[0][0] - A[0]) / i / v, ls = -(et[0][1] - A[1]) / i / R, mn = (et[1][0] - A[0]) / i / v, Nn = -(et[1][1] - A[1]) / i / R, en = (et[2][0] - A[0]) / i / v, de = -(et[2][1] - A[1]) / i / R;
        F.push(at, Pt, Ut, Yt, tn, Bt), z.push(mn, Nn, pn, ls, en, de);
      });
      const V = yl(0, f, y, 0, -1, 1), X = n.getUniformLocation(k, "u_matrix");
      n.uniformMatrix4fv(X, !1, V);
    ...
    if (c) {
      ...
      n.uniform4fv(V, J);
      const X = n.getAttribLocation(F, "a_position"), Q = n.createBuffer();
      n.bindBuffer(n.ARRAY_BUFFER, Q), n.vertexAttribPointer(X, 2, n.FLOAT, !1, 0, 0), n.enableVertexAttribArray(X);
      const B = a.getTriangles().reduce(function(it, ot) {
        const H = ot.target, { u1: Y, v1: mt, u0: et, v0: b, u2: at, v2: Pt } = P(H);
        return it.concat([Y, mt, et, b, et, b, at, Pt, at, Pt, Y, mt]);
      }, []);
  ...
  class py extends El {
    constructor(t) {
      ...
      if (a && (e.canWrapX() ? (p[1] = kt(p[1], a[1], a[3]), p[3] = kt(p[3], a[1], a[3])) : p = Fe(p, a)), !bs(p)) this.state = Z.EMPTY;
      else {
        let f = 0, y = 0;
    ...
    reproject_() {
      ...
      if (this.sourceTiles_.forEach((v) => {
        ...
        const z = [O[0] + 2 * A, O[1] + 2 * A], k = P instanceof Float32Array, J = z[0] * z[1], V = k ? Float32Array : Uint8ClampedArray, X = new V(P.buffer), Q = V.BYTES_PER_ELEMENT, B = Q * X.length / J, it = X.byteLength / z[1], ot = Math.floor(it / Q / z[0]), H = this.sourceTileGrid_.getTileCoordExtent(I.tileCoord);
        H[0] += v.offset, H[2] += v.offset;
        const Y = (R = this.clipExtent_) == null ? void 0 : R.slice();
        Y && (Y[0] += v.offset, Y[2] += v.offset), t.push({ extent: H, clipExtent: Y, data: X, dataType: V, bytesPerPixel: B, pixelSize: z, bandCount: ot });
      }), this.sourceTiles_.length = 0, t.length === 0) {
        this.state = Z.ERROR, this.changed();
        return;
      }
      const s = this.wrappedTileCoord_[0], i = this.targetTileGrid_.getTileSize(s), r = typeof i == "number" ? i : i[0], o = typeof i == "number" ? i : i[1], a = r * this.pixelRatio_, h = o * this.pixelRatio_, l = this.targetTileGrid_.getResolution(s), u = this.sourceTileGrid_.getResolution(this.sourceZ_), c = this.targetTileGrid_.getTileCoordExtent(this.wrappedTileCoord_), d = t[0].bandCount, p = new t[0].dataType(d * a * h), f = dy(a, h, Yd, { premultipliedAlpha: !1, antialias: !1 });
      let y;
      const E = f.RGBA;
      let M;
      ...
      for (let v = C - 1; v >= 0; --v) {
        ...
        for (let J = 0, V = z.length; J < V; J += w) {
          const X = (P - 1 - (J / F | 0)) * F + J % F;
          p[k] = z[X], p[k + 1] = z[X + 1], p[k + 2] = z[X + 2], p[k + 3] = z[X + 3], k += d;
        }
      }
      if (fy(f), Yd.push(f.canvas), e) {
        const v = Xt(r, o), R = new ImageData(p, r);
  ...
  class vl extends xl {
    constructor(t, e, s, i, r, o, a, h, l, u, c, d) {
      ...
      if (y && (t.canWrapX() ? (R[1] = kt(R[1], y[1], y[3]), R[3] = kt(R[3], y[1], y[3])) : R = Fe(R, y)), !bs(R)) this.state = Z.EMPTY;
      else {
        let I = 0, O = 0;
    ...
    release() {
      this.canvas_ && (Yo(this.canvas_.getContext("2d")), Ri.push(this.canvas_), this.canvas_ = null), super.release();
    }
  }
  class qd extends xl {
    constructor(t, e, s, i, r, o) {
  ...
  function Vd(n, t) {
    ...
    e.extent && (t = Fe(t, qn(e.extent, n.viewState.projection)));
  ...
  class vy extends Sd {
    ...
    renderFrame(t, e) {
      ...
      this.prepareContainer(t, e);
      const C = this.context.canvas.width, v = this.context.canvas.height, R = i.extent && qn(i.extent);
      R && (M = Fe(M, qn(i.extent)));
      const I = y * C / 2 / w, O = y * v / 2 / w, A = [h[0] - I, h[1] - O, h[0] + I, h[1] + O], P = {};
      this.renderedTiles.length = 0;
      const F = u.getPreload();
      if (t.nextExtent) {
        const H = p.getZForResolution(r.nextResolution, c.zDirection), Y = Vd(t, t.nextExtent);
        this.enqueueTiles(t, Y, H, P, F);
      }
      const z = Vd(t, M);
      ...
      for (const H of P[f]) {
        const Y = H.getState();
        if ((H instanceof vl || H instanceof py) && Y === Z.EMPTY) continue;
        const mt = H.tileCoord;
        if (Y === Z.LOADED && H.getAlpha(k, J) === 1) {
          H.endTransition(k);
          continue;
        }
        if (Y !== Z.IDLE && (s = !1), Y !== Z.ERROR && (this.renderComplete = !1), this.findStaleTile_(mt, P)) {
      ...
      const V = y / a * l / w, X = this.getRenderContext(t);
      Sn(this.tempTransform, C / 2, v / 2, V, V, 0, -C / 2, -v / 2), i.extent && this.clipUnrotated(X, t, R), c.getInterpolate() || (X.imageSmoothingEnabled = !1), this.preRender(X, t);
      const Q = Object.keys(P).map(Number);
      Q.sort(Bn);
      let B;
      const it = [], ot = [];
      for (let H = Q.length - 1; H >= 0; --H) {
        const Y = Q[H], mt = c.getTilePixelSize(Y, l, o), et = p.getResolution(Y) / y, b = mt[0] * et * V, at = mt[1] * et * V, Pt = p.getTileCoordForCoordAndZ(on(A), Y), Ut = p.getTileCoordExtent(Pt), Yt = Vt(this.tempTransform, [w * (Ut[0] - A[0]) / y, w * (A[3] - Ut[3]) / y]), tn = w * c.getGutterForProjection(o);
        for (const Bt of P[Y]) {
          if (Bt.getState() !== Z.LOADED) continue;
          const pn = Bt.tileCoord, ls = Pt[1] - pn[1], mn = Math.round(Yt[0] - (ls - 1) * b), Nn = Pt[2] - pn[2], en = Math.round(Yt[1] - (Nn - 1) * at), de = Math.round(Yt[0] - ls * b), Ye = Math.round(Yt[1] - Nn * at), us = mn - de, cs = en - Ye, _n = Q.length === 1;
          let Fn = !1;
          B = [de, Ye, de + us, Ye, de + us, Ye + cs, de, Ye + cs];
          for (let ds = 0, fs = it.length; ds < fs; ++ds) if (!_n && Y < ot[ds]) {
            const qt = it[ds];
            re([de, Ye, de + us, Ye + cs], [qt[0], qt[3], qt[4], qt[7]]) && (Fn || (X.save(), Fn = !0), X.beginPath(), X.moveTo(B[0], B[1]), X.lineTo(B[2], B[3]), X.lineTo(B[4], B[5]), X.lineTo(B[6], B[7]), X.moveTo(qt[6], qt[7]), X.lineTo(qt[4], qt[5]), X.lineTo(qt[2], qt[3]), X.lineTo(qt[0], qt[1]), X.clip());
          }
          it.push(B), ot.push(Y), this.drawTile(Bt, t, de, Ye, us, cs, tn, _n), Fn && X.restore(), this.renderedTiles.unshift(Bt), this.updateUsedTiles(t.usedTiles, c, Bt);
        }
      }
      if (this.renderedRevision = d, this.renderedResolution = y, this.extentChanged = !this.renderedExtent_ || !si(this.renderedExtent_, A), this.renderedExtent_ = A, this.renderedPixelRatio = l, this.postRender(this.context, t), i.extent && X.restore(), X.imageSmoothingEnabled = !0, this.renderComplete) {
        const H = (Y, mt) => {
  ...
  const Tl = { TILELOADSTART: "tileloadstart", TILELOADEND: "tileloadend", TILELOADERROR: "tileloaderror" }, bi = [0, 0, 0], is = 5;
  class Kd {
    constructor(t) {
      ...
      const s = t.extent;
      s !== void 0 && !this.origin_ && !this.origins_ && (this.origin_ = on(s)), wt(!this.origin_ && this.origins_ || this.origin_ && !this.origins_, "Either `origin` or `origins` must be configured, never both"), this.tileSizes_ = null, t.tileSizes !== void 0 && (this.tileSizes_ = t.tileSizes, wt(this.tileSizes_.length == this.resolutions_.length, "Number of `tileSizes` and `resolutions` must be equal")), this.tileSize_ = t.tileSize !== void 0 ? t.tileSize : this.tileSizes_ ? null : $a, wt(!this.tileSize_ && this.tileSizes_ || this.tileSize_ && !this.tileSizes_, "Either `tileSize` or `tileSizes` must be configured, never both"), this.extent_ = s !== void 0 ? s : null, this.fullTileRanges_ = null, this.tmpSize_ = [0, 0], this.tmpExtent_ = [0, 0, 0, 0], t.sizes !== void 0 ? this.fullTileRanges_ = t.sizes.map((i, r) => {
    ...
    forEachTileCoordParentTileRange(t, e, s, i) {
      ...
      for (this.zoomFactor_ === 2 ? (o = t[1], a = t[2]) : h = this.getTileCoordExtent(t, i); l >= this.minZoom; ) {
        if (o !== void 0 && a !== void 0 ? (o = Math.floor(o / 2), a = Math.floor(a / 2), r = Ci(o, o, a, a, s)) : r = this.getTileRangeForExtentAndZ(h, l, s), e(l, r)) return !0;
        --l;
      }
      return !1;
    }
    ...
    getTileRangeForExtentAndZ(t, e, s) {
      this.getTileCoordForXYAndZ_(t[0], t[3], e, !1, bi);
      const i = bi[1], r = bi[2];
      this.getTileCoordForXYAndZ_(t[2], t[1], e, !0, bi);
      const o = bi[1], a = bi[2];
      return Ci(i, o, r, a, s);
    }
    ...
    getTileCoordForXYAndResolution_(t, e, s, i, r) {
      ...
      return i ? (u = mo(u, is) - 1, c = mo(c, is) - 1) : (u = po(u, is), c = po(c, is)), ua(o, u, c, r);
    }
    getTileCoordForXYAndZ_(t, e, s, i, r) {
      ...
      return i ? (l = mo(l, is) - 1, u = mo(u, is) - 1) : (l = po(l, is), u = po(u, is)), ua(s, l, u, r);
    }
  ...
  function by(n, t, e) {
    const s = t[0], i = n.getTileCoordCenter(t), r = $d(e);
    if (!Rs(r, i)) {
  ...
  function Ty(n, t, e, s) {
    ...
    const i = Iy(n, t, e);
    return new Kd({ extent: n, origin: ku(n, s), resolutions: i, tileSize: e });
  }
  function Iy(n, t, e, s) {
    t = t !== void 0 ? t : Bg, e = ve(e !== void 0 ? e : $a);
    const i = Wt(n), r = pt(n);
...
`);
  ...
  function Pl(n, t, e) {
    ...
    if (s && i && !hr(s, i)) {
      ...
      o.getUnits() === "tile-pixels" ? r.transform(o, a) : r.applyTransform(oi(o, a));
    }
  ...
  const Xy = "http://www.w3.org/2001/XMLSchema-instance";
  function Nt(n, t) {
  ...
  function Ft(n, t, e, s, i) {
    return s.push(n), Ii(t, e, s, i), s.pop();
  }
  ...
  class tt extends Ky {
    ...
    readFeatureElementInternal(t, e, s) {
      ...
      const a = t.getAttribute("fid") || Yy(t, this.namespace, "id");
    ...
    pointMemberParser(t, e) {
      Ii(this.POINTMEMBER_PARSERS, t, e, this);
    }
    lineStringMemberParser(t, e) {
      Ii(this.LINESTRINGMEMBER_PARSERS, t, e, this);
    }
    polygonMemberParser(t, e) {
      Ii(this.POLYGONMEMBER_PARSERS, t, e, this);
    }
    readLineString(t, e) {
      const s = this.readFlatCoordinatesFromNode(t, e);
      if (s) return new Qn(s, "XYZ");
    }
  ...
  const $y = pa + " http://schemas.opengis.net/gml/2.1.2/feature.xsd", Hy = { MultiLineString: "lineStringMember", MultiCurve: "curveMember", MultiPolygon: "polygonMember", MultiSurface: "surfaceMember" };
  class _t extends tt {
    constructor(t) {
      t = t || {}, super(t), this.FEATURE_COLLECTION_PARSERS[pa].featureMember = ut(this.readFeaturesInternal), this.schemaLocation = t.schemaLocation ? t.schemaLocation : $y;
    }
    ...
    writeFeatureElement(t, e, s) {
      ...
      if (e.hasProperties()) {
        ...
        for (const d in c) {
          const p = c[d];
          p != null && (h.push(d), l.push(p), d == a || typeof p.getSimplifiedGeometry == "function" ? d in r.serializers[o] || (r.serializers[o][d] = $(this.writeGeometryElement, this)) : d in r.serializers[o] || (r.serializers[o][d] = $(We)));
        }
      }
      const u = Object.assign({}, r);
      u.node = t, _e(u, r.serializers, Ti(void 0, o), l, s, h);
    }
    ...
    writeMultiPoint(t, e, s) {
      ...
      o && t.setAttribute("srsName", o);
      const a = e.getPoints();
      _e({ node: t, hasZ: r, srsName: o }, this.POINTMEMBER_SERIALIZERS, Ti("pointMember"), a, s, void 0, this);
    }
  ...
  _t.prototype.GEOMETRY_FLAT_COORDINATES_PARSERS = { "http://www.opengis.net/gml": { coordinates: st(_t.prototype.readFlatCoordinates) } }, _t.prototype.FLAT_LINEAR_RINGS_PARSERS = { "http://www.opengis.net/gml": { innerBoundaryIs: _t.prototype.innerBoundaryIsParser, outerBoundaryIs: _t.prototype.outerBoundaryIsParser } }, _t.prototype.BOX_PARSERS_ = { "http://www.opengis.net/gml": { coordinates: ut(_t.prototype.readFlatCoordinates) } }, _t.prototype.GEOMETRY_PARSERS = { "http://www.opengis.net/gml": { Point: st(tt.prototype.readPoint), MultiPoint: st(tt.prototype.readMultiPoint), LineString: st(tt.prototype.readLineString), MultiLineString: st(tt.prototype.readMultiLineString), LinearRing: st(tt.prototype.readLinearRing), Polygon: st(tt.prototype.readPolygon), MultiPolygon: st(tt.prototype.readMultiPolygon), Box: st(_t.prototype.readBox) } }, _t.prototype.GEOMETRY_SERIALIZERS = { "http://www.opengis.net/gml": { Curve: $(_t.prototype.writeCurveOrLineString), MultiCurve: $(_t.prototype.writeMultiCurveOrLineString), Point: $(_t.prototype.writePoint), MultiPoint: $(_t.prototype.writeMultiPoint), LineString: $(_t.prototype.writeCurveOrLineString), MultiLineString: $(_t.prototype.writeMultiCurveOrLineString), LinearRing: $(_t.prototype.writeLinearRing), Polygon: $(_t.prototype.writeSurfaceOrPolygon), MultiPolygon: $(_t.prototype.writeMultiSurfaceOrPolygon), Surface: $(_t.prototype.writeSurfaceOrPolygon), MultiSurface: $(_t.prototype.writeMultiSurfaceOrPolygon), Envelope: $(_t.prototype.writeEnvelope) } }, _t.prototype.LINESTRINGORCURVEMEMBER_SERIALIZERS = { "http://www.opengis.net/gml": { lineStringMember: $(_t.prototype.writeLineStringOrCurveMember), curveMember: $(_t.prototype.writeLineStringOrCurveMember) } }, _t.prototype.RING_SERIALIZERS = { "http://www.opengis.net/gml": { outerBoundaryIs: $(_t.prototype.writeRing), innerBoundaryIs: $(_t.prototype.writeRing) } }, _t.prototype.POINTMEMBER_SERIALIZERS = { "http://www.opengis.net/gml": { pointMember: $(_t.prototype.writePointMember) } }, _t.prototype.SURFACEORPOLYGONMEMBER_SERIALIZERS = { "http://www.opengis.net/gml": { surfaceMember: $(_t.prototype.writeSurfaceOrPolygonMember), polygonMember: $(_t.prototype.writeSurfaceOrPolygonMember) } }, _t.prototype.ENVELOPE_SERIALIZERS = { "http://www.opengis.net/gml": { lowerCorner: $(We), upperCorner: $(We) } };
  ...
  class G extends tt {
    ...
    curveMemberParser(t, e) {
      Ii(this.CURVEMEMBER_PARSERS, t, e, this);
    }
    surfaceMemberParser(t, e) {
      Ii(this.SURFACEMEMBER_PARSERS, t, e, this);
    }
    readPatch(t, e) {
    ...
    writeMultiPoint(t, e, s) {
      ...
      const a = e.getPoints();
      _e({ node: t, hasZ: o, srsName: r }, this.POINTMEMBER_SERIALIZERS, Ti("pointMember"), a, s, void 0, this);
    }
    writeMultiCurveOrLineString(t, e, s) {
      const i = s[s.length - 1], r = i.hasZ, o = i.srsName, a = i.curve;
      o && t.setAttribute("srsName", o);
    ...
    writeFeatureMembers_(t, e, s) {
      ...
      a[o] = {}, a[o][r] = $(this.writeFeatureElement, this);
      const h = Object.assign({}, i);
      h.node = t, _e(h, a, Ti(r, o), e, s);
    }
    MULTIGEOMETRY_MEMBER_NODE_FACTORY_(t, e, s) {
      const i = e[e.length - 1].node;
    ...
    writeFeaturesNode(t, e) {
      ...
      s.setAttributeNS(Xy, "xsi:schemaLocation", this.schemaLocation);
  ...
  var Gs = 1, zs = 2, Ai = 3, n1 = 4, Fl = 5, sf = 6378137, s1 = 6356752314e-3, rf = 0.0066943799901413165, Dr = 484813681109536e-20, D = Math.PI / 2, i1 = 0.16666666666666666, r1 = 0.04722222222222222, o1 = 0.022156084656084655, q = 1e-10, te = 0.017453292519943295, cn = 57.29577951308232, Ct = Math.PI / 4, Gr = Math.PI * 2, ee = 3.14159265359, Te = {};
  ...
  On.prototype.readCharicter = function() {
  ...
  }, On.prototype.afterquote = function(n) {
    if (n === '"') {
  ...
  }, On.prototype.afterItem = function(n) {
    if (n === ",") {
  ...
  }, On.prototype.number = function(n) {
    if (uf.test(n)) {
      this.word += n;
      return;
    }
  ...
  }, On.prototype.quoted = function(n) {
    if (n === '"') {
      this.state = lf;
      return;
    }
    this.word += n;
  }, On.prototype.keyword = function(n) {
    if (u1.test(n)) {
      this.word += n;
      return;
    }
  ...
  }, On.prototype.neutral = function(n) {
    if (l1.test(n)) {
  ...
  function Pi(n, t) {
    ...
    switch (e) {
      ...
      case "PRIMEM":
      case "VERT_DATUM":
        t[e] = { name: n[0].toLowerCase(), convert: n[1] }, n.length === 3 && Pi(n[2], t[e]);
        return;
      case "SPHEROID":
      case "ELLIPSOID":
        t[e] = { name: n[0], a: n[1], rf: n[2] }, n.length === 4 && Pi(n[3], t[e]);
        return;
      case "EDATUM":
      ...
      case "ENGINEERINGCRS":
        ...
        return;
      default:
        for (s = -1; ++s < n.length; ) if (!Array.isArray(n[s])) return Pi(n, t[e]);
        return Gl(t, e, n);
    }
  }
  ...
  function p1(n) {
    ...
    var h = function(u) {
      return g1(n, u);
    }, l = [["standard_parallel_1", "Standard_Parallel_1"], ["standard_parallel_1", "Latitude of 1st standard parallel"], ["standard_parallel_2", "Standard_Parallel_2"], ["standard_parallel_2", "Latitude of 2nd standard parallel"], ["false_easting", "False_Easting"], ["false_easting", "False easting"], ["false-easting", "Easting at false origin"], ["false_northing", "False_Northing"], ["false_northing", "False northing"], ["false_northing", "Northing at false origin"], ["central_meridian", "Central_Meridian"], ["central_meridian", "Longitude of natural origin"], ["central_meridian", "Longitude of false origin"], ["latitude_of_origin", "Latitude_Of_Origin"], ["latitude_of_origin", "Central_Parallel"], ["latitude_of_origin", "Latitude of natural origin"], ["latitude_of_origin", "Latitude of false origin"], ["scale_factor", "Scale_Factor"], ["k0", "scale_factor"], ["latitude_of_center", "Latitude_Of_Center"], ["latitude_of_center", "Latitude_of_center"], ["lat0", "latitude_of_center", dn], ["longitude_of_center", "Longitude_Of_Center"], ["longitude_of_center", "Longitude_of_center"], ["longc", "longitude_of_center", dn], ["x0", "false_easting", a], ["y0", "false_northing", a], ["long0", "central_meridian", dn], ["lat0", "latitude_of_origin", dn], ["lat0", "standard_parallel_1", dn], ["lat1", "standard_parallel_1", dn], ["lat2", "standard_parallel_2", dn], ["azimuth", "Azimuth"], ["alpha", "azimuth", dn], ["srsCode", "name"]];
    l.forEach(h), !n.long0 && n.longc && (n.projName === "Albers_Conic_Equal_Area" || n.projName === "Lambert_Azimuthal_Equal_Area") && (n.long0 = n.longc), !n.lat_ts && n.lat1 && (n.projName === "Stereographic_South_Pole" || n.projName === "Polar Stereographic (variant B)") ? (n.lat0 = dn(n.lat1 > 0 ? 90 : -90), n.lat_ts = n.lat1) : !n.lat_ts && n.lat0 && n.projName === "Polar_Stereographic" && (n.lat_ts = n.lat0, n.lat0 = dn(n.lat0 > 0 ? 90 : -90));
  }
  function df(n) {
    var t = c1(n), e = t[0], s = {};
    return Pi(t, s), cf(s), s[e];
  }
  function ye(n) {
    var t = this;
  ...
  function w1(n) {
    var t = rs(n, "extension");
    if (t) return rs(t, "proj4");
  }
  function S1(n) {
    return n[0] === "+";
  }
  ...
  function R1() {
    var n = this.b / this.a;
    this.es = 1 - n * n, "x0" in this || (this.x0 = 0), "y0" in this || (this.y0 = 0), this.e = Math.sqrt(this.es), this.lat_ts ? this.sphere ? this.k0 = Math.cos(this.lat_ts) : this.k0 = fn(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)) : this.k0 || (this.k ? this.k0 = this.k : this.k0 = 1);
  }
  function C1(n) {
    var t = n.x, e = n.y;
    if (e * cn > 90 && e * cn < -90 && t * cn > 180 && t * cn < -180) return null;
    var s, i;
    if (Math.abs(Math.abs(e) - D) <= q) return null;
    if (this.sphere) s = this.x0 + this.a * this.k0 * K(t - this.long0), i = this.y0 + this.a * this.k0 * Math.log(Math.tan(Ct + 0.5 * e));
    else {
      var r = Math.sin(e), o = Qe(this.e, e, r);
      s = this.x0 + this.a * this.k0 * K(t - this.long0), i = this.y0 - this.a * this.k0 * Math.log(o);
    }
  ...
  function b1(n) {
    ...
    return s = K(this.long0 + t / (this.a * this.k0)), n.x = s, n.y = i, n;
  }
  ...
  function U1(n, t, e, s, i, r, o) {
    var a = {};
    return n === void 0 || n === "none" ? a.datum_type = Fl : a.datum_type = n1, t && (a.datum_params = t.map(parseFloat), (a.datum_params[0] !== 0 || a.datum_params[1] !== 0 || a.datum_params[2] !== 0) && (a.datum_type = Gs), a.datum_params.length > 3 && (a.datum_params[3] !== 0 || a.datum_params[4] !== 0 || a.datum_params[5] !== 0 || a.datum_params[6] !== 0) && (a.datum_type = zs, a.datum_params[3] *= Dr, a.datum_params[4] *= Dr, a.datum_params[5] *= Dr, a.datum_params[6] = a.datum_params[6] / 1e6 + 1)), o && (a.datum_type = Ai, a.grids = o), a.a = e, a.b = s, a.es = i, a.ep2 = r, a;
  }
  var _f = {};
  function B1(n, t) {
    var e = new DataView(t), s = X1(e), i = Y1(e, s), r = q1(e, i, s), o = { header: i, subgrids: r };
    return _f[n] = o, o;
  }
  function j1(n) {
  ...
  function q1(n, t, e) {
    for (var s = 176, i = [], r = 0; r < t.nSubgrids; r++) {
      var o = K1(n, s, e), a = Z1(n, s, o, e), h = Math.round(1 + (o.upperLongitude - o.lowerLongitude) / o.longitudeInterval), l = Math.round(1 + (o.upperLatitude - o.lowerLatitude) / o.latitudeInterval);
      i.push({ ll: [Li(o.lowerLongitude), Li(o.lowerLatitude)], del: [Li(o.longitudeInterval), Li(o.latitudeInterval)], lim: [h, l], count: o.gridNodeCount, cvs: V1(a) }), s += 176 + o.gridNodeCount * 16;
    }
    return i;
  }
  function V1(n) {
    return n.map(function(t) {
      return [Li(t.longitudeShift), Li(t.latitudeShift)];
    });
  }
  function K1(n, t, e) {
  ...
  gn.projections = F1, gn.projections.start();
  function $1(n, t) {
    return n.datum_type !== t.datum_type || n.a !== t.a || Math.abs(n.es - t.es) > 5e-11 ? !1 : n.datum_type === Gs ? n.datum_params[0] === t.datum_params[0] && n.datum_params[1] === t.datum_params[1] && n.datum_params[2] === t.datum_params[2] : n.datum_type === zs ? n.datum_params[0] === t.datum_params[0] && n.datum_params[1] === t.datum_params[1] && n.datum_params[2] === t.datum_params[2] && n.datum_params[3] === t.datum_params[3] && n.datum_params[4] === t.datum_params[4] && n.datum_params[5] === t.datum_params[5] && n.datum_params[6] === t.datum_params[6] : !0;
  }
  function yf(n, t, e) {
  ...
  function H1(n, t, e) {
    if (t === Gs) return { x: n.x + e[0], y: n.y + e[1], z: n.z + e[2] };
    if (t === zs) {
  ...
  function Q1(n, t, e) {
    if ($1(n, t) || n.datum_type === Fl || t.datum_type === Fl) return e;
    var s = n.a, i = n.es;
    if (n.datum_type === Ai) {
      var r = Ef(n, !1, e);
      if (r !== 0) return;
    ...
    if (t.datum_type === Ai && (o = sf, a = s1, h = rf), i === h && s === o && !wa(n.datum_type) && !wa(t.datum_type)) return e;
    if (e = yf(e, i, s), wa(n.datum_type) && (e = H1(e, n.datum_type, n.datum_params)), wa(t.datum_type) && (e = J1(e, t.datum_type, t.datum_params)), e = xf(e, h, o, a), t.datum_type === Ai) {
      var l = Ef(t, !0, e);
      if (l !== 0) return;
    }
    return e;
  ...
  function Ef(n, t, e) {
    ...
    return isNaN(i.x) ? (console.log("Failed to find a grid shift table for location '" + -s.x * cn + " " + s.y * cn + " tried: '" + r + "'"), -1) : (e.x = -i.x, e.y = i.y, 0);
  }
  function tx(n, t, e) {
    var s = { x: Number.NaN, y: Number.NaN };
    if (isNaN(n.x)) return s;
    var i = { x: n.x, y: n.y };
    i.x -= e.ll[0], i.y -= e.ll[1], i.x = K(i.x - Math.PI) + Math.PI;
    var r = Mf(i, e);
    if (t) {
      ...
      s.x = K(r.x + e.ll[0]), s.y = r.y + e.ll[1];
  ...
  function nx(n, t) {
    return (n.datum.datum_type === Gs || n.datum.datum_type === zs || n.datum.datum_type === Ai) && t.datumCode !== "WGS84" || (t.datum.datum_type === Gs || t.datum.datum_type === zs || t.datum.datum_type === Ai) && n.datumCode !== "WGS84";
  }
  function Sa(n, t, e, s) {
    var i;
    Array.isArray(e) ? e = Sf(e) : e = { x: e.x, y: e.y, z: e.z, m: e.m };
    var r = e.z !== void 0;
    if (ex(e), n.datum && t.datum && nx(n, t) && (i = new gn("WGS84"), e = Sa(n, i, e, s), n = i), s && n.axis !== "enu" && (e = wf(n, !1, e)), n.projName === "longlat") e = { x: e.x * te, y: e.y * te, z: e.z || 0 };
    else if (n.to_meter && (e = { x: e.x * n.to_meter, y: e.y * n.to_meter, z: e.z || 0 }), e = n.inverse(e), !e) return;
    if (n.from_greenwich && (e.x += n.from_greenwich), e = Q1(n.datum, t.datum, e), !!e) return t.from_greenwich && (e = { x: e.x - t.from_greenwich, y: e.y, z: e.z || 0 }), t.projName === "longlat" ? e = { x: e.x * cn, y: e.y * cn, z: e.z || 0 } : (e = t.forward(e), t.to_meter && (e = { x: e.x / t.to_meter, y: e.y / t.to_meter, z: e.z || 0 })), s && t.axis !== "enu" ? wf(t, !0, e) : (e && !r && delete e.z, e);
  }
  var Rf = gn("WGS84");
  function Ul(n, t, e, s) {
    var i, r, o;
  ...
  function Cf(n) {
    return n instanceof gn ? n : n.oProj ? n.oProj : gn(n);
  }
  function le(n, t, e) {
    n = Cf(n);
    var s = !1, i;
  ...
  var bf = 6, Tf = "AJSAJS", If = "AFAFAF", Oi = 65, Ie = 73, Xe = 79, jr = 86, Wr = 90;
  ...
  function lx(n, t, e) {
    ...
    o > Wr && (o = o - Wr + Oi - 1, h = !0), (o === Ie || i < Ie && o > Ie || (o > Ie || i < Ie) && h) && o++, (o === Xe || i < Xe && o > Xe || (o > Xe || i < Xe) && h) && (o++, o === Ie && o++), o > Wr && (o = o - Wr + Oi - 1), a > jr ? (a = a - jr + Oi - 1, h = !0) : h = !1, (a === Ie || r < Ie && a > Ie || (a > Ie || r < Ie) && h) && a++, (a === Xe || r < Xe && a > Xe || (a > Xe || r < Xe) && h) && (a++, a === Ie && a++), a > jr && (a = a - jr + Oi - 1);
...
northing meters` + n;
  ...
  function Ni(n, t, e) {
    if (!(this instanceof Ni)) return new Ni(n, t, e);
  ...
  Ni.fromMGRS = function(n) {
    return new Ni(Pf(n));
  }, Ni.prototype.toMGRS = function(n) {
  ...
  function Xl(n, t, e) {
    for (var s = 1 / (1 - t), i = n, r = wx; r; --r) {
      ...
      if (a = (Fi(i, o, Math.cos(i), e) - n) * (a * Math.sqrt(a)) * s, i -= a, Math.abs(a) < q) return i;
    }
    return i;
  }
  function Sx() {
    this.x0 = this.x0 !== void 0 ? this.x0 : 0, this.y0 = this.y0 !== void 0 ? this.y0 : 0, this.long0 = this.long0 !== void 0 ? this.long0 : 0, this.lat0 = this.lat0 !== void 0 ? this.lat0 : 0, this.es && (this.en = Wl(this.es), this.ml0 = Fi(this.lat0, Math.sin(this.lat0), Math.cos(this.lat0), this.en));
  }
  function vx(n) {
    var t = n.x, e = n.y, s = K(t - this.long0), i, r, o, a = Math.sin(e), h = Math.cos(e);
    if (this.es) {
  ...
  function Rx(n) {
    ...
    if (this.es) if (t = this.ml0 + o / this.k0, e = Xl(t, this.es, this.en), Math.abs(e) < D) {
      ...
      t = t * l, s = e - t * y / (1 - this.es) * 0.5 * (1 - y / 12 * (5 + 3 * d - 9 * u * d + u - 4 * c - y / 30 * (61 + 90 * d - 252 * u * d + 45 * p + 46 * u - y / 56 * (1385 + 3633 * d + 4095 * p + 1574 * p * d)))), i = K(this.long0 + f * (1 - y / 6 * (1 + 2 * d + u - y / 20 * (5 + 28 * d + 24 * p + 8 * u * d + 6 * u - y / 42 * (61 + 662 * d + 1320 * p + 720 * p * d)))) / h);
    } else s = D * Ur(o), i = 0;
    else {
      var E = Math.exp(r / this.k0), M = 0.5 * (E - 1 / E), w = this.lat0 + o / this.k0, C = Math.cos(w);
      t = Math.sqrt((1 - Math.pow(C, 2)) / (1 + Math.pow(M, 2))), s = Math.asin(t), o < 0 && (s = -s), M === 0 && C === 0 ? i = 0 : i = K(Math.atan2(M, C) + this.long0);
    }
  ...
  function Px() {
    ...
    var s = Yl(this.cbg, this.lat0);
    this.Zb = -this.Qn * (s + Ix(this.gtu, 2 * s));
  }
  function Lx(n) {
    var t = K(n.x - this.long0), e = n.y;
    e = Yl(this.cbg, e);
  ...
  function Ox(n) {
    ...
    if (Math.abs(t) <= 2.623395162778) {
      ...
      e = Math.atan2(o * l, Ae(h, l * a)), t = Math.atan2(h, l * a), s = K(t + this.long0), i = Yl(this.cgb, e);
    } else s = 1 / 0, i = 1 / 0;
    return n.x = s, n.y = i, n;
  }
  ...
  function Fx(n, t) {
    if (n === void 0) {
      if (n = Math.floor((K(t) + Math.PI) * 30 / Math.PI) + 1, n < 0) return 0;
      if (n > 60) return 60;
    }
    return n;
  }
  ...
  var Xx = ["gauss"];
  const Vl = { init: Bx, forward: jx, inverse: Wx, names: Xx };
  function Yx() {
  ...
  function qx(n) {
    var t, e, s, i;
    return n.x = K(n.x - this.long0), Vl.forward.apply(this, [n]), t = Math.sin(n.y), e = Math.cos(n.y), s = Math.cos(n.x), i = this.k0 * this.R2 / (1 + this.sinc0 * t + this.cosc0 * e * s), n.x = i * e * Math.sin(n.x), n.y = i * (this.cosc0 * t - this.sinc0 * e * s), n.x = this.a * n.x + this.x0, n.y = this.a * n.y + this.y0, n;
  }
  function Vx(n) {
    var t, e, s, i, r;
  ...
  function Qx(n) {
    ...
    if (this.sphere) {
      ...
      return t = this.long0, e = this.lat0, o <= q ? (n.x = t, n.y = e, n) : (e = Math.asin(Math.cos(a) * this.sinlat0 + n.y * Math.sin(a) * this.coslat0 / o), Math.abs(this.coslat0) < q ? this.lat0 > 0 ? t = K(this.long0 + Math.atan2(n.x, -1 * n.y)) : t = K(this.long0 + Math.atan2(n.x, n.y)) : t = K(this.long0 + Math.atan2(n.x * Math.sin(a), o * this.coslat0 * Math.cos(a) - n.y * this.sinlat0 * Math.sin(a))), n.x = t, n.y = e, n);
    } else if (Math.abs(this.coslat0) <= q) {
      if (o <= q) return e = this.lat0, t = this.long0, n.x = t, n.y = e, n;
      n.x *= this.con, n.y *= this.con, s = o * this.cons / (2 * this.a * this.k0), e = this.con * Br(this.e, s), t = this.con * K(this.con * this.long0 + Math.atan2(n.x, -1 * n.y));
    } else i = 2 * Math.atan(o * this.cosX0 / (2 * this.a * this.k0 * this.ms1)), t = this.long0, o <= q ? r = this.X0 : (r = Math.asin(Math.cos(i) * this.sinX0 + n.y * Math.sin(i) * this.cosX0 / o), t = K(this.long0 + Math.atan2(n.x * Math.sin(i), o * this.cosX0 * Math.cos(i) - n.y * this.sinX0 * Math.sin(i)))), e = -1 * Br(this.e, Math.tan(0.5 * (D + r)));
    return n.x = t, n.y = e, n;
  }
  var tE = ["stere", "Stereographic_South_Pole", "Polar Stereographic (variant B)", "Polar_Stereographic"];
  const eE = { init: Hx, forward: Jx, inverse: Qx, names: tE, ssfn_: $x };
  function nE() {
    var n = this.lat0;
  ...
  function hE() {
    ...
    else if (p = this.long1, y = this.lat1, f = this.long2, E = this.lat2, Math.abs(y - E) <= ki || (n = Math.abs(y)) <= ki || Math.abs(n - D) <= ki || Math.abs(Math.abs(this.lat0) - D) <= ki || Math.abs(Math.abs(E) - D) <= ki) throw new Error();
    var v = 1 - this.es;
    t = Math.sqrt(v), Math.abs(this.lat0) > q ? (a = Math.sin(this.lat0), e = Math.cos(this.lat0), n = 1 - this.es * a * a, this.B = e * e, this.B = Math.sqrt(1 + this.es * this.B * this.B / v), this.A = this.B * this.k0 * t / n, s = this.B * t / (e * Math.sqrt(n)), i = s * s - 1, i <= 0 ? i = 0 : (i = Math.sqrt(i), this.lat0 < 0 && (i = -i)), this.E = i += s, this.E *= Math.pow(Qe(this.e, this.lat0, a), this.B)) : (this.B = 1 / t, this.A = this.k0, this.E = s = i = 1), w || C ? (w ? (c = Math.asin(Math.sin(M) / s), C || (u = M)) : (c = u, M = Math.asin(s * Math.sin(c))), this.lam0 = d - Math.asin(0.5 * (i - 1 / i) * Math.tan(c)) / this.B) : (r = Math.pow(Qe(this.e, y, Math.sin(y)), this.B), o = Math.pow(Qe(this.e, E, Math.sin(E)), this.B), i = this.E / r, h = (o - r) / (o + r), l = this.E * this.E, l = (l - o * r) / (l + o * r), n = p - f, n < -Math.pi ? f -= Gr : n > Math.pi && (f += Gr), this.lam0 = K(0.5 * (p + f) - Math.atan(l * Math.tan(0.5 * this.B * (p - f)) / h) / this.B), c = Math.atan(2 * Math.sin(this.B * K(p - this.lam0)) / (i - 1 / i)), u = M = Math.asin(s * Math.sin(c))), this.singam = Math.sin(c), this.cosgam = Math.cos(c), this.sinrot = Math.sin(u), this.cosrot = Math.cos(u), this.rB = 1 / this.B, this.ArB = this.A * this.rB, this.BrA = 1 / this.ArB, this.A * this.B, this.no_off ? this.u_0 = 0 : (this.u_0 = Math.abs(this.ArB * Math.atan(Math.sqrt(s * s - 1) / Math.cos(M))), this.lat0 < 0 && (this.u_0 = -this.u_0)), i = 0.5 * c, this.v_pole_n = this.ArB * Math.log(Math.tan(Ct - i)), this.v_pole_s = this.ArB * Math.log(Math.tan(Ct + i));
  }
  function lE(n) {
    var t = {}, e, s, i, r, o, a, h, l;
    if (n.x = n.x - this.lam0, Math.abs(Math.abs(n.y) - D) > q) {
      if (o = this.E / Math.pow(Qe(this.e, n.y, Math.sin(n.y)), this.B), a = 1 / o, e = 0.5 * (o - a), s = 0.5 * (o + a), r = Math.sin(this.B * n.x), i = (e * this.singam - r * this.cosgam) / s, Math.abs(Math.abs(i) - 1) < q) throw new Error();
      l = 0.5 * this.ArB * Math.log((1 - i) / (1 + i)), a = Math.cos(this.B * n.x), Math.abs(a) < ki ? h = this.A * n.x : h = this.ArB * Math.atan2(e * this.cosgam + r * this.singam, a);
  ...
  function fE() {
    if (this.lat2 || (this.lat2 = this.lat1), this.k0 || (this.k0 = 1), this.x0 = this.x0 || 0, this.y0 = this.y0 || 0, !(Math.abs(this.lat1 + this.lat2) < q)) {
      ...
      var t = Math.sin(this.lat1), e = Math.cos(this.lat1), s = fn(this.e, t, e), i = Qe(this.e, this.lat1, t), r = Math.sin(this.lat2), o = Math.cos(this.lat2), a = fn(this.e, r, o), h = Qe(this.e, this.lat2, r), l = Qe(this.e, this.lat0, Math.sin(this.lat0));
  ...
  function gE(n) {
    ...
    if (s > q) i = Qe(this.e, e, Math.sin(e)), r = this.a * this.f0 * Math.pow(i, this.ns);
    else {
      if (s = e * this.ns, s <= 0) return null;
      r = 0;
    }
    var o = this.ns * K(t - this.long0);
  ...
  function pE(n) {
    ...
    return r = K(h / this.ns + this.long0), n.x = r, n.y = i, n;
  }
  ...
  function xE(n) {
    var t, e, s, i, r, o, a, h = n.x, l = n.y, u = K(h - this.long0);
  ...
  function SE() {
    this.sphere || (this.e0 = Xr(this.es), this.e1 = Yr(this.es), this.e2 = qr(this.es), this.e3 = Vr(this.es), this.ml0 = this.a * xe(this.e0, this.e1, this.e2, this.e3, this.lat0));
  }
  function vE(n) {
    var t, e, s = n.x, i = n.y;
    if (s = K(s - this.long0), this.sphere) t = this.a * Math.asin(Math.cos(i) * Math.sin(s)), e = this.a * (Math.atan2(Math.tan(i), Math.cos(s)) - this.lat0);
    else {
      var r = Math.sin(i), o = Math.cos(i), a = Di(this.a, this.e, r), h = Math.tan(i) * Math.tan(i), l = s * Math.cos(i), u = l * l, c = this.es * o * o / (1 - this.es), d = this.a * xe(this.e0, this.e1, this.e2, this.e3, i);
  ...
  function RE(n) {
    ...
    if (this.sphere) {
      ...
      var h = Di(this.a, this.e, Math.sin(a)), l = h * h * h / this.a / this.a * (1 - this.es), u = Math.pow(Math.tan(a), 2), c = t * this.a / h, d = c * c;
      s = a - h * Math.tan(a) / l * c * c * (0.5 - (1 + 3 * u) * c * c / 24), i = c * (1 - d * (u / 3 + (1 + 3 * u) * u * d / 15)) / Math.cos(a);
    }
    return n.x = K(i + this.long0), n.y = os(s), n;
  }
  ...
  function OE(n) {
    ...
    if (c = K(c - this.long0), this.sphere) {
      ...
      switch (a = 0, h = 0, l = 0, s = Math.cos(c), i = Math.sin(c), r = Math.sin(d), o = as(this.e, r), (this.mode === this.OBLIQ || this.mode === this.EQUIT) && (a = o / this.qp, h = Math.sqrt(1 - a * a)), this.mode) {
        case this.OBLIQ:
  ...
  function NE(n) {
    ...
    return n.x = K(this.long0 + s), n.y = i, n;
  }
  ...
  const XE = { init: LE, forward: OE, inverse: NE, names: WE, S_POLE: TE, N_POLE: IE, EQUIT: AE, OBLIQ: PE };
  function hs(n) {
    return Math.abs(n) > 1 && (n = n > 1 ? 1 : -1), Math.asin(n);
  }
  function YE() {
    Math.abs(this.lat1 + this.lat2) < q || (this.temp = this.b / this.a, this.es = 1 - Math.pow(this.temp, 2), this.e3 = Math.sqrt(this.es), this.sin_po = Math.sin(this.lat1), this.cos_po = Math.cos(this.lat1), this.t1 = this.sin_po, this.con = this.sin_po, this.ms1 = fn(this.e3, this.sin_po, this.cos_po), this.qs1 = as(this.e3, this.sin_po), this.sin_po = Math.sin(this.lat2), this.cos_po = Math.cos(this.lat2), this.t2 = this.sin_po, this.ms2 = fn(this.e3, this.sin_po, this.cos_po), this.qs2 = as(this.e3, this.sin_po), this.sin_po = Math.sin(this.lat0), this.cos_po = Math.cos(this.lat0), this.t3 = this.sin_po, this.qs0 = as(this.e3, this.sin_po), Math.abs(this.lat1 - this.lat2) > q ? this.ns0 = (this.ms1 * this.ms1 - this.ms2 * this.ms2) / (this.qs2 - this.qs1) : this.ns0 = this.con, this.c = this.ms1 * this.ms1 + this.ns0 * this.qs1, this.rh = this.a * Math.sqrt(this.c - this.ns0 * this.qs0) / this.ns0);
  }
  function qE(n) {
    var t = n.x, e = n.y;
    this.sin_phi = Math.sin(e), this.cos_phi = Math.cos(e);
    var s = as(this.e3, this.sin_phi), i = this.a * Math.sqrt(this.c - this.ns0 * s) / this.ns0, r = this.ns0 * K(t - this.long0), o = i * Math.sin(r) + this.x0, a = this.rh - i * Math.cos(r) + this.y0;
    return n.x = o, n.y = a, n;
  }
  function VE(n) {
    var t, e, s, i, r, o;
    return n.x -= this.x0, n.y = this.rh - n.y + this.y0, this.ns0 >= 0 ? (t = Math.sqrt(n.x * n.x + n.y * n.y), s = 1) : (t = -Math.sqrt(n.x * n.x + n.y * n.y), s = -1), i = 0, t !== 0 && (i = Math.atan2(s * n.x, s * n.y)), s = t * this.ns0 / this.a, this.sphere ? o = Math.asin((this.c - s * s) / (2 * this.ns0)) : (e = (this.c - s * s) / this.ns0, o = this.phi1z(this.e3, e)), r = K(i / this.ns0 + this.long0), n.x = r, n.y = o, n;
  }
  function KE(n, t) {
    var e, s, i, r, o, a = hs(0.5 * t);
    if (n < q) return a;
  ...
  const $E = { init: YE, forward: qE, inverse: VE, names: ZE, phi1z: KE };
  function HE() {
    this.sin_p14 = Math.sin(this.lat0), this.cos_p14 = Math.cos(this.lat0), this.infinity_dist = 1e3 * this.a, this.rc = 1;
  }
  function JE(n) {
    var t, e, s, i, r, o, a, h, l = n.x, u = n.y;
    return s = K(l - this.long0), t = Math.sin(u), e = Math.cos(u), i = Math.cos(s), o = this.sin_p14 * t + this.cos_p14 * e * i, r = 1, o > 0 || Math.abs(o) <= q ? (a = this.x0 + this.a * r * e * Math.sin(s) / o, h = this.y0 + this.a * r * (this.cos_p14 * t - this.sin_p14 * e * i) / o) : (a = this.x0 + this.infinity_dist * e * Math.sin(s), h = this.y0 + this.infinity_dist * (this.cos_p14 * t - this.sin_p14 * e * i)), n.x = a, n.y = h, n;
  }
  function QE(n) {
    var t, e, s, i, r, o;
    return n.x = (n.x - this.x0) / this.a, n.y = (n.y - this.y0) / this.a, n.x /= this.k0, n.y /= this.k0, (t = Math.sqrt(n.x * n.x + n.y * n.y)) ? (i = Math.atan2(t, this.rc), e = Math.sin(i), s = Math.cos(i), o = hs(s * this.sin_p14 + n.y * e * this.cos_p14 / t), r = Math.atan2(n.x * e, t * this.cos_p14 * s - n.y * this.sin_p14 * e), r = K(this.long0 + r)) : (o = this.phic0, r = 0), n.x = r, n.y = o, n;
  }
  var tM = ["gnom"];
  ...
  function sM() {
    this.sphere || (this.k0 = fn(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)));
  }
  function iM(n) {
    var t = n.x, e = n.y, s, i, r = K(t - this.long0);
  ...
  function rM(n) {
    n.x -= this.x0, n.y -= this.y0;
    var t, e;
    return this.sphere ? (t = K(this.long0 + n.x / this.a / Math.cos(this.lat_ts)), e = Math.asin(n.y / this.a * Math.cos(this.lat_ts))) : (e = nM(this.e, 2 * n.y * this.k0 / this.a), t = K(this.long0 + n.x / (this.a * this.k0))), n.x = t, n.y = e, n;
  }
  var oM = ["cea"];
  ...
  function lM(n) {
    var t = n.x, e = n.y, s = K(t - this.long0), i = os(e - this.lat0);
    return n.x = this.x0 + this.a * s * this.rc, n.y = this.y0 + this.a * i, n;
  }
  function uM(n) {
    var t = n.x, e = n.y;
    return n.x = K(this.long0 + (t - this.x0) / (this.a * this.rc)), n.y = os(this.lat0 + (e - this.y0) / this.a), n;
  }
  var cM = ["Equirectangular", "Equidistant_Cylindrical", "eqc"];
  const dM = { init: hM, forward: lM, inverse: uM, names: cM };
  var Uf = 20;
  function fM() {
    this.temp = this.b / this.a, this.es = 1 - Math.pow(this.temp, 2), this.e = Math.sqrt(this.es), this.e0 = Xr(this.es), this.e1 = Yr(this.es), this.e2 = qr(this.es), this.e3 = Vr(this.es), this.ml0 = this.a * xe(this.e0, this.e1, this.e2, this.e3, this.lat0);
  }
  function gM(n) {
    var t = n.x, e = n.y, s, i, r, o = K(t - this.long0);
    if (r = o * Math.sin(e), this.sphere) Math.abs(e) <= q ? (s = this.a * o, i = -1 * this.a * this.lat0) : (s = this.a * Math.sin(r) / Math.tan(e), i = this.a * (os(e - this.lat0) + (1 - Math.cos(r)) / Math.tan(e)));
    else if (Math.abs(e) <= q) s = this.a * o, i = -1 * this.ml0;
    else {
      var a = Di(this.a, this.e, Math.sin(e)) / Math.tan(e);
  ...
  function pM(n) {
    var t, e, s, i, r, o, a, h, l;
    if (s = n.x - this.x0, i = n.y - this.y0, this.sphere) if (Math.abs(i + this.a * this.lat0) <= q) t = K(s / this.a + this.long0), e = 0;
    else {
      ...
      t = K(this.long0 + Math.asin(s * Math.tan(h) / this.a) / Math.sin(e));
    }
    else if (Math.abs(i + this.ml0) <= q) e = 0, t = K(this.long0 + s / this.a);
    else {
      ...
      c = Math.sqrt(1 - this.es * Math.pow(Math.sin(e), 2)) * Math.tan(e), t = K(this.long0 + Math.asin(s * c / this.a) / Math.sin(e));
    }
    return n.x = t, n.y = e, n;
  }
  ...
  function vM(n) {
    var t = n.x, e = n.y, s = K(t - this.long0), i = this.x0 + this.a * s, r = this.y0 + this.a * Math.log(Math.tan(Math.PI / 4 + e / 2.5)) * 1.25;
    return n.x = i, n.y = r, n;
  }
  function RM(n) {
    n.x -= this.x0, n.y -= this.y0;
    var t = K(this.long0 + n.x / this.a), e = 2.5 * (Math.atan(Math.exp(0.8 * n.y / this.a)) - Math.PI / 4);
    return n.x = t, n.y = e, n;
  }
  ...
  function AM(n) {
    var t, e, s = n.x, i = n.y;
    if (s = K(s - this.long0), this.sphere) {
      ...
      e = this.a * Fi(i, h, l, this.en), t = this.a * s * l / Math.sqrt(1 - this.es * h * h);
    }
    return n.x = t, n.y = e, n;
  }
  function PM(n) {
    var t, e, s, i;
    return n.x -= this.x0, s = n.x / this.a, n.y -= this.y0, t = n.y / this.a, this.sphere ? (t /= this.C_y, s = s / (this.C_x * (this.m + Math.cos(t))), this.m ? t = hs((this.m * t + Math.sin(t)) / this.n) : this.n !== 1 && (t = hs(Math.sin(t) / this.n)), s = K(s + this.long0), t = os(t)) : (t = Xl(n.y / this.a, this.es, this.en), i = Math.abs(t), i < D ? (i = Math.sin(t), e = this.long0 + n.x * Math.sqrt(1 - this.es * i * i) / (this.a * Math.cos(t)), s = K(e)) : i - q < D && (s = this.long0)), n.x = s, n.y = t, n;
  }
  ...
  function FM(n) {
    for (var t = n.x, e = n.y, s = K(t - this.long0), i = e, r = Math.PI * Math.sin(e); ; ) {
  ...
  function kM(n) {
    ...
    var s = K(this.long0 + n.x / (0.900316316158 * this.a * Math.cos(t)));
  ...
  function zM() {
    Math.abs(this.lat1 + this.lat2) < q || (this.lat2 = this.lat2 || this.lat1, this.temp = this.b / this.a, this.es = 1 - Math.pow(this.temp, 2), this.e = Math.sqrt(this.es), this.e0 = Xr(this.es), this.e1 = Yr(this.es), this.e2 = qr(this.es), this.e3 = Vr(this.es), this.sinphi = Math.sin(this.lat1), this.cosphi = Math.cos(this.lat1), this.ms1 = fn(this.e, this.sinphi, this.cosphi), this.ml1 = xe(this.e0, this.e1, this.e2, this.e3, this.lat1), Math.abs(this.lat1 - this.lat2) < q ? this.ns = this.sinphi : (this.sinphi = Math.sin(this.lat2), this.cosphi = Math.cos(this.lat2), this.ms2 = fn(this.e, this.sinphi, this.cosphi), this.ml2 = xe(this.e0, this.e1, this.e2, this.e3, this.lat2), this.ns = (this.ms1 - this.ms2) / (this.ml2 - this.ml1)), this.g = this.ml1 + this.ms1 / this.ns, this.ml0 = xe(this.e0, this.e1, this.e2, this.e3, this.lat0), this.rh = this.a * (this.g - this.ml0));
  }
  function UM(n) {
    var t = n.x, e = n.y, s;
    ...
    var r = this.ns * K(t - this.long0), o = this.x0 + s * Math.sin(r), a = this.y0 + this.rh - s * Math.cos(r);
    return n.x = o, n.y = a, n;
  }
  function BM(n) {
    ...
    var r = 0;
    if (e !== 0 && (r = Math.atan2(t * n.x, t * n.y)), this.sphere) return i = K(this.long0 + r / this.ns), s = os(this.g - e / this.a), n.x = i, n.y = s, n;
    var o = this.g - e / this.a;
    return s = Ca(o, this.e0, this.e1, this.e2, this.e3), i = K(this.long0 + r / this.ns), n.x = i, n.y = s, n;
  }
  ...
  function YM(n) {
    var t = n.x, e = n.y, s = K(t - this.long0), i, r;
  ...
  function qM(n) {
    ...
    return n.x -= this.x0, n.y -= this.y0, c = Math.PI * this.R, s = n.x / c, i = n.y / c, r = s * s + i * i, o = -Math.abs(i) * (1 + r), a = o - 2 * i * i + s * s, h = -2 * o + 1 + 2 * i * i + r * r, p = i * i / h + (2 * a * a * a / h / h / h - 9 * o * a / h / h) / 27, l = (o - a * a / 3 / h) / h, u = 2 * Math.sqrt(-l / 3), c = 3 * p / l / u, Math.abs(c) > 1 && (c >= 0 ? c = 1 : c = -1), d = Math.acos(c) / 3, n.y >= 0 ? e = (-u * Math.cos(d + Math.PI / 3) - a / 3 / h) * Math.PI : e = -(-u * Math.cos(d + Math.PI / 3) - a / 3 / h) * Math.PI, Math.abs(s) < q ? t = this.long0 : t = K(this.long0 + Math.PI * (r - 1 + Math.sqrt(1 + 2 * (s * s - i * i) + r * r)) / 2 / s), n.x = t, n.y = e, n;
  }
  var VM = ["Van_der_Grinten_I", "VanDerGrinten", "vandg"];
  const KM = { init: XM, forward: YM, inverse: qM, names: VM };
  function ZM() {
    this.sin_p12 = Math.sin(this.lat0), this.cos_p12 = Math.cos(this.lat0);
  }
  function $M(n) {
    var t = n.x, e = n.y, s = Math.sin(n.y), i = Math.cos(n.y), r = K(t - this.long0), o, a, h, l, u, c, d, p, f, y, E, M, w, C, v, R, I, O, A, P, F, z, k;
    return this.sphere ? Math.abs(this.sin_p12 - 1) <= q ? (n.x = this.x0 + this.a * (D - e) * Math.sin(r), n.y = this.y0 - this.a * (D - e) * Math.cos(r), n) : Math.abs(this.sin_p12 + 1) <= q ? (n.x = this.x0 + this.a * (D + e) * Math.sin(r), n.y = this.y0 + this.a * (D + e) * Math.cos(r), n) : (O = this.sin_p12 * s + this.cos_p12 * i * Math.cos(r), R = Math.acos(O), I = R ? R / Math.sin(R) : 1, n.x = this.x0 + this.a * I * i * Math.sin(r), n.y = this.y0 + this.a * I * (this.cos_p12 * s - this.sin_p12 * i * Math.cos(r)), n) : (o = Xr(this.es), a = Yr(this.es), h = qr(this.es), l = Vr(this.es), Math.abs(this.sin_p12 - 1) <= q ? (u = this.a * xe(o, a, h, l, D), c = this.a * xe(o, a, h, l, e), n.x = this.x0 + (u - c) * Math.sin(r), n.y = this.y0 - (u - c) * Math.cos(r), n) : Math.abs(this.sin_p12 + 1) <= q ? (u = this.a * xe(o, a, h, l, D), c = this.a * xe(o, a, h, l, e), n.x = this.x0 + (u + c) * Math.sin(r), n.y = this.y0 + (u + c) * Math.cos(r), n) : (d = s / i, p = Di(this.a, this.e, this.sin_p12), f = Di(this.a, this.e, s), y = Math.atan((1 - this.es) * d + this.es * p * this.sin_p12 / (f * i)), E = Math.atan2(Math.sin(r), this.cos_p12 * Math.tan(y) - this.sin_p12 * Math.cos(r)), E === 0 ? A = Math.asin(this.cos_p12 * Math.sin(y) - this.sin_p12 * Math.cos(y)) : Math.abs(Math.abs(E) - Math.PI) <= q ? A = -Math.asin(this.cos_p12 * Math.sin(y) - this.sin_p12 * Math.cos(y)) : A = Math.asin(Math.sin(r) * Math.cos(y) / Math.sin(E)), M = this.e * this.sin_p12 / Math.sqrt(1 - this.es), w = this.e * this.cos_p12 * Math.cos(E) / Math.sqrt(1 - this.es), C = M * w, v = w * w, P = A * A, F = P * A, z = F * A, k = z * A, R = p * A * (1 - P * v * (1 - v) / 6 + F / 8 * C * (1 - 2 * v) + z / 120 * (v * (4 - 7 * v) - 3 * M * M * (1 - 7 * v)) - k / 48 * C), n.x = this.x0 + R * Math.sin(E), n.y = this.y0 + R * Math.cos(E), n));
  }
  function HM(n) {
    n.x -= this.x0, n.y -= this.y0;
    var t, e, s, i, r, o, a, h, l, u, c, d, p, f, y, E, M, w, C, v, R, I, O, A;
    return this.sphere ? (t = Math.sqrt(n.x * n.x + n.y * n.y), t > 2 * D * this.a ? void 0 : (e = t / this.a, s = Math.sin(e), i = Math.cos(e), r = this.long0, Math.abs(t) <= q ? o = this.lat0 : (o = hs(i * this.sin_p12 + n.y * s * this.cos_p12 / t), a = Math.abs(this.lat0) - D, Math.abs(a) <= q ? this.lat0 >= 0 ? r = K(this.long0 + Math.atan2(n.x, -n.y)) : r = K(this.long0 - Math.atan2(-n.x, n.y)) : r = K(this.long0 + Math.atan2(n.x * s, t * this.cos_p12 * i - n.y * this.sin_p12 * s))), n.x = r, n.y = o, n)) : (h = Xr(this.es), l = Yr(this.es), u = qr(this.es), c = Vr(this.es), Math.abs(this.sin_p12 - 1) <= q ? (d = this.a * xe(h, l, u, c, D), t = Math.sqrt(n.x * n.x + n.y * n.y), p = d - t, o = Ca(p / this.a, h, l, u, c), r = K(this.long0 + Math.atan2(n.x, -1 * n.y)), n.x = r, n.y = o, n) : Math.abs(this.sin_p12 + 1) <= q ? (d = this.a * xe(h, l, u, c, D), t = Math.sqrt(n.x * n.x + n.y * n.y), p = t - d, o = Ca(p / this.a, h, l, u, c), r = K(this.long0 + Math.atan2(n.x, n.y)), n.x = r, n.y = o, n) : (t = Math.sqrt(n.x * n.x + n.y * n.y), E = Math.atan2(n.x, n.y), f = Di(this.a, this.e, this.sin_p12), M = Math.cos(E), w = this.e * this.cos_p12 * M, C = -w * w / (1 - this.es), v = 3 * this.es * (1 - C) * this.sin_p12 * this.cos_p12 * M / (1 - this.es), R = t / f, I = R - C * (1 + C) * Math.pow(R, 3) / 6 - v * (1 + 3 * C) * Math.pow(R, 4) / 24, O = 1 - C * I * I / 2 - R * I * I * I / 6, y = Math.asin(this.sin_p12 * Math.cos(I) + this.cos_p12 * Math.sin(I) * M), r = K(this.long0 + Math.asin(Math.sin(E) * Math.sin(I) / Math.cos(y))), A = Math.sin(y), o = Math.atan2((A - this.es * O * this.sin_p12) * Math.tan(y), A * (1 - this.es)), n.x = r, n.y = o, n));
  }
  var JM = ["Azimuthal_Equidistant", "aeqd"];
  const QM = { init: ZM, forward: $M, inverse: HM, names: JM };
  function t2() {
    this.sin_p14 = Math.sin(this.lat0), this.cos_p14 = Math.cos(this.lat0);
  }
  function e2(n) {
    var t, e, s, i, r, o, a, h, l = n.x, u = n.y;
    return s = K(l - this.long0), t = Math.sin(u), e = Math.cos(u), i = Math.cos(s), o = this.sin_p14 * t + this.cos_p14 * e * i, r = 1, (o > 0 || Math.abs(o) <= q) && (a = this.a * r * e * Math.sin(s), h = this.y0 + this.a * r * (this.cos_p14 * t - this.sin_p14 * e * i)), n.x = a, n.y = h, n;
  }
  function n2(n) {
    var t, e, s, i, r, o, a;
    return n.x -= this.x0, n.y -= this.y0, t = Math.sqrt(n.x * n.x + n.y * n.y), e = hs(t / this.a), s = Math.sin(e), i = Math.cos(e), o = this.long0, Math.abs(t) <= q ? (a = this.lat0, n.x = o, n.y = a, n) : (a = hs(i * this.sin_p14 + n.y * s * this.cos_p14 / t), r = Math.abs(this.lat0) - D, Math.abs(r) <= q ? (this.lat0 >= 0 ? o = K(this.long0 + Math.atan2(n.x, -n.y)) : o = K(this.long0 - Math.atan2(-n.x, n.y)), n.x = o, n.y = a, n) : (o = K(this.long0 + Math.atan2(n.x * s, t * this.cos_p14 * i - n.y * this.sin_p14 * s)), n.x = o, n.y = a, n));
  }
  var s2 = ["ortho"];
  const i2 = { init: t2, forward: e2, inverse: n2, names: s2 };
  ...
  function a2(n) {
    ...
    if (n.x = (n.x - this.x0) / this.a, n.y = (n.y - this.y0) / this.a, s = Math.atan(Math.sqrt(n.x * n.x + n.y * n.y)), e = Math.atan2(n.y, n.x), n.x >= 0 && n.x >= Math.abs(n.y) ? c.value = bt.AREA_0 : n.y >= 0 && n.y >= Math.abs(n.x) ? (c.value = bt.AREA_1, e -= D) : n.x < 0 && -n.x >= Math.abs(n.y) ? (c.value = bt.AREA_2, e = e < 0 ? e + ee : e - ee) : (c.value = bt.AREA_3, e += D), u = ee / 12 * Math.tan(e), o = Math.sin(u) / (Math.cos(u) - 1 / Math.sqrt(2)), a = Math.atan(o), i = Math.cos(e), r = Math.tan(s), h = 1 - i * i * r * r * (1 - Math.cos(Math.atan(1 / Math.cos(a)))), h < -1 ? h = -1 : h > 1 && (h = 1), this.face === Gt.TOP) l = Math.acos(h), t.phi = D - l, c.value === bt.AREA_0 ? t.lam = a + D : c.value === bt.AREA_1 ? t.lam = a < 0 ? a + ee : a - ee : c.value === bt.AREA_2 ? t.lam = a - D : t.lam = a;
      ...
      var d, p, f;
      d = h, u = d * d, u >= 1 ? f = 0 : f = Math.sqrt(1 - u) * Math.sin(a), u += f * f, u >= 1 ? p = 0 : p = Math.sqrt(1 - u), c.value === bt.AREA_1 ? (u = p, p = -f, f = u) : c.value === bt.AREA_2 ? (p = -p, f = -f) : c.value === bt.AREA_3 && (u = p, p = f, f = -u), this.face === Gt.RIGHT ? (u = d, d = -p, p = u) : this.face === Gt.BACK ? (d = -d, p = -p) : this.face === Gt.LEFT && (u = d, d = p, p = -u), t.phi = Math.acos(-f) - D, t.lam = Math.atan2(p, d), this.face === Gt.RIGHT ? t.lam = Gi(t.lam, -D) : this.face === Gt.BACK ? t.lam = Gi(t.lam, -3.14159265359) : this.face === Gt.LEFT && (t.lam = Gi(t.lam, +D));
    }
    if (this.es !== 0) {
      var y, E, M;
  ...
  function g2(n) {
    var t = K(n.x - this.long0), e = Math.abs(n.y), s = Math.floor(e * Wf);
    s < 0 ? s = 0 : s >= zi && (s = zi - 1), e = cn * (e - u2 * s);
    var i = { x: Ta(Kl[s], e) * t, y: Ta(Kr[s], e) };
  ...
  function p2(n) {
    ...
    if (t.y >= 1) t.x /= Kl[zi][0], t.y = n.y < 0 ? -D : D;
    else {
      var e = Math.floor(t.y * zi);
      for (e < 0 ? e = 0 : e >= zi && (e = zi - 1); ; ) if (Kr[e][0] > t.y) --e;
      else if (Kr[e + 1][0] <= t.y) ++e;
      else break;
      var s = Kr[e], i = 5 * (t.y - s[0]) / (Kr[e + 1][0] - s[0]);
      i = d2(function(r) {
        return (Ta(s, r) - t.y) / c2(s, r);
      }, i, q, 100), t.x /= Ta(Kl[e], i), t.y = (5 * e + i) * te, n.y < 0 && (t.y = -t.y);
    }
    return t.x = K(t.x + this.long0), t;
  }
  var m2 = ["Robinson", "robin"];
  const _2 = { init: f2, forward: g2, inverse: p2, names: m2 };
  function y2() {
    this.name = "geocent";
  }
  function x2(n) {
  ...
  var M2 = ["Geocentric", "geocentric", "geocent", "Geocent"];
  const w2 = { init: y2, forward: x2, inverse: E2, names: M2 };
  ...
  var C2 = ["Tilted_Perspective", "tpers"];
  const b2 = { init: S2, forward: v2, inverse: R2, names: C2 };
  function T2() {
  ...
  var P2 = ["Geostationary Satellite View", "Geostationary_Satellite", "geos"];
  const L2 = { init: T2, forward: I2, inverse: A2, names: P2 };
  var $r = 1.340264, Hr = -0.081106, Jr = 893e-6, Qr = 3796e-6, Ia = Math.sqrt(3) / 2;
  function O2() {
    this.es = 0, this.long0 = this.long0 !== void 0 ? this.long0 : 0;
  }
  function N2(n) {
    var t = K(n.x - this.long0), e = n.y, s = Math.asin(Ia * Math.sin(e)), i = s * s, r = i * i * i;
    return n.x = t * Math.cos(s) / (Ia * ($r + 3 * Hr * i + r * (7 * Jr + 9 * Qr * i))), n.y = s * ($r + Hr * i + r * (Jr + Qr * i)), n.x = this.a * n.x + this.x0, n.y = this.a * n.y + this.y0, n;
  }
  function F2(n) {
    n.x = (n.x - this.x0) / this.a, n.y = (n.y - this.y0) / this.a;
    var t = 1e-9, e = 12, s = n.y, i, r, o, a, h, l;
    for (l = 0; l < e && (i = s * s, r = i * i * i, o = s * ($r + Hr * i + r * (Jr + Qr * i)) - n.y, a = $r + 3 * Hr * i + r * (7 * Jr + 9 * Qr * i), s -= h = o / a, !(Math.abs(h) < t)); ++l) ;
    return i = s * s, r = i * i * i, n.x = Ia * n.x * ($r + 3 * Hr * i + r * (7 * Jr + 9 * Qr * i)) / Math.cos(s), n.y = Math.asin(Math.sin(s) / Ia), n.x = K(n.x + this.long0), n;
  }
  var k2 = ["eqearth", "Equal Earth", "Equal_Earth"];
  const D2 = { init: O2, forward: N2, inverse: F2, names: k2 };
  var to = 1e-10;
  function G2() {
    var n;
    if (this.phi1 = this.lat1, Math.abs(this.phi1) < to) throw new Error();
    this.es ? (this.en = Wl(this.es), this.m1 = Fi(this.phi1, this.am1 = Math.sin(this.phi1), n = Math.cos(this.phi1), this.en), this.am1 = n / (Math.sqrt(1 - this.es * this.am1 * this.am1) * this.am1), this.inverse = U2, this.forward = z2) : (Math.abs(this.phi1) + to >= D ? this.cphi1 = 0 : this.cphi1 = 1 / Math.tan(this.phi1), this.inverse = j2, this.forward = B2);
  }
  function z2(n) {
    var t = K(n.x - (this.long0 || 0)), e = n.y, s, i, r;
    return s = this.am1 + this.m1 - Fi(e, i = Math.sin(e), r = Math.cos(e), this.en), i = r * t / (s * Math.sqrt(1 - this.es * i * i)), n.x = s * Math.sin(i), n.y = this.am1 - s * Math.cos(i), n.x = this.a * n.x + (this.x0 || 0), n.y = this.a * n.y + (this.y0 || 0), n;
  }
  function U2(n) {
    n.x = (n.x - (this.x0 || 0)) / this.a, n.y = (n.y - (this.y0 || 0)) / this.a;
    var t, e, s, i;
    if (e = Ae(n.x, n.y = this.am1 - n.y), i = Xl(this.am1 + this.m1 - e, this.es, this.en), (t = Math.abs(i)) < D) t = Math.sin(i), s = e * Math.atan2(n.x, n.y) * Math.sqrt(1 - this.es * t * t) / Math.cos(i);
    else if (Math.abs(t - D) <= to) s = 0;
    else throw new Error();
    return n.x = K(s + (this.long0 || 0)), n.y = os(i), n;
  }
  function B2(n) {
    var t = K(n.x - (this.long0 || 0)), e = n.y, s, i;
  ...
  function j2(n) {
    ...
    return Math.abs(Math.abs(e) - D) <= to ? t = 0 : t = s * Math.atan2(n.x, n.y) / Math.cos(e), n.x = K(t + (this.long0 || 0)), n.y = os(e), n;
  }
  var W2 = ["bonne", "Bonne (Werner lat_1=90)"];
  const X2 = { init: G2, names: W2 };
  function Y2(n) {
    n.Proj.projections.add(va), n.Proj.projections.add(Ra), n.Proj.projections.add(zx), n.Proj.projections.add(Zx), n.Proj.projections.add(eE), n.Proj.projections.add(oE), n.Proj.projections.add(dE), n.Proj.projections.add(_E), n.Proj.projections.add(wE), n.Proj.projections.add(bE), n.Proj.projections.add(XE), n.Proj.projections.add($E), n.Proj.projections.add(eM), n.Proj.projections.add(aM), n.Proj.projections.add(dM), n.Proj.projections.add(_M), n.Proj.projections.add(wM), n.Proj.projections.add(bM), n.Proj.projections.add(OM), n.Proj.projections.add(GM), n.Proj.projections.add(WM), n.Proj.projections.add(KM), n.Proj.projections.add(QM), n.Proj.projections.add(i2), n.Proj.projections.add(l2), n.Proj.projections.add(_2), n.Proj.projections.add(w2), n.Proj.projections.add(b2), n.Proj.projections.add(L2), n.Proj.projections.add(D2), n.Proj.projections.add(X2);
  }
  le.defaultDatum = "WGS84", le.Proj = gn, le.WGS84 = new le.Proj("WGS84"), le.Point = Ni, le.toPoint = Sf, le.defs = ye, le.nadgrid = B1, le.transform = Sa, le.mgrs = sx, le.version = "__VERSION__", Y2(le);
  ...
  class q2 extends Ve {
    ...
    handleMapChanged() {
      ...
      const e = this.getMap();
      if (e) {
        this.mapPostrenderListenerKey = xt(e, An.POSTRENDER, this.render, this), this.updatePixelPosition();
  ...
  var Aa = { exports: {} };
  const V2 = kr(R0), K2 = kr(Z0), Z2 = kr(B0), $2 = kr(ip), H2 = kr(vm);
  var J2 = Aa.exports, Xf;
  function Q2() {
    return Xf || (Xf = 1, function(n, t) {
      (function(e, s) {
        s(t, V2, K2, Z2, $2, H2);
      })(J2, function(e, s, i, r, o, a) {
        ...
        }, Name: A, Title: A, Abstract: A, MaxScaleDenominator: P, MinScaleDenominator: P }, X, Q);
        function it(g, m) {
        ...
        function ls(g, m, _) {
          ...
          return at(T) ? !1 : Yt(S, x) <= 0 && Yt(T, x) >= 0;
        }
        function mn(g, m, _) {
          var x = b(g.expression1, m, _);
          if (at(x)) return !1;
          var S = b(g.expression2, m, _);
          return at(S) ? !1 : !g.matchcase || typeof x == "boolean" || typeof S == "boolean" ? Yt(x, S, !1) === 0 : x == S;
        }
        function Nn(g, m, _) {
          var x = b(g.expression1, m, _);
          if (at(x)) return !1;
          var S = b(g.expression2, m, _);
          return at(S) ? !1 : !mn(g, m, _);
        }
        function en(g, m, _) {
          var x = b(g.expression1, m, _);
          if (at(x)) return !1;
        ...
        function de(g, m, _) {
          switch (g.operator) {
            ...
            case "propertyislessthanorequalto":
              return mn(g, m, _) || Bt(g, m, _);
            case "propertyisnotequalto":
              return Nn(g, m, _);
            case "propertyisgreaterthan":
              return pn(g, m, _);
            case "propertyisgreaterthanorequalto":
              return mn(g, m, _) || pn(g, m, _);
        ...
        function Ui(g, m, _, x) {
          ...
          for (var S = [], T = 0, N = 0; N < g.rules.length; N += 1) {
            var j = g.rules[N];
            Fn(j, _) && (j.elsefilter ? (S.push(j), T += 1) : j.filter ? _n(j.filter, m, x) && S.push(j) : S.push(j));
          }
        ...
        var Bs = "IMAGE_LOADING", Bi = "IMAGE_LOADED", js = "IMAGE_ERROR", Ws = 6, Jl = 16, La = "PLACEMENT_DEFAULT", so = "PLACEMENT_FIRSTPOINT", ji = "PLACEMENT_LASTPOINT", Wi = ["graphic.externalgraphic", "stroke.graphicstroke.graphic.externalgraphic", "fill.graphicfill.graphic.externalgraphic"], Oa = {};
        function io(g, m) {
          Oa[g] = m;
        }
        function ps(g) {
        ...
        function nn(g) {
          ...
          return m || (m = new Promise(function(_, x) {
            var S = new Image();
            S.onload = function() {
              io(g, { url: g, image: S, width: S.naturalWidth, height: S.naturalHeight }), kn(g, Bi), _(g);
            }, S.onerror = function() {
              kn(g, js), x();
            }, S.src = g;
          }), kn(g, Bs), Dn(g, m), m);
        ...
        function Dt(g, m, _, x) {
          g.forEach(function(S) {
            ...
            T.forEach(function(N) {
              Wi.forEach(function(j) {
                var U = gs(N, j);
                if (U) {
                  var W = U.onlineresource, ct = Xi(W);
                  (!ct || ct === Bs) && (x[W] || (x[W] = !0, sn(W, m, _)));
                }
              });
            });
          });
        ...
        var qe = new s.Style({}), Ql = new s.Style({ image: new s.Circle({ radius: 8, fill: new s.Fill({ color: "blue", fillOpacity: 0.7 }) }) }), Vf = new s.Style({ image: new s.Circle({ radius: 5, fill: new s.Fill({ color: "#DDDDDD" }), stroke: new s.Stroke({ width: 1, color: "#888888" }) }) }), Kf = new s.Style({ fill: new s.Fill({ color: "#DDDDDD" }), stroke: new s.Stroke({ color: "#888888", width: 1 }) }), ew = new s.Style({ image: new s.RegularShape({ angle: Math.PI / 4, fill: new s.Fill({ color: "red" }), points: 4, radius: 8, radius2: 0, stroke: new s.Stroke({ color: "red", width: 4 }) }) }), nw = new s.Style({ fill: new s.Fill({ color: "red" }), stroke: new s.Stroke({ color: "red", width: 1 }) });
        function Na(g) {
        ...
        function Yi(g, m) {
          return m !== null && m < 1 && g.startsWith("#") ? sw(g, m) : g;
        }
        function iw(g, m) {
        ...
        function ka(g) {
          if (g) {
            var m = g.styling || {}, _ = b(m.stroke, null, null, "#000000"), x = b(m.strokeOpacity, null, null, 1), S = b(m.strokeWidth, null, null, 1), T = b(m.strokeDashoffset, null, null, 0), N = { color: Yi(_, x), width: S, lineDashOffset: T }, j = b(m.strokeLinejoin, null, null);
            j !== null && (N.lineJoin = j);
        ...
        function tu(g) {
          if (g) {
            ...
            return new s.Fill({ color: Yi(_, x) });
          }
        }
        function eu(g, m, _, x) {
          var S = g.getFill();
        ...
        var aw = tu({ styling: { fill: "#888888" } }), hw = ka({ styling: { stroke: {} } });
        function lw(g) {
          var m = g.graphic, _ = b(m.size, null, null, Ws), x = b(m.rotation, null, null, 0);
          ...
          return new s.Style({ image: Fa("square", _, hw, aw, x) });
        }
        var uw = Na(lw);
        function Xs(g, m, _) {
          ...
          var x = uw(g);
          x.setGeometry(null);
          var S = x.getImage(), T = g.graphic, N = T.size, j = T.rotation, U = Number(b(N, m, _)) || Ws, W = Number(b(j, m, _)) || 0;
        ...
        function $f(g, m, _) {
          ...
          for (var U = g.getLength(), W = Math.max(m, 0.1), ct = _.initialGap || 0, Mt = 0, yt = [].concat(x[0]), Lt = [].concat(x[1]), Ot = 0, Ht = []; ct <= U; ) {
            ...
            if (Ot + Jt < ct) {
              ...
              var Me = ct - Ot, se = cw(yt, Lt, Me), De = nu(yt, Lt, _.invertY);
        ...
        function Jf(g, m, _, x, S, T) {
          if (m) {
            ...
            if (!(m.length < 2)) {
              var N = x.getImage();
              if (N) {
                var j = $f(new r.LineString(m), _ * S, { invertY: !0, extent: g.extent_, placement: T.placement, initialGap: T.initialGap });
        ...
        function Qf(g, m) {
          ...
          return g.vendoroptions && (g.vendoroptions.placement === "firstPoint" ? S.placement = so : g.vendoroptions.placement === "lastPoint" && (S.placement = ji)), function(T, N) {
            ...
            if (!(j === "Point" || j === "MultiPoint")) {
              ...
              var Mt = Xs(x, N.feature, m), yt = x.graphic && x.graphic.size || ct, Lt = Number(b(yt, N.feature, m, ct)), Ot = iw(g, Lt);
              S.initialGap = rw(g), Jf(W, T, Ot, Mt, U, S);
            }
          };
        }
        function fw(g, m) {
        ...
        function gw(g) {
          return g.stroke && g.stroke.graphicstroke ? fw(g) : new s.Style({ stroke: ka(g.stroke) });
        }
        var pw = Na(gw);
        function tg(g, m, _) {
          var x = pw(g);
        ...
        var eg = [[1, 1]], ng = [[0, 0], [2, 2]], sg = [[0, 0], [1, 1], [2, 2], [3, 3], [2, 0], [0, 2]], mw = [[0, 0], [1, 1]];
        function _w(g, m) {
        ...
        function Ga(g, m, _) {
          ...
          return S.fillStyle = m, _w(S, _), ig(x);
        }
        function su(g, m, _) {
          var x = document.createElement("canvas");
          x.width = g, x.height = g;
          var S = x.getContext("2d");
          return S.fillStyle = m, S.fillRect(0, 0, g, g), yw(S, _), ig(x);
        }
        function xw(g, m) {
          var _ = null;
          switch (g) {
        ...
        function Mw(g) {
          ...
          switch (Xi(x)) {
            case Bi:
              return new s.Fill({ color: Ew(g.fill.graphicfill.graphic) });
            case Bs:
              return Kf.getFill();
            case js:
              return nw.getFill();
        ...
        function ww(g, m) {
          ...
          var _ = JSON.parse(JSON.stringify(g)), x = _.graphic, S = Number(x.size) || Ws;
          x.size = m * S;
          var T = x.mark;
          if (T && T.stroke) {
        ...
        function Sw(g) {
          ...
          if (N && N.indexOf("brush://") === 0) {
            var j = "#000000";
            return S.fill && S.fill.styling && S.fill.styling.fill && (j = S.fill.styling.fill), xw(N, j);
          }
          var U = Number(x.size) || Ws, W = U * a.DEVICE_PIXEL_RATIO, ct = null, Mt = 2;
          try {
            var yt = document.createElement("canvas");
            yt.width = W * Mt, yt.height = W * Mt;
            var Lt = yt.getContext("2d"), Ot = ww(_, Mt), Ht = Xs(Ot), Jt = i.toContext(Lt, { size: [U * Mt, U * Mt] });
        ...
        function vw(g) {
          ...
          if (m ? x = Mw(g) : _ ? x = Sw(g) : x = tu(g.fill), g.stroke && g.stroke.graphicstroke) {
            var S = Qf(g);
        ...
        function bw(g) {
          ...
          var se = g.fill ? g.fill.styling : {}, De = b(se.fill, null, null, "#000000"), za = b(se.fillOpacity, null, null, 1), Ua = { text: m, font: j, offsetX: Mt, offsetY: yt, rotation: Math.PI * W / 180, textAlign: Ot, textBaseline: Jt, fill: new s.Fill({ color: Yi(De, za) }) };
          if (g.halo) {
            var ug = g.halo && g.halo.fill ? g.halo.fill.styling : {}, jw = b(ug.fill, null, null, "#FFFFFF"), Ww = b(ug.fillOpacity, null, null, 1), Ba = b(g.halo.radius, null, null, 1);
            Ua.stroke = new s.Stroke({ color: Yi(jw, Ww), width: (Ba === 2 || Ba === 4 ? Ba - 1e-5 : Ba) * 2 });
          }
          return new s.Style({ text: new s.Text(Ua) });
        }
        var Tw = Na(bw);
        function iu(g, m, _) {
          var x = Tw(g), S = x.getText();
          if (!S) return x;
          ...
          if (S.setPlacement(Lt), ow(x, g, m, _), g.font && g.font.styling) {
        ...
        function rg(g) {
          var m = $f(g, g.getLength() / 2), _ = m[1], x = _[0], S = _[1];
          return [x, S];
        }
        function Iw(g, m) {
        ...
        function ru(g, m, _, x) {
          ...
          switch (Mt) {
            case "Point":
            case "MultiPoint":
              Gn(yt, N, m, Xs, _), Gn(yt, j, m, iu, _);
              break;
            case "LineString":
            case "MultiLineString":
              Gn(yt, T, m, tg, _), W.strictGeometryMatch || Gn(yt, N, m, Iw, _), Gn(yt, j, m, iu, _);
              break;
            case "Polygon":
            case "MultiPolygon":
              Gn(yt, S, m, Cw, _), W.strictGeometryMatch || Gn(yt, T, m, tg, _), Gn(yt, N, m, Aw, _), Gn(yt, j, m, iu, _);
              break;
            default:
              W.useFallbackStyles && (yt = Pw);
          }
        ...
        function Nw(g, m) {
          ...
          return function(S, T) {
            var N = typeof m.convertResolution == "function" ? m.convertResolution(T) : T, j = typeof m.getProperty == "function" ? m.getProperty : Ow, U = Ui(g, S, N, { getProperty: j, getFeatureId: Lw });
            Dt(U, g, _, x);
        ...
        function ag(g) {
          return Ys(g).toLowerCase();
        }
        function hg(g) {
          return Ys(g).toUpperCase();
        }
        function kw(g, m, _) {
        ...
        function Dw(g, m, _) {
          var x = Ys(g), S = Number(m), T = Number(_);
          return Number.isNaN(S) || Number.isNaN(T) ? "" : x.slice(S, T);
        }
        function Gw(g, m) {
          var _ = Ys(g), x = Number(m);
        ...
        function lg() {
          ...
          var _ = g[0], x = g.slice(1), S = Ys(_);
          return x.some(function(T) {
            return Ys(T) === S;
          });
        }
        function Bw() {
          Y("lower", ag), Y("upper", hg), Y("geometry_type", Uw), Y("substr", kw), Y("strToLowerCase", ag), Y("strToUpperCase", hg), Y("strSubstring", Dw), Y("strSubstringStart", Gw), Y("geometryType", ou), Y("dimension", zw), Y("in", lg);
          for (var g = 2; g <= 10; g += 1) Y("in" + g, lg);
          Y("__fe:Add__", function(m, _) {
            return Number(m) + Number(_);
          }), Y("__fe:Sub__", function(m, _) {
            return Number(m) - Number(_);
          }), Y("__fe:Mul__", function(m, _) {
            return Number(m) * Number(_);
          }), Y("__fe:Div__", function(m, _) {
            return Number(m) / Number(_);
          });
        }
        Bw(), e.OlStyler = ru, e.Reader = ot, e.categorizeSymbolizers = no, e.createOlStyle = Fw, e.createOlStyleFunction = Nw, e.getByPath = gs, e.getFunction = mt, e.getLayer = fs, e.getLayerNames = ds, e.getRuleSymbolizers = Us, e.getRules = Ui, e.getStyle = eo, e.getStyleNames = qt, e.registerFunction = Y;
      });
  ...
  class $l extends Un {
    ...
    initHoverPopup() {
      ...
      display: none;
      width: max-content;
    `, this.shadowRoot.appendChild(t), this.overlay = new q2({ element: t, offset: [10, 10], positioning: "center-left" }), this.map.addOverlay(this.overlay), this.map.on("pointermove", (e) => {
    ...
    getStyle(t, e = null) {
      ...
      switch (t) {
        case "Polygon":
        case "MultiPolygon":
          return new ae({ fill: new Ze({ color: s }), stroke: new ke({ color: i, width: r }) });
        case "LineString":
          return new ae({ stroke: new ke({ color: i, width: r }) });
        case "Point":
          return new ae({ image: new Os({ radius: 5, fill: new Ze({ color: s }), stroke: new ke({ color: i, width: 1 }) }) });
        default:
  ...
  `;
    ...
    applyFeatureGroupsToMap(t, e) {
      ...
      Object.keys(t).forEach((r) => {
        const o = new Y0({ features: t[r] }), a = this.applySLDStyles(i, r, s);
    ...
    updateLayerStyle(t, { fillColor: e, strokeColor: s, strokeWidth: i }) {
      t.setStyle((r) => {
        ...
        return o === "Point" ? new ae({ image: new Os({ radius: 5, fill: new Ze({ color: e }), stroke: new ke({ color: s, width: i }) }) }) : o === "Polygon" || o === "MultiPolygon" ? new ae({ fill: new Ze({ color: e }), stroke: new ke({ color: s, width: i }) }) : o === "LineString" ? new ae({ stroke: new ke({ color: s, width: i }) }) : o === "Circle" ? new ae({ stroke: new ke({ color: s, width: i }) }) : new ae({ fill: new Ze({ color: e }), stroke: new ke({ color: s, width: i }) });
      });
    }
  ...
  `), yn($l, "properties", { gmlFile: { type: String, reflect: !0 }, xmlFile: { type: String, reflect: !0 }, sldFile: { type: String, reflect: !0 } });
  class Hl extends Un {
    constructor() {
  ...
  `), yn(Hl, "properties", { gmlFile: { type: String, reflect: !0 }, xmlFile: { type: String, reflect: !0 }, sldFile: { type: String, reflect: !0 } });
  class Yf extends Un {
    render() {
      const t = "./public/examples/2019/713/data_demo.gml", e = "./public/examples/2019/713/metadata.xml", s = "./public/examples/2019/713/styles.sld";
      return console.log("MapExample XML", e), console.log("MapExample GML", t), console.log("MapExample SLD", s), console.log("IS SOMETHING HAPPENING?"), Es`
          <map-viewer
              .gmlFile="${t}"
              .xmlFile="${e}"
              .sldFile="${s}">
  ...
  `);
  function tw(n) {
    if (n === "#map-viewer") return Es`
    <map-viewer></map-viewer>`;
    if (n === "#map-example") return Es`
    <map-example></map-example>`;
    if (n === "#map-template") return Es`
  ...
  class qf extends Un {
    ...
    render() {
      return Es`
      <main>
        ${tw(this.route)} <!-- Pass the current route to the router -->
      </main>
    `;
    }
    createRenderRoot() {
  ...
  yn(qf, "properties", { route: { type: String } }), customElements.define("main-component", qf), customElements.define("map-viewer", $l), customElements.define("map-template", Hl), customElements.define("map-example", Yf);
});
